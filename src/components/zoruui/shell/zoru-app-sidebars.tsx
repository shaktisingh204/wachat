...
export const ZORU_APP_SIDEBARS: ZoruAppSidebarConfig[] = [
  ...
  /* ─────────────────────────────  CRM  ──────────────────────────────
   *
   * Ten-workspace IA per CRM_PAGE_REDESIGN_PLAN §3.1.1:
   *   1. Overview          6. Inventory
   *   2. Sales Pipeline    7. Accounting & Banking
   *   3. Customers         8. Operations
   *   4. Billing           9. Workplace
   *   5. Procurement      10. Admin
   *
   * Every list page under `/dashboard/crm` lives in exactly one
   * workspace. Detail (`[id]`) and edit pages are reached from their
   * parent list. Three confirmed duplicate routes are intentionally
   * omitted (see "Critical rules" in the redesign plan).
   */
  {
    ...
    build: (p) => [
      /* ─── 1. Overview ─── */
      {
        ...
        items: [
          ...
          leaf("dashboards", "Advanced Dashboard", "/dashboard/sabbi/dashboards", LayoutGrid, p),
        ],
      },
      ...
      /* ─── 2. Lead ─── */
      {
        ...
        items: [
          ...
          leaf("deal-pipeline", "Deal Pipeline", "/dashboard/sabbigin/pipelines", GitBranch, p),
          ...
          leaf("lead-pipelines", "Pipelines", "/dashboard/sabbigin/pipelines", GitBranch, p, { exact: true }),
      ...
      /* ─── 22. Tickets ─── */
      {
        ...
        label: "Tickets",
        items: [
          leaf("all-tickets", "All Tickets", "/dashboard/sabdesk", Ticket, p, { exact: true }),
          leaf("tickets-custom-forms", "Custom Forms", "/dashboard/sabdesk/custom-forms", FileSpreadsheet, p, { adminOnly: true }),
          leaf("tickets-channels", "Channels", "/dashboard/sabdesk/channels", Inbox, p, { adminOnly: true }),
          leaf("tickets-groups", "Groups", "/dashboard/sabdesk/groups", Users, p, { adminOnly: true }),
        ],
      },
      ...
      /* ─── 23. Helpdesk Configuration ─── */
      {
        ...
        items: [
          leaf("hd-channels", "Channels", "/dashboard/sabdesk/channels", Inbox, p, { adminOnly: true }),
          leaf("hd-types", "Types", "/dashboard/sabdesk/types", Tags, p, { adminOnly: true }),
          leaf("hd-groups", "Groups", "/dashboard/sabdesk/groups", Users, p, { adminOnly: true }),
          leaf("hd-tags", "Tags", "/dashboard/sabdesk/tags", Tag, p, { adminOnly: true }),
          leaf("hd-agent-groups", "Agent Groups", "/dashboard/sabdesk/agent-groups", Users, p, { adminOnly: true }),
          leaf("hd-sla", "SLA Policies", "/dashboard/sabdesk/sla", ShieldCheck, p, { adminOnly: true }),
          leaf("hd-reply-templates", "Reply Templates", "/dashboard/sabdesk/reply-templates", FileText, p, { adminOnly: true }),
          leaf("hd-custom-forms", "Custom Forms", "/dashboard/sabdesk/custom-forms", FileSpreadsheet, p, { adminOnly: true }),
          leaf("hd-knowledge-base", "Knowledge Base", "/dashboard/sabdesk/knowledge-base", BookOpen, p, { adminOnly: true }),
        ],
      },
      ...
      /* ─── 25. Communication ─── */
      {
        ...
        items: [
          ...
          leaf("messages", "Messages", "/dashboard/sabmail/crm-email", Mail, p),
      ...
      /* ─── 27. Reports ─── */
      {
        ...
        label: "Reports",
        items: [
          leaf("reports-home", "Reports Hub", "/dashboard/sabbi/reports", BarChart3, p, { exact: true, adminOnly: true }),
          leaf("task-report", "Task Report", "/dashboard/sabbi/reports/task-report", ListChecks, p, { adminOnly: true }),
          leaf("income-vs-expense", "Income vs Expense", "/dashboard/sabbi/reports/income", DollarSign, p, { adminOnly: true }),
          leaf("sales-report", "Sales Report", "/dashboard/sabbi/reports/sales-deals", TrendingUp, p, { adminOnly: true }),
          leaf("lead-report", "Lead Report", "/dashboard/sabbi/reports/leads-conversion", Filter, p, { adminOnly: true }),
        ],
      },
      ...
      /* ─── 28. Analytics & Activity ─── */
      {
        ...
        items: [
          leaf("aa-dashboards", "Dashboards", "/dashboard/sabbi/dashboards", LayoutGrid, p),
          leaf("aa-analytics", "Analytics", "/dashboard/sabbi/analytics", BarChart3, p),
      ...
      /* ─── 30. Integrations ─── */
      {
        ...
        items: [
          ...
          leaf("int-email", "Email Integration", "/dashboard/sabmail/crm-email", Mail, p),
      ...
      /* ─── 35. Settings ─── */
      {
        ...
        items: [
          ...
          leaf("company-addresses", "Company addresses", "/dashboard/crm/settings/company-addresses", MapPin, p, { adminOnly: true }),
          leaf("custom-fields", "Custom fields", "/dashboard/crm/settings/custom-fields", Layers, p, { exact: true, adminOnly: true }),
          leaf("custom-fields-groups", "Custom field groups", "/dashboard/crm/settings/custom-fields/groups", Layers, p, { adminOnly: true }),
          leaf("custom-modules", "Custom modules", "/dashboard/crm/settings/custom-modules", Puzzle, p, { adminOnly: true }),
          leaf("custom-links", "Custom links", "/dashboard/crm/settings/custom-links", LinkIcon, p, { adminOnly: true }),
          leaf("currencies", "Currencies", "/dashboard/crm/settings/currencies", Coins, p, { adminOnly: true }),
          leaf("currency-formats", "Currency formats", "/dashboard/crm/settings/currency-formats", CircleDollarSign, p, { adminOnly: true }),
          leaf("languages", "Languages", "/dashboard/crm/settings/languages", Globe, p, { adminOnly: true }),
          leaf("taxes", "Taxes", "/dashboard/crm/settings/taxes", Percent, p, { adminOnly: true }),
          leaf("unit-types", "Unit types", "/dashboard/crm/settings/unit-types", Tags, p, { adminOnly: true }),
          leaf("expense-categories", "Expense categories", "/dashboard/crm/settings/expense-categories", FolderOpen, p, { adminOnly: true }),
          leaf("expense-cat-roles", "Expense category roles", "/dashboard/crm/settings/expense-category-roles", Shield, p, { adminOnly: true }),
          leaf("permissions", "Permissions", "/dashboard/crm/settings/permissions", Shield, p, { adminOnly: true }),
          leaf("permission-types", "Permission types", "/dashboard/crm/settings/permission-types", ShieldCheck, p, { adminOnly: true }),
          leaf("roles", "Roles", "/dashboard/crm/settings/roles", UserCog, p, { adminOnly: true }),
          leaf("invoice-settings", "Invoice settings", "/dashboard/crm/settings/invoice-settings", Receipt, p, { adminOnly: true }),
          leaf("attendance-settings", "Attendance settings", "/dashboard/crm/settings/attendance-settings", UserCheck, p, { adminOnly: true }),
          leaf("project-settings", "Project settings", "/dashboard/crm/settings/project-settings", ListChecks, p, { adminOnly: true }),
          leaf("task-settings", "Task settings", "/dashboard/crm/settings/task-settings", Check, p, { adminOnly: true }),
          leaf("promotions-settings", "Promotions settings", "/dashboard/crm/settings/promotions", Megaphone, p, { adminOnly: true }),
          ...
          leaf("int-msg-settings", "Message settings", "/dashboard/crm/settings/integrations/message-settings", MessageSquare, p, { adminOnly: true }),
          leaf("int-push", "Push notifications", "/dashboard/crm/settings/integrations/push-notifications", Bell, p, { adminOnly: true }),
          leaf("int-qbooks", "QuickBooks", "/dashboard/crm/settings/integrations/quickbooks", Wallet, p, { adminOnly: true }),
          leaf("int-slack", "Slack", "/dashboard/crm/settings/integrations/slack", MessagesSquare, p, { adminOnly: true }),
          leaf("int-smtp", "SMTP", "/dashboard/crm/settings/integrations/smtp", Mail, p, { adminOnly: true }),
