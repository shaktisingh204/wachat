...
const cardVariants = cva(
  "rounded-xl bg-[var(--st-surface)] text-[var(--st-text)] shadow-sm transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        glass: "backdrop-blur-xl bg-[var(--st-surface)]/60 shadow-md hover:bg-[var(--st-surface)]/70 hover:shadow-lg dark:bg-[var(--st-surface)]/40",
        ...
        gradient: "shadow-md relative overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-br before:from-[var(--st-text)] before:via-transparent before:to-[var(--st-text)] before:opacity-0 hover:before:opacity-100 before:transition-opacity hover:shadow-lg",
