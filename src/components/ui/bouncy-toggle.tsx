    ...
    <div className="flex items-center gap-3">
      ...
      <button
        ...
        className={cn(
          ...
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--st-border)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--st-surface)]",
          isChecked ? "bg-[var(--st-text)]" : "bg-[var(--st-text)]/20"
        )}
      >
        {/* Glow effect */}
        <div
        ...
        >
          ...
          <div
            className={cn(
              ...
              isChecked
                ? "h-2 w-2 bg-[var(--st-text)] opacity-100 scale-100"
                : "h-1.5 w-1.5 bg-[var(--st-text)]/40 opacity-100 scale-100"
            )}
          />
          ...
          <div
            className={cn(
              ...
              isChecked
                ? "animate-ping bg-[var(--st-text)]/20 scale-150 opacity-0"
                : "scale-100 opacity-0"
            )}
