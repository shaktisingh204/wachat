...
const themes: Record<string, Theme> = {
    emerald: { accent: 'emerald', accentFrom: 'from-zoru-surface-2', accentTo: 'to-zoru-ink', accentDeep: '#047857', bg: '#02110d', glow: 'rgba(16,185,129,0.35)', surface: 'rgba(16,185,129,0.08)', text: '#ecfdf5', muted: '#6ee7b7', grid: 'rgba(16,185,129,0.10)' },
    violet: { accent: 'violet', accentFrom: 'from-zoru-surface-2', accentTo: 'to-zoru-ink', accentDeep: '#6d28d9', bg: '#0c0617', glow: 'rgba(168,85,247,0.35)', surface: 'rgba(168,85,247,0.08)', text: '#f5f3ff', muted: '#c4b5fd', grid: 'rgba(168,85,247,0.10)' },
    amber: { accent: 'amber', accentFrom: 'from-zoru-surface-2', accentTo: 'to-zoru-ink', accentDeep: '#b45309', bg: '#150a02', glow: 'rgba(251,146,60,0.35)', surface: 'rgba(251,146,60,0.08)', text: '#fff7ed', muted: '#fdba74', grid: 'rgba(251,146,60,0.10)' },
    sky: { accent: 'sky', accentFrom: 'from-zoru-surface-2', accentTo: 'to-zoru-ink', accentDeep: '#0369a1', bg: '#020817', glow: 'rgba(56,189,248,0.35)', surface: 'rgba(56,189,248,0.08)', text: '#eff6ff', muted: '#7dd3fc', grid: 'rgba(56,189,248,0.10)' },
    rose: { accent: 'rose', accentFrom: 'from-zoru-surface-2', accentTo: 'to-zoru-ink', accentDeep: '#be123c', bg: '#170611', glow: 'rgba(244,63,94,0.35)', surface: 'rgba(244,63,94,0.08)', text: '#fff1f2', muted: '#fda4af', grid: 'rgba(244,63,94,0.10)' },
    cyan: { accent: 'cyan', accentFrom: 'from-zoru-surface-2', accentTo: 'to-zoru-ink', accentDeep: '#0e7490', bg: '#021019', glow: 'rgba(34,211,238,0.35)', surface: 'rgba(34,211,238,0.08)', text: '#ecfeff', muted: '#67e8f9', grid: 'rgba(34,211,238,0.10)' },
    teal: { accent: 'teal', accentFrom: 'from-zoru-surface-2', accentTo: 'to-zoru-ink', accentDeep: '#0f766e', bg: '#02161a', glow: 'rgba(20,184,166,0.35)', surface: 'rgba(20,184,166,0.08)', text: '#ecfeff', muted: '#5eead4', grid: 'rgba(20,184,166,0.10)' },
    indigo: { accent: 'indigo', accentFrom: 'from-zoru-surface-2', accentTo: 'to-zoru-ink', accentDeep: '#4338ca', bg: '#0a081f', glow: 'rgba(99,102,241,0.35)', surface: 'rgba(99,102,241,0.08)', text: '#eef2ff', muted: '#a5b4fc', grid: 'rgba(99,102,241,0.10)' },
    fuchsia: { accent: 'fuchsia', accentFrom: 'from-zoru-surface-2', accentTo: 'to-zoru-ink', accentDeep: '#a21caf', bg: '#160620', glow: 'rgba(217,70,239,0.35)', surface: 'rgba(217,70,239,0.08)', text: '#fdf4ff', muted: '#f0abfc', grid: 'rgba(217,70,239,0.10)' },
    blue: { accent: 'blue', accentFrom: 'from-zoru-surface-2', accentTo: 'to-zoru-ink', accentDeep: '#1d4ed8', bg: '#020a1c', glow: 'rgba(59,130,246,0.35)', surface: 'rgba(59,130,246,0.08)', text: '#eff6ff', muted: '#93c5fd', grid: 'rgba(59,130,246,0.10)' },
    orange: { accent: 'orange', accentFrom: 'from-zoru-surface-2', accentTo: 'to-zoru-ink', accentDeep: '#c2410c', bg: '#1a0a06', glow: 'rgba(249,115,22,0.35)', surface: 'rgba(249,115,22,0.08)', text: '#fff7ed', muted: '#fdba74', grid: 'rgba(249,115,22,0.10)' },
    lime: { accent: 'lime', accentFrom: 'from-zoru-surface-2', accentTo: 'to-zoru-ink', accentDeep: '#4d7c0f', bg: '#0a1402', glow: 'rgba(132,204,22,0.35)', surface: 'rgba(132,204,22,0.08)', text: '#f7fee7', muted: '#bef264', grid: 'rgba(132,204,22,0.10)' },
    pink: { accent: 'pink', accentFrom: 'from-zoru-surface-2', accentTo: 'to-zoru-ink', accentDeep: '#be185d', bg: '#170614', glow: 'rgba(236,72,153,0.35)', surface: 'rgba(236,72,153,0.08)', text: '#fdf2f8', muted: '#f9a8d4', grid: 'rgba(236,72,153,0.10)' },
    purple: { accent: 'purple', accentFrom: 'from-zoru-surface-2', accentTo: 'to-zoru-ink', accentDeep: '#7e22ce', bg: '#0d0518', glow: 'rgba(147,51,234,0.35)', surface: 'rgba(147,51,234,0.08)', text: '#faf5ff', muted: '#d8b4fe', grid: 'rgba(147,51,234,0.10)' },
    yellow: { accent: 'yellow', accentFrom: 'from-zoru-surface-2', accentTo: 'to-zoru-ink', accentDeep: '#a16207', bg: '#161002', glow: 'rgba(234,179,8,0.35)', surface: 'rgba(234,179,8,0.08)', text: '#fefce8', muted: '#fde047', grid: 'rgba(234,179,8,0.10)' },
    slate: { accent: 'slate', accentFrom: 'from-zoru-surface-2', accentTo: 'to-zoru-ink', accentDeep: '#334155', bg: '#0a0b10', glow: 'rgba(148,163,184,0.35)', surface: 'rgba(148,163,184,0.08)', text: '#f8fafc', muted: '#cbd5e1', grid: 'rgba(148,163,184,0.10)' },
};
