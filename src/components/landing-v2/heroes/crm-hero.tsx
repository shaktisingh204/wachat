...
const heatColors: Record<string, string> = {
    cold: 'bg-zoru-surface-2/20 text-white',
    warm: 'bg-zoru-surface-2/20 text-white',
    hot: 'bg-zoru-surface-2/20 text-white',
};
    ...
    return (
        <div className="relative h-full w-full">
            ...
            <m.div
                ...
                className="relative h-full w-full overflow-hidden rounded-3xl border border-white/10 bg-zoru-ink/80 p-4 shadow-[0_30px_80px_-20px_rgba(56,189,248,0.5)] backdrop-blur"
            >
                <div className="mb-3 flex items-center justify-between">
                    <p className="text-[11px] font-semibold uppercase tracking-wider text-white/70">Pipeline · Q3</p>
                    <p className="text-[11px] text-white/60">
                        <span className="font-semibold text-white">₹19.95L</span> · 8 deals
                    </p>
                </div>
                                ...
                                {s.deals.map((d, di) => (
                                    ...
                                    >
                                        ...
                                        <div className="mt-1.5 flex items-center justify-between">
                                            <span className="text-[10px] text-white/70">{d.value}</span>
                ...
                <m.div
                    ...
                    className="pointer-events-none absolute left-4 top-12 rounded-xl border border-zoru-line/40 bg-zoru-ink/20 px-2.5 py-1.5 text-[10px] font-semibold text-white backdrop-blur"
                >
                    Lead → Qualified
                </m.div>
            </m.div>
