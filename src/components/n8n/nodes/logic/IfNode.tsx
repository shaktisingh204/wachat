    ...
    <div className={cn('space-y-4', className)}>
          ...
          <div key={cond.id} className="rounded-lg border border-[var(--gray-5)] bg-[var(--gray-2)] p-3 space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex h-7 w-7 shrink-0 items-center justify-center rounded text-[var(--gray-8)] hover:text-[var(--st-text)] transition-colors"
              >
      ...
      <div className="space-y-1.5">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="flex items-center gap-2 rounded-lg border border-[var(--st-border)] bg-[var(--st-bg-muted)] px-3 py-2.5">
            <LuCircleCheck className="h-4 w-4 shrink-0 text-[var(--st-text)]" strokeWidth={2} />
            <div>
              <p className="text-[12px] font-semibold text-[var(--st-text)]">True</p>
              <p className="text-[10.5px] text-[var(--st-text)]">Output 0 — condition met</p>
            </div>
          </div>
          <div className="flex items-center gap-2 rounded-lg border border-[var(--st-border)] bg-[var(--st-bg-muted)] px-3 py-2.5">
            <LuCircleX className="h-4 w-4 shrink-0 text-[var(--st-text-secondary)]" strokeWidth={2} />
            <div>
              <p className="text-[12px] font-semibold text-[var(--st-text)]">False</p>
              <p className="text-[10.5px] text-[var(--st-text)]">Output 1 — condition not met</p>
            </div>
          </div>
        </div>
      </div>
