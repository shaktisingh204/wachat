...
export function SabcrmSuiteFrame({ children }: { children: React.ReactNode }) {
  ...
  const groups: SabSidebarGroup[] = React.useMemo(() => {
    ...
    const entries: Array<{ group: string } & { id: string; label: string; href?: string; icon: LucideIcon; onClick?: () => void }> = [
      ...
      { group: 'finance', id: 'accounts', label: 'Chart of accounts', href: '/sabcrm/finance/accounts', icon: BookOpen },
      { group: 'finance', id: 'journal-entries', label: 'Journal entries', href: '/sabcrm/finance/journal-entries', icon: FileText },
      { group: 'finance', id: 'trial-balance', label: 'Trial balance', href: '/sabcrm/finance/trial-balance', icon: BookOpen },
      { group: 'finance', id: 'pnl', label: 'Profit & loss', href: '/sabcrm/finance/pnl', icon: TrendingUp },
      { group: 'finance', id: 'balance-sheet', label: 'Balance sheet', href: '/sabcrm/finance/balance-sheet', icon: BookOpen },
      { group: 'finance', id: 'cash-flow', label: 'Cash flow', href: '/sabcrm/finance/cash-flow', icon: TrendingUp },
      ...
      { group: 'commerce', id: 'register', label: 'Register', href: '/sabcrm/commerce/register', icon: Store },
    ...
    result.push({
      id: 'people',
      label: 'People',
      items: entries.filter((e) => e.group === 'people').map(toLeaf),
    });
    result.push({
      id: 'insights',
      label: 'Insights',
