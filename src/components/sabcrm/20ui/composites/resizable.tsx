...
export const ZoruResizableHandle = ({
  ...
  <ResizablePanels.PanelResizeHandle
    className={cn(
      "relative flex w-px items-center justify-center bg-[var(--st-border)]",
  ...
  >
    {withHandle && (
      <div className="z-10 flex h-4 w-3 items-center justify-center rounded-[2px] border border-[var(--st-border)] bg-[var(--st-bg)]">
        <GripVertical className="h-2.5 w-2.5 text-[var(--st-text-secondary)]" />
      </div>
    )}
  </ResizablePanels.PanelResizeHandle>
);
