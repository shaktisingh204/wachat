    ...
    build: (p) => [
      ...
      },
      {
        ...
        items: [
          ...
          leaf("studio", "AI Studio", "/dashboard/facebook/studio", Wand2, p),
          ...
          leaf("planner", "Planner", "/dashboard/facebook/planner", ListChecks, p),
      ...
      },
      {
        ...
        label: "Engagement",
        items: [
          leaf("inbox", "Unified inbox", "/dashboard/facebook/inbox", Inbox, p),
