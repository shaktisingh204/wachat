...
export function CrmFormDrawer({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <ZoruSheetContent className="w-[90vw] max-w-[840px] p-0 flex flex-col bg-zoru-surface overflow-hidden border-l border-zoru-line">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <aside className="w-[180px] shrink-0 border-r border-zoru-line bg-zoru-surface-2/30 p-3 flex flex-col gap-1 overflow-y-auto">
            <div className="text-[10px] font-semibold uppercase tracking-wider text-zoru-ink-muted mb-2 px-2">
              Form Sections
            </div>
                ...
                >
                  <span className="truncate flex items-center gap-2">
                    <span className={`flex h-4 w-4 shrink-0 items-center justify-center rounded-full text-[9px] ${
                      isActive ? 'bg-white/20 text-white' : 'bg-zoru-line text-zoru-ink-subtle'
                    }`}>
                      {idx + 1}
                    </span>
                    {sec.label}
          ...
          <main className="flex-1 p-6 overflow-y-auto bg-zoru-bg">
            <div className="w-full space-y-6">
              {activeSection ? (
                ...
                <p className="text-[13px] text-zoru-ink-muted text-center py-12">
        ...
        {/* Drawer Footer */}
        <ZoruSheetFooter className="px-6 py-3.5 border-t border-zoru-line bg-zoru-surface-2/20 flex flex-row items-center justify-between gap-2">
          <Button
            type="button"
            variant="outline"
            size="sm"
