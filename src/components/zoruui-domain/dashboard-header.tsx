            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold font-headline flex items-center gap-2">
                        {greeting}, {sessionUser.name?.split(' ')[0]} <Sparkles className="h-5 w-5 text-[var(--st-text)] fill-[var(--st-text)] animate-pulse" />
                    </h1>
                    <p className="text-[var(--st-text-secondary)] mt-1">
                        You have <span className="font-semibold text-[var(--st-text)]">{projects.length} active projects</span> in your workspace.
                    </p>
                </div>
            </div>
