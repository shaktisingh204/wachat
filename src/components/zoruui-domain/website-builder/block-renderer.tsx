...
import { ImageCarouselRenderer } from '@/components/zoruui-domain/website-builder/image-carousel-renderer';
import { TabsBlockRenderer } from '@/components/zoruui-domain/website-builder/tabs-block-renderer';
import { AccordionBlockRenderer } from '@/components/zoruui-domain/website-builder/accordion-block-renderer';
import { FormBlockRenderer } from '@/components/zoruui-domain/website-builder/form-block-renderer';
import { MapBlockRenderer } from '@/components/zoruui-domain/website-builder/map-block-renderer';
import { CountdownBlockRenderer } from '@/components/zoruui-domain/website-builder/countdown-block-renderer';
import { SocialShareBlockRenderer } from '@/components/zoruui-domain/website-builder/social-share-block-renderer';
import { RepeaterBlockRenderer } from '@/components/zoruui-domain/website-builder/repeater-block-renderer';
...
export const BlockRenderer: React.FC<BlockRendererProps> = (props) => {
    ...
    switch (block.type) {
        ...
        default: return <div className="text-center text-[var(--st-text-secondary)]">Unsupported block type: {block.type}</div>;
    }
};
