                            ...
                            <TabsList className="h-auto flex-wrap justify-start bg-transparent p-0 gap-1 mb-2">
                                {Object.keys(moduleCategories).map(category => (
                                    <TabsTrigger
                                        key={category}
                                        value={category}
                                        className="data-[state=active]:bg-[var(--st-text)] data-[state=active]:text-white border"
                                    >
                                        {category}
                                    </TabsTrigger>
                                ))}
                        ...
                        <div className="flex-1 overflow-auto py-4">
                            {Object.entries(moduleCategories).map(([category, modules]) => (
                                <TabsContent key={category} value={category} className="mt-0">
                                    <div className="flex justify-between items-center mb-4 bg-[var(--st-bg-muted)]/30 p-2 rounded-md">
