...
import { Button, Checkbox, Switch, Badge, DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuSeparator, DropdownMenuTrigger, Table, TBody, Td, Th, THead, Tr } from '@/components/sabcrm/20ui/compat';
import {
  MoreHorizontal,
  ArrowUpDown,
  Circle,
