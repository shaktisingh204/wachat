    ...
    return (
        <div className="h-full w-full flex flex-col items-center justify-center p-8 text-center">
            ...
            <div className="relative max-w-md w-full rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl shadow-black/20 p-10 overflow-hidden">
                {/* Subtle glow blob */}
                <div className="absolute -top-16 -right-16 h-48 w-48 rounded-full bg-[var(--st-text)]/20 blur-3xl pointer-events-none" />
                <div className="absolute -bottom-16 -left-16 h-48 w-48 rounded-full bg-[var(--st-text)]/10 blur-3xl pointer-events-none" />
                ...
                <div className="relative mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl border border-white/10 bg-white/10 shadow-inner">
                    <ShieldOff className="h-8 w-8 text-[var(--st-text-secondary)]" />
                </div>
                ...
                <p className="relative text-sm text-[var(--st-text-secondary)] leading-relaxed mb-8">
                ...
                <div className="relative flex gap-3 justify-center">
                    <Button asChild size="sm" className="gap-2 rounded-xl bg-[var(--st-text)]/90 hover:bg-[var(--st-text)] shadow-md">
                        <Link href="/wachat">
