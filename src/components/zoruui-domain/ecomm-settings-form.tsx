...
import { Card, CardBody, CardHeader, CardTitle, CardDescription, CardFooter, Button, Input, Label, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Separator, Switch } from '@/components/sabcrm/20ui';
import {
  useActionState,
  useEffect,
  useState } from 'react';
                ...
                <CardBody className="space-y-6">
                    ...
                    <Separator />
                     <div>
                        ...
                        <p className="text-sm text-[var(--st-text-secondary)] mb-4">Provide direct payment links for services like Razorpay, Paytm, or GPay to enable "Pay" buttons in your shop flows.</p>
                     ...
                     <div>
                        ...
                        <p className="text-sm text-[var(--st-text-secondary)] mb-4">Automatically send a follow-up message to users who leave items in their cart.</p>
