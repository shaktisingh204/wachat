        ...
        <form action={formAction}>
             <Card className="p-0">
                <div className="p-6 pb-4">
                    <h2 className="flex items-center gap-2 text-zoru-ink font-semibold text-lg"><Server className="h-5 w-5"/>Custom SMTP</h2>
                    <p className="text-sm text-zoru-ink-muted mt-1">Connect your own SMTP server to send emails. This gives you full control over your email delivery.</p>
                </div>
                <div className="px-6 pb-6 space-y-6">
                    <div className="grid md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            <Label htmlFor="fromName" className="text-zoru-ink">From Name</Label>
                            <Input id="fromName" name="fromName" defaultValue={settings?.fromName} placeholder="e.g. SabNode Support" required/>
                        </div>
                        <div className="space-y-2">
                            <Label htmlFor="fromEmail" className="text-zoru-ink">From Email</Label>
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="smtpSecure" className="text-zoru-ink">Use SSL/TLS Encryption</Label>
                    </div>
                </div>
                <div className="px-6 py-4 border-t border-zoru-line flex">
                    <SubmitButton />
                </div>
            </Card>
        </form>
