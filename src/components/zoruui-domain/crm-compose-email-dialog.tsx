          ...
          <div className="flex-1 overflow-y-auto px-6 py-2">
            <div className="grid gap-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-[var(--st-text-secondary)]">You can use variables like {'{{contact.name}}'} or {'{{account.name}}'}.</p>
              </div>
            </div>
          </div>
