            ...
            <div className={cn("admin-dashboard flex h-screen w-full", isSparklesEnabled && 'diwali-theme')}>
                {isSparklesEnabled && (
                    <div className="absolute inset-0 pointer-events-none z-0">
                        ...
                        <Sparkles className="absolute top-20 left-80 h-12 w-12 text-[var(--st-text)]/30 animate-pulse" style={{ animationDelay: '0.5s' }} />
                        <Sparkles className="absolute bottom-16 right-20 h-16 w-16 text-[var(--st-text)]/40 animate-pulse" style={{ animationDelay: '1s' }} />
                        <Sparkles className="absolute bottom-4 left-4 h-6 w-6 text-[var(--st-text)]/50 animate-pulse" style={{ animationDelay: '1.5s' }} />
                        <Sparkles className="absolute top-1/2 left-1/2 h-10 w-10 text-[var(--st-text)]/30 animate-pulse" style={{ animationDelay: '2s' }} />
                    </div>
                )}
                <Sidebar>
                    <SidebarHeader>
                ...
                <div className="flex-1 flex flex-col relative">
                    <header className="flex items-center justify-between p-3 border-b bg-[var(--st-bg-secondary)] sticky top-0 z-10 shrink-0">
