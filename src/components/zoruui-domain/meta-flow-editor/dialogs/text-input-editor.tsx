...
import { Input, Label, Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/sabcrm/20ui';
        ...
        <div className="space-y-6">
            <div className="space-y-2">
                ...
                <Input
                    ...
                    required
                    className="font-mono bg-[var(--st-bg-muted)]/50"
                    placeholder="field_name"
                />
                <p className="text-[10px] text-[var(--st-text-secondary)]">Unique ID for data binding.</p>
            </div>
            <div className="space-y-2">
