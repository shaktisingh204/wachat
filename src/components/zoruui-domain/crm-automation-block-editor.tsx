...
const TriggerEditor = ({ data, onUpdate }: { data: any, onUpdate: (data: any) => void }) => (
    <div className="space-y-2">
        ...
        <p className="text-xs text-[var(--st-text-secondary)]">The exact name of the tag that should start this workflow.</p>
        <Input 
...
const AddTagEditor = ({ data, onUpdate }: { data: any, onUpdate: (data: any) => void }) => (
     <div className="space-y-2">
        ...
        <p className="text-xs text-[var(--st-text-secondary)]">The tag to add to the contact.</p>
        <Input 
...
export function CrmAutomationBlockEditor({ node, onUpdate }: { node: any, onUpdate: (data: any) => void }) {
    ...
    const renderEditorContent = () => {
        switch (node.type) {
            ...
            default: return <p className="text-sm text-[var(--st-text-secondary)]">No settings for this block type.</p>
        }
    }
