...
const primaryNav: NavEntry[] = [
  ...
  },
  {
    ...
    matches: ['/dashboard/sabflow', '/wachat/flow-builder', '/wachat/flows'],
  },
  {
    key: 'crm',
    label: 'CRM',
...
const wachatPrimary: NavEntry[] = [
  ...
  },
  {
    ...
    matches: ['/wachat/contacts', '/dashboard/wachat/contacts'],
  },
  {
    ...
    matches: ['/wachat/broadcasts', '/wachat/bulk'],
  },
  {
    ...
    href: '/wachat/templates',
    matches: ['/wachat/templates', '/wachat/canned-messages'],
  },
];

/* ── Conversations: live chat ops, search, saved snippets ── */
const wachatConversations: NavEntry[] = [
  { key: 'wachat-conv-search', label: 'Search Chats', icon: <LuSearch className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/conversation-search', matches: ['/wachat/conversation-search'] },
  { key: 'wachat-conv-kanban', label: 'Kanban Board', icon: <LuColumns3 className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/conversation-kanban', matches: ['/wachat/conversation-kanban'] },
  { key: 'wachat-conv-summary', label: 'Summaries', icon: <LuFileText className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/conversation-summary', matches: ['/wachat/conversation-summary'] },
  { key: 'wachat-conv-filters', label: 'Filters', icon: <LuListFilter className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/conversation-filters', matches: ['/wachat/conversation-filters'] },
  { key: 'wachat-chat-labels', label: 'Chat Labels', icon: <LuTag className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/chat-labels', matches: ['/wachat/chat-labels'] },
  { key: 'wachat-chat-export', label: 'Chat Export', icon: <LuFileDown className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/chat-export', matches: ['/wachat/chat-export'] },
  { key: 'wachat-chat-transfer', label: 'Transfer Chat', icon: <LuUserCog className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/chat-transfer', matches: ['/wachat/chat-transfer'] },
  { key: 'wachat-saved-replies', label: 'Saved Replies', icon: <LuMessageSquareQuote className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/saved-replies', matches: ['/wachat/saved-replies'] },
  { key: 'wachat-canned', label: 'Canned Messages', icon: <LuBookmark className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/settings/canned', matches: ['/wachat/settings/canned'] },
  { key: 'wachat-qr-cats', label: 'Reply Categories', icon: <LuFolderOpen className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/quick-reply-categories', matches: ['/wachat/quick-reply-categories'] },
  { key: 'wachat-greeting', label: 'Greeting Message', icon: <LuMessageSquareQuote className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/greeting-messages', matches: ['/wachat/greeting-messages'] },
  { key: 'wachat-away', label: 'Away Message', icon: <LuMessageSquareQuote className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/away-messages', matches: ['/wachat/away-messages'] },
  { key: 'wachat-contact-notes', label: 'Contact Notes', icon: <LuStickyNote className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/contact-notes', matches: ['/wachat/contact-notes'] },
];

/* ── Automation: flows, bots, auto replies, scheduling ── */
const wachatAutomation: NavEntry[] = [
  { key: 'wachat-flow-builder', label: 'Flow Builder', icon: <LuGitBranch className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/flow-builder', matches: ['/wachat/flow-builder'] },
  { key: 'wachat-flows', label: 'Meta Flows', icon: <LuServerCog className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/flows', matches: ['/wachat/flows'] },
  { key: 'wachat-auto-reply', label: 'Auto Reply', icon: <LuReply className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/auto-reply', matches: ['/wachat/auto-reply'] },
  { key: 'wachat-auto-reply-rules', label: 'Reply Rules', icon: <LuListFilter className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/auto-reply-rules', matches: ['/wachat/auto-reply-rules'] },
...
const wachatBroadcasts: NavEntry[] = [
  { key: 'wachat-broadcast-history', label: 'Broadcast History', icon: <LuSend className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/broadcast-history', matches: ['/wachat/broadcast-history'] },
  { key: 'wachat-broadcast-scheduler', label: 'Broadcast Scheduler', icon: <LuCalendar className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/broadcast-scheduler', matches: ['/wachat/broadcast-scheduler'] },
  { key: 'wachat-broadcast-segments', label: 'Segments', icon: <LuGroup className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/broadcast-segments', matches: ['/wachat/broadcast-segments'] },
  { key: 'wachat-campaign-ab', label: 'A/B Test', icon: <LuSplit className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/campaign-ab-test', matches: ['/wachat/campaign-ab-test'] },
  { key: 'wachat-bulk-messaging', label: 'Bulk Messaging', icon: <LuSend className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/bulk-messaging', matches: ['/wachat/bulk-messaging'] },
  { key: 'wachat-media-library', label: 'Media Library', icon: <LuImage className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/media-library', matches: ['/wachat/media-library'] },
  { key: 'wachat-link-tracking', label: 'Link Tracking', icon: <LuLink2 className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/link-tracking', matches: ['/wachat/link-tracking'] },
  { key: 'wachat-wa-link-gen', label: 'Link Generator', icon: <LuLink2 className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/whatsapp-link-generator', matches: ['/wachat/whatsapp-link-generator'] },
  { key: 'wachat-tpl-library', label: 'Template Library', icon: <LuBookCopy className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/message-templates-library', matches: ['/wachat/message-templates-library'] },
  { key: 'wachat-tpl-builder', label: 'Template Builder', icon: <LuSquarePen className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/template-builder', matches: ['/wachat/template-builder'] },
  { key: 'wachat-msg-tags', label: 'Message Tags', icon: <LuTag className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/message-tags', matches: ['/wachat/message-tags'] },
];

/* ── Analytics: performance, delivery, satisfaction, credit ── */
const wachatAnalytics: NavEntry[] = [
  { key: 'wachat-analytics', label: 'Analytics', icon: <LuChartBar className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/analytics', matches: ['/wachat/analytics'] },
  { key: 'wachat-template-analytics', label: 'Template Analytics', icon: <LuChartBar className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/template-analytics', matches: ['/wachat/template-analytics'] },
  { key: 'wachat-message-analytics', label: 'Message Stats', icon: <LuActivity className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/message-analytics', matches: ['/wachat/message-analytics'] },
  { key: 'wachat-message-stats', label: 'Message Statistics', icon: <LuChartBar className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/message-statistics', matches: ['/wachat/message-statistics'] },
  { key: 'wachat-delivery-reports', label: 'Delivery Reports', icon: <LuActivity className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/delivery-reports', matches: ['/wachat/delivery-reports'] },
  { key: 'wachat-response-tracker', label: 'Response Times', icon: <LuClock className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/response-time-tracker', matches: ['/wachat/response-time-tracker'] },
  { key: 'wachat-customer-satisfaction', label: 'Satisfaction', icon: <LuStarHalf className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/customer-satisfaction', matches: ['/wachat/customer-satisfaction'] },
  { key: 'wachat-chat-ratings', label: 'Chat Ratings', icon: <LuStarHalf className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/chat-ratings', matches: ['/wachat/chat-ratings'] },
...
/* ── Commerce: catalog, payments, QR ── */
const wachatCommerce: NavEntry[] = [
  { key: 'wachat-catalog', label: 'Catalog', icon: <LuShoppingBag className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/catalog', matches: ['/wachat/catalog'] },
  { key: 'wachat-pay', label: 'WhatsApp Pay', icon: <LuCreditCard className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/whatsapp-pay', matches: ['/wachat/whatsapp-pay'] },
  { key: 'wachat-qr-codes', label: 'QR Codes', icon: <LuQrCode className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/qr-codes', matches: ['/wachat/qr-codes'] },
];

/* ── Contacts & Lists: groups, merges, blocklists, imports ── */
const wachatContactsMgmt: NavEntry[] = [
  { key: 'wachat-contact-groups', label: 'Contact Groups', icon: <LuFolderOpen className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/contact-groups', matches: ['/wachat/contact-groups'] },
  { key: 'wachat-contact-merge', label: 'Merge Contacts', icon: <LuUsers className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/contact-merge', matches: ['/wachat/contact-merge'] },
  { key: 'wachat-contact-timeline', label: 'Timeline', icon: <LuClock className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/contact-timeline', matches: ['/wachat/contact-timeline'] },
  { key: 'wachat-import-history', label: 'Import History', icon: <LuFileDown className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/contact-import-history', matches: ['/wachat/contact-import-history'] },
  { key: 'wachat-blocked', label: 'Blocked Contacts', icon: <LuShield className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/blocked-contacts', matches: ['/wachat/blocked-contacts'] },
  { key: 'wachat-blacklist', label: 'Blacklist', icon: <LuBan className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/contact-blacklist', matches: ['/wachat/contact-blacklist'] },
  { key: 'wachat-opt-out', label: 'Opt-Out / DND', icon: <LuBan className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/opt-out', matches: ['/wachat/opt-out'] },
];

/* ── Team & Access: agents, assignments, availability ── */
const wachatTeam: NavEntry[] = [
  { key: 'wachat-team-perf', label: 'Team Performance', icon: <LuUserPlus className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/team-performance', matches: ['/wachat/team-performance'] },
  { key: 'wachat-assignments', label: 'Assignments', icon: <LuUserCog className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/assignments', matches: ['/wachat/assignments'] },
  { key: 'wachat-agent-avail', label: 'Agent Status', icon: <LuUserPlus className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/agent-availability', matches: ['/wachat/agent-availability'] },
  { key: 'wachat-agents', label: 'Agents & Roles', icon: <LuUserCog className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/settings/agents', matches: ['/wachat/settings/agents'] },
  { key: 'wachat-attributes', label: 'User Attributes', icon: <LuKey className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/settings/attributes', matches: ['/wachat/settings/attributes'] },
  { key: 'wachat-business-hours', label: 'Business Hours', icon: <LuClock className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/business-hours', matches: ['/wachat/business-hours'] },
];

/* ── Platform & Dev: numbers, calls, webhooks, API ── */
const wachatPlatform: NavEntry[] = [
  { key: 'wachat-numbers', label: 'Numbers', icon: <LuHash className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/numbers', matches: ['/wachat/numbers'] },
  { key: 'wachat-calls', label: 'Calls', icon: <LuPhone className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/calls', matches: ['/wachat/calls'] },
  { key: 'wachat-phone-settings', label: 'Phone Settings', icon: <LuSmartphone className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/phone-number-settings', matches: ['/wachat/phone-number-settings'] },
  { key: 'wachat-health', label: 'Account Health', icon: <LuActivity className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/health', matches: ['/wachat/health'] },
  { key: 'wachat-integrations', label: 'Integrations', icon: <LuPuzzle className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/integrations', matches: ['/wachat/integrations'] },
  { key: 'wachat-webhooks', label: 'Webhooks', icon: <LuWebhook className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/webhooks', matches: ['/wachat/webhooks'] },
  { key: 'wachat-webhook-logs', label: 'Webhook Logs', icon: <LuWebhook className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/webhook-logs', matches: ['/wachat/webhook-logs'] },
  ...
  { key: 'wachat-general-settings', label: 'General Settings', icon: <LuSettings className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/wachat/settings/general', matches: ['/wachat/settings/general', '/dashboard/settings'] },
];
...
const crmSalesCrm: NavEntry[] = [
  ...
  },
  {
    ...
    matches: ['/dashboard/sabbigin/pipelines'],
  },
  {
...
const crmInsights: NavEntry[] = [
  {
    ...
    label: 'Analytics',
    icon: <LuChartBar className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/sabbi/analytics',
    matches: ['/dashboard/sabbi/analytics'],
  },
  {
    key: 'crm-reports',
    label: 'GST',
    ...
    matches: ['/dashboard/sabbi/reports'],
  },
  {
    key: 'crm-gstr-1',
    label: 'GSTR-1',
    icon: <LuReceiptText className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/sabbi/reports/gstr-1',
    matches: ['/dashboard/sabbi/reports/gstr-1'],
  },
  {
    key: 'crm-gstr-2b',
    label: 'GSTR-2B',
    ...
    matches: ['/dashboard/sabbi/reports/gstr-2b'],
  },
  {
    ...
    matches: ['/dashboard/sabbi/reports/income'],
  },
  {
    key: 'crm-hr-reports',
    label: 'HR Reports',
    ...
    matches: ['/dashboard/sabbi/reports/attendance-report'],
  },
  {
    ...
    matches: ['/dashboard/sabbi/reports/ticket-report'],
  },
];
...
const crmHr: NavEntry[] = [
  {
    ...
    label: 'HR Overview',
    icon: <LuUsers className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/hr',
    matches: ['/dashboard/hrm/hr'],
  },
  {
    key: 'crm-hr-payroll',
  ...
  },
  {
    ...
    matches: [
      '/dashboard/hrm/payroll/shifts',
      '/dashboard/hrm/payroll/shift-rotations',
      '/dashboard/hrm/payroll/shift-change-requests',
    ],
  },
  {
    key: 'hr-jobs',
  ...
  },
  {
    ...
    matches: [
      ...
      '/dashboard/hrm/hr/directory',
      '/dashboard/hrm/hr/org-chart',
    ],
  },
  {
    key: 'hr-documents',
  ...
  },
  {
    ...
    matches: [
      '/dashboard/hrm/hr/training',
      '/dashboard/hrm/hr/certifications',
      '/dashboard/hrm/hr/learning-paths',
    ],
  },
  {
    key: 'hr-performance',
    ...
    matches: [
      '/dashboard/hrm/hr/okrs',
      '/dashboard/hrm/hr/feedback-360',
      '/dashboard/hrm/hr/one-on-ones',
    ],
  },
  {
    key: 'hr-time',
  ...
  },
  {
    ...
    matches: [
      '/dashboard/hrm/hr/recognition',
      '/dashboard/hrm/hr/surveys',
    ],
  },
  {
    key: 'hr-exit',
    label: 'Comp & Exit',
    icon: <LuUserCog className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/hr/compensation-bands',
    matches: [
  ...
  },
  {
    ...
    label: 'Leave Types',
    icon: <LuTag className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/leave/types',
    matches: ['/dashboard/hrm/payroll/leave/types'],
  },
  {
    key: 'hr-leave-balance',
    label: 'Leave Balance',
    icon: <LuCalculator className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/leave/balance',
    matches: ['/dashboard/hrm/payroll/leave/balance'],
  },
  {
    key: 'hr-leave-calendar',
    label: 'Leave Calendar',
    icon: <LuCalendarDays className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/leave/calendar',
    matches: ['/dashboard/hrm/payroll/leave/calendar'],
  },
  {
    key: 'hr-dept-hierarchy',
    label: 'Dept Hierarchy',
    icon: <LuNetwork className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/departments/hierarchy',
    matches: ['/dashboard/hrm/payroll/departments/hierarchy'],
  },
  {
    key: 'hr-designation-hierarchy',
    label: 'Designation Hierarchy',
    icon: <LuNetwork className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/designations/hierarchy',
    matches: ['/dashboard/hrm/payroll/designations/hierarchy'],
  },
  {
    key: 'hr-employee-documents',
    label: 'Employee Documents',
    icon: <LuFileText className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/employees/documents',
    matches: ['/dashboard/hrm/payroll/employees/documents'],
  },
  {
    key: 'hr-emergency-contacts',
    label: 'Emergency Contacts',
    icon: <LuPhone className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/employees/emergency-contacts',
    matches: ['/dashboard/hrm/payroll/employees/emergency-contacts'],
  },
  {
    key: 'hr-visa-details',
    label: 'Visa Details',
    icon: <LuEarth className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/employees/visa-details',
    matches: ['/dashboard/hrm/payroll/employees/visa-details'],
  },
  {
    key: 'hr-skills',
    label: 'Skills',
    icon: <LuAward className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/employees/skills',
    matches: ['/dashboard/hrm/payroll/employees/skills'],
  },
  {
    key: 'hr-employee-skills',
    label: 'Employee Skills',
    icon: <LuAward className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/employees/employee-skills',
    matches: ['/dashboard/hrm/payroll/employees/employee-skills'],
  },
  {
    key: 'hr-teams',
    label: 'Teams',
    icon: <LuUsers className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/employees/teams',
    matches: ['/dashboard/hrm/payroll/employees/teams'],
  },
  {
    key: 'hr-leave-quotas',
    label: 'Leave Quotas',
    icon: <LuUmbrella className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/employees/leave-quotas',
    matches: ['/dashboard/hrm/payroll/employees/leave-quotas'],
  },
  {
    key: 'hr-attendance',
    label: 'Attendance',
  ...
  },
  {
    ...
    label: 'Goal Setting',
    icon: <LuTarget className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/goal-setting',
    matches: ['/dashboard/hrm/payroll/goal-setting'],
  },
  {
    ...
    matches: ['/dashboard/hrm/payroll/appraisal-reviews'],
  },
  {
    key: 'hr-kpi-tracking',
    label: 'KPI Tracking',
    icon: <LuTrendingUp className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/kpi-tracking',
    matches: ['/dashboard/hrm/payroll/kpi-tracking'],
  },
  {
    key: 'hr-settings',
    label: 'HR Settings',
...
const hrmPeople: NavEntry[] = [
  ...
  {
    key: 'hrm-employee-profile',
    label: 'Employee Profiles',
    icon: <LuUserCog className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/employees/profile',
    matches: ['/dashboard/hrm/payroll/employees/profile'],
  },
  {
    key: 'hrm-employee-teams',
    label: 'Teams',
    icon: <LuUsers className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/employees/teams',
    matches: ['/dashboard/hrm/payroll/employees/teams'],
...
const hrmEngagement: NavEntry[] = [
  ...
  },
  {
    key: 'hrm-time-logs',
    label: 'Time Logs',
    icon: <LuTimer className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/time-logs',
    matches: ['/dashboard/hrm/payroll/time-logs'],
  },
  {
    key: 'hrm-weekly-timesheets',
    label: 'Weekly Timesheets',
    icon: <LuCalendarClock className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/hrm/payroll/weekly-timesheets',
    matches: ['/dashboard/hrm/payroll/weekly-timesheets'],
  },
  {
    key: 'hrm-timesheets',
    label: 'Time & Expense',
...
const emailPrimary: NavEntry[] = [
  ...
  { key: 'em-inbox', label: 'Inbox', icon: <LuInbox className="h-[15px] w-[15px]" strokeWidth={1.75} />, href: '/dashboard/sabmail/inbox', matches: ['/dashboard/sabmail/inbox'] },
...
const crmConfigure: NavEntry[] = [
  {
    ...
    label: 'Email',
    icon: <LuMail className="h-[15px] w-[15px]" strokeWidth={1.75} />,
    href: '/dashboard/sabmail/crm-email',
    matches: ['/dashboard/sabmail/crm-email'],
  },
  {
        ...
        right={
          <>
            ...
            <button
              ...
              className="inline-flex h-8 items-center gap-1.5 rounded-full border border-border bg-card pl-2 pr-3 text-[12px] font-medium text-foreground transition-colors hover:border-border"
              style={{
                background:
            ...
            >
              ...
              <span className="hidden text-muted-foreground sm:inline">plan</span>
            </button>
            ...
            context === 'ad-manager'
              ...
              : context === 'instagram'
                ...
                ? [
                    ...
                    { title: 'Conversations', addable: false, items: wachatConversations.map(toNavItem) },
                    { title: 'Automation', addable: false, items: wachatAutomation.map(toNavItem) },
                    { title: 'Broadcasts', addable: false, items: wachatBroadcasts.map(toNavItem) },
                    { title: 'Analytics', addable: false, items: wachatAnalytics.map(toNavItem) },
                    { title: 'Commerce', addable: false, items: wachatCommerce.map(toNavItem) },
                    { title: 'Contacts & Lists', addable: false, items: wachatContactsMgmt.map(toNavItem) },
                    { title: 'Team & Access', addable: false, items: wachatTeam.map(toNavItem) },
                    {
                      title: 'Platform & Dev',
                      addable: true,
                      onAdd: () => router.push('/wachat/integrations'),
                      items: wachatPlatform.map(toNavItem),
                    },
                  ]
                : context === 'sabflow'
                ? [
  ...
  return (
    <div className="flex flex-col gap-2.5">
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 self-start rounded-full border border-border bg-card px-2.5 py-1.5 text-[11.5px] font-medium text-muted-foreground hover:text-foreground hover:border-border transition-colors"
      >
        ...
        <ZoruDropdownMenuTrigger asChild>
          ...
          >
            ...
            <span className="min-w-0 flex-1">
              <span className="flex items-center gap-1.5 text-[10.5px] uppercase tracking-wide text-muted-foreground/70 font-medium">
                Project
          ...
          {projects.length === 0 ? (
            ...
            projects.slice(0, 10).map((p) => {
              ...
              return (
                ...
                >
                  <span className="flex h-5 w-5 items-center justify-center rounded-[6px] bg-accent text-[9px] font-semibold uppercase text-accent-foreground mr-2">
                    {(p.name || '?').slice(0, 2)}
                  </span>
    ...
    <div className="flex flex-col gap-2.5">
      ...
      <div className="flex items-center gap-2.5 px-1">
        ...
        <div className="min-w-0">
          <p className="truncate text-[13px] font-semibold leading-tight text-foreground">Ad Manager</p>
          <p className="text-[11px] text-muted-foreground">Facebook & Instagram Ads</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col gap-2.5">
      ...
      <div className="flex items-center gap-2.5 px-1">
        ...
        <div className="min-w-0">
          <p className="truncate text-[13px] font-semibold leading-tight text-foreground">Instagram</p>
          <p className="text-[11px] text-muted-foreground">Feed, Stories & Reels</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="flex flex-col gap-2.5">
      ...
      <div className="flex items-center gap-2.5 px-1">
        ...
        <div className="min-w-0">
          ...
          <p className="text-[11px] text-muted-foreground">Visual automation engine</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col gap-2.5">
      ...
      <div className="flex items-center gap-2.5 px-1">
        ...
        <div className="min-w-0">
          <p className="truncate text-[13px] font-semibold leading-tight text-foreground">Settings</p>
          <p className="text-[11px] text-muted-foreground">Account, billing & workspace</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col gap-2.5">
      ...
      <div className="flex items-center gap-2.5 px-1">
        ...
        <div className="min-w-0">
          <p className="truncate text-[13px] font-semibold leading-tight text-foreground">Team</p>
          <p className="text-[11px] text-muted-foreground">Members, Roles & Collaboration</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col gap-2.5">
      ...
      <div className="flex items-center gap-2.5 px-1">
        ...
        <div className="min-w-0">
          <p className="truncate text-[13px] font-semibold leading-tight text-foreground">Telegram</p>
          <p className="text-[11px] text-muted-foreground">Bots, Channels & Business</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col gap-2.5">
      ...
      <div className="flex items-center gap-2.5 px-1">
        ...
        <div className="min-w-0">
          <p className="truncate text-[13px] font-semibold leading-tight text-foreground">Meta Suite</p>
          <p className="text-[11px] text-muted-foreground">Facebook & Instagram</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col gap-2.5">
      ...
      <div className="flex items-center gap-2.5 px-1">
        ...
        <div className="min-w-0">
          <p className="truncate text-[13px] font-semibold leading-tight text-foreground">URL Shortener</p>
          <p className="text-[11px] text-muted-foreground">Trackable short links</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col gap-2.5">
      ...
      <div className="flex items-center gap-2.5 px-1">
        ...
        <div className="min-w-0">
          <p className="truncate text-[13px] font-semibold leading-tight text-foreground">CRM</p>
          <p className="text-[11px] text-muted-foreground">Sales, Ops & Accounting</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col gap-2.5">
      ...
      <div className="flex items-center gap-2.5 px-1">
        ...
        <div className="min-w-0">
          <p className="truncate text-[13px] font-semibold leading-tight text-foreground">QR Code Maker</p>
          <p className="text-[11px] text-muted-foreground">Customizable QR codes</p>
        </div>
      </div>
    </div>
  );
