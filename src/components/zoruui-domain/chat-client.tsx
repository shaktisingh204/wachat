...
export function ChatClient() {
    ...
    return (
        <>
            ...
            />
            <div className="h-full w-full flex flex-col overflow-hidden bg-[var(--st-bg-secondary)]">
                <div className="flex flex-1 overflow-hidden">
                    <div className={cn("w-full flex-col border-r bg-[var(--st-bg-secondary)]/50 backdrop-blur-xl md:w-[380px] flex-shrink-0", selectedContact ? "hidden md:flex" : "flex")}>
                        <ChatContactList
                    ...
                    <div className={cn("w-full flex-col flex-1 relative", selectedContact ? "flex" : "hidden md:flex")}>
                        {selectedContact && activeProject ? (
                            ...
                            <div className="hidden md:flex flex-col items-center justify-center h-full text-[var(--st-text-secondary)] gap-4 p-8 text-center bg-chat-texture">
                                <div className="h-20 w-20 bg-[var(--st-bg-muted)] rounded-full flex items-center justify-center mb-2">
                                    <MessageSquare className="h-10 w-10 text-[var(--st-text-secondary)]/50" />
                                </div>
                    ...
                    {isInfoPanelOpen && selectedContact && activeProject && (
                        <div className="w-[340px] border-l hidden lg:block flex-shrink-0 bg-[var(--st-bg-secondary)]/50 backdrop-blur-xl">
                            <ContactInfoPanel
                                project={activeProject}
                                contact={selectedContact}
                                onContactUpdate={handleContactUpdate}
