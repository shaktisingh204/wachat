...
import { ImageCarouselRenderer } from '@/components/20ui-domain/website-builder/image-carousel-renderer';
import { TabsBlockRenderer } from '@/components/20ui-domain/website-builder/tabs-block-renderer';
import { AccordionBlockRenderer } from '@/components/20ui-domain/website-builder/accordion-block-renderer';
import { FormBlockRenderer } from '@/components/20ui-domain/website-builder/form-block-renderer';
import { MapBlockRenderer } from '@/components/20ui-domain/website-builder/map-block-renderer';
import { CountdownBlockRenderer } from '@/components/20ui-domain/website-builder/countdown-block-renderer';
import { SocialShareBlockRenderer } from '@/components/20ui-domain/website-builder/social-share-block-renderer';
import { RepeaterBlockRenderer } from '@/components/20ui-domain/website-builder/repeater-block-renderer';
