...
import { Card, CardBody, CardDescription, CardFooter, CardHeader, CardTitle, Button, Input, Label, Separator, Accordion, AccordionItem, AccordionTrigger, AccordionContent } from '@/components/sabcrm/20ui';
import {
  useActionState,
  useEffect,
  useRef } from 'react';
                                ...
                                <div className="space-y-4 pt-2">
                                    <div className="grid gap-4 md:grid-cols-2">
                                        <div className="space-y-2">
                                            ...
                                            />
                                            <p className="text-xs text-[var(--st-text-secondary)]">The default timezone for reports and scheduling.</p>
                                        </div>
                                        <div className="space-y-2">
                                            ...
                                            />
                                            <p className="text-xs text-[var(--st-text-secondary)]">The default language code for auto-replies.</p>
                                        </div>
                                    </div>
                                    <div className="space-y-2">
                                    ...
                                    <div className="grid gap-4 md:grid-cols-2">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex gap-2 items-center">
                                                ...
                                                />
                                                <span className="text-sm text-[var(--st-text-secondary)]">Hex color code</span>
                                            </div>
                                        </div>
                                        <div className="space-y-2">
