...
export function EmailCompose() {
    ...
    return (
        <ZoruDialog open={isOpen} onOpenChange={(open) => !open && handleClose()}>
            <ZoruDialogContent className="sm:max-w-[600px] p-0 gap-0 overflow-hidden">
                <ZoruDialogHeader className="p-4 border-b bg-muted/20 flex flex-row items-center justify-between space-y-0">
                    <ZoruDialogTitle>New Message</ZoruDialogTitle>
                ...
                <form onSubmit={handleSend} className="flex flex-col h-full max-h-[80vh]">
                    ...
                    <ZoruDialogFooter className="p-4 border-t bg-muted/10 items-center justify-between sm:justify-between">
                        <div className="flex items-center gap-2">
                            <ZoruButton type="button" variant="ghost" size="icon">
                        ...
                        <div className="flex gap-2">
                            <ZoruButton type="button" variant="ghost" onClick={handleClose}>Discard</ZoruButton>
                            <ZoruButton type="submit" disabled={sending}>
