                 ...
                 <ZoruAccordion type="multiple" className="w-full" defaultValue={['content_general']}>
                    <ZoruAccordionItem value="content_general">
                        ...
                        <ZoruAccordionContent className="space-y-4 pt-2">
                             ...
                             <div className="flex items-center space-x-2"><ZoruSwitch id="linkNofollow" checked={settings.linkNofollow} onCheckedChange={(val) => handleUpdate('linkNofollow', val)} /><ZoruLabel htmlFor="linkNofollow">Add nofollow</ZoruLabel></div>
                             <div className="space-y-2"><ZoruLabel>Alignment</ZoruLabel><ZoruSelect value={settings.align || 'left'} onValueChange={(val) => handleUpdate('align', val)}><ZoruSelectTrigger><ZoruSelectValue /></ZoruSelectTrigger><ZoruSelectContent><ZoruSelectItem value="left">Left</ZoruSelectItem><ZoruSelectItem value="center">Center</ZoruSelectItem><ZoruSelectItem value="right">Right</ZoruSelectItem><ZoruSelectItem value="justify">Justify (full width)</ZoruSelectItem></ZoruSelectContent></ZoruSelect></div>
                             <div className="space-y-2"><ZoruLabel>Size</ZoruLabel><ZoruSelect value={settings.size || 'default'} onValueChange={(val) => handleUpdate('size', val)}><ZoruSelectTrigger><ZoruSelectValue /></ZoruSelectTrigger><ZoruSelectContent><ZoruSelectItem value="sm">Small</ZoruSelectItem><ZoruSelectItem value="default">Medium</ZoruSelectItem><ZoruSelectItem value="lg">Large</ZoruSelectItem></ZoruSelectContent></ZoruSelect></div>
                             <div className="space-y-2"><ZoruLabel>HTML Tag</ZoruLabel><ZoruSelect value={settings.htmlTag || 'a'} onValueChange={(val) => handleUpdate('htmlTag', val)}><ZoruSelectTrigger><ZoruSelectValue /></ZoruSelectTrigger><ZoruSelectContent><ZoruSelectItem value="a">a (link)</ZoruSelectItem><ZoruSelectItem value="button">button</ZoruSelectItem><ZoruSelectItem value="div">div</ZoruSelectItem><ZoruSelectItem value="span">span</ZoruSelectItem><ZoruSelectItem value="p">p</ZoruSelectItem></ZoruSelectContent></ZoruSelect></div>
                        </ZoruAccordionContent>
                    </ZoruAccordionItem>
                    <ZoruAccordionItem value="content_icon">
                        <ZoruAccordionTrigger>Icon</ZoruAccordionTrigger>
                        <ZoruAccordionContent className="space-y-4 pt-2">
                             <div className="space-y-2"><ZoruLabel>Icon</ZoruLabel><ZoruSelect value={settings.icon || ''} onValueChange={(val) => handleUpdate('icon', val)}><ZoruSelectTrigger><ZoruSelectValue placeholder="No Icon"/></ZoruSelectTrigger><ZoruSelectContent>{iconNames.map(iconName => (<ZoruSelectItem key={iconName} value={iconName}>{iconName}</ZoruSelectItem>))}</ZoruSelectContent></ZoruSelect></div>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2"><ZoruLabel>Position</ZoruLabel><ZoruSelect value={settings.iconPosition || 'left'} onValueChange={(val) => handleUpdate('iconPosition', val)}><ZoruSelectTrigger><ZoruSelectValue/></ZoruSelectTrigger><ZoruSelectContent><ZoruSelectItem value="left">Before</ZoruSelectItem><ZoruSelectItem value="right">After</ZoruSelectItem></ZoruSelectContent></ZoruSelect></div>
                                <div className="space-y-2"><ZoruLabel>Spacing (px)</ZoruLabel><ZoruInput type="number" value={settings.iconSpacing || '8'} onChange={e => handleUpdate('iconSpacing', e.target.value)} /></div>
                            </div>
                        </ZoruAccordionContent>
                    </ZoruAccordionItem>
                </ZoruAccordion>
                 ...
                 <ZoruAccordion type="multiple" className="w-full" defaultValue={['style_button']}>
                    <ZoruAccordionItem value="style_button">
                        ...
                        <ZoruAccordionContent className="space-y-4 pt-2">
                            ...
                            <Tabs defaultValue="normal">
                                ...
                                <TabsContent value="normal" className="pt-4 space-y-4">
                                    <div className="space-y-2"><ZoruLabel>Text Color</ZoruLabel><ZoruInput type="color" value={settings.color || '#FFFFFF'} onChange={e => handleUpdate('color', e.target.value)} /></div>
                                    <div className="space-y-2"><ZoruLabel>Background Color</ZoruLabel><ZoruInput type="color" value={settings.backgroundColor || '#000000'} onChange={e => handleUpdate('backgroundColor', e.target.value)} /></div>
                                </TabsContent>
                                <TabsContent value="hover" className="pt-4 space-y-4">
                                    <div className="space-y-2"><ZoruLabel>Text Color</ZoruLabel><ZoruInput type="color" value={settings.hover?.color || settings.color || '#FFFFFF'} onChange={e => handleSubFieldUpdate('hover', 'color', e.target.value)} /></div>
                                    <div className="space-y-2"><ZoruLabel>Background Color</ZoruLabel><ZoruInput type="color" value={settings.hover?.backgroundColor || settings.backgroundColor || '#333333'} onChange={e => handleSubFieldUpdate('hover', 'backgroundColor', e.target.value)} /></div>
                                </TabsContent>
                            </Tabs>
                        </ZoruAccordionContent>
                    </ZoruAccordionItem>
                     <ZoruAccordionItem value="style_icon">
                        <ZoruAccordionTrigger>Icon</ZoruAccordionTrigger>
                        <ZoruAccordionContent className="space-y-4 pt-2">
                             <div className="space-y-2"><ZoruLabel>Icon Size (px)</ZoruLabel><ZoruInput type="number" value={settings.iconStyle?.size || '16'} onChange={e => handleSubFieldUpdate('iconStyle', 'size', e.target.value, true)} /></div>
                             <Tabs defaultValue="normal">
                                <TabsList className="grid w-full grid-cols-2">
                                    <TabsTrigger value="normal">Normal</TabsTrigger>
                                    <TabsTrigger value="hover">Hover</TabsTrigger>
                                ...
                                <TabsContent value="normal" className="pt-4 space-y-4">
                                     <div className="space-y-2"><ZoruLabel>Icon Color</ZoruLabel><ZoruInput type="color" value={settings.iconStyle?.color || settings.color || '#FFFFFF'} onChange={e => handleSubFieldUpdate('iconStyle', 'color', e.target.value)} /></div>
                                </TabsContent>
                                <TabsContent value="hover" className="pt-4 space-y-4">
                                     <div className="space-y-2"><ZoruLabel>Icon Hover Color</ZoruLabel><ZoruInput type="color" value={settings.hover?.iconColor || settings.iconStyle?.color || settings.hover?.color || settings.color || '#FFFFFF'} onChange={e => handleSubFieldUpdate('hover', 'iconColor', e.target.value)} /></div>
                                </TabsContent>
                             </Tabs>
                        </ZoruAccordionContent>
                    </ZoruAccordionItem>
                    <ZoruAccordionItem value="style_border">
                        ...
                        <ZoruAccordionContent className="space-y-4 pt-2">
                            ...
                            <div className="space-y-2"><ZoruLabel>Box Shadow</ZoruLabel><ZoruSelect value={settings.boxShadow?.type || 'none'} onValueChange={v => handleSubFieldUpdate('boxShadow', 'type', v)}><ZoruSelectTrigger><ZoruSelectValue/></ZoruSelectTrigger><ZoruSelectContent><ZoruSelectItem value="none">None</ZoruSelectItem><ZoruSelectItem value="outline">Outline</ZoruSelectItem><ZoruSelectItem value="inset">Inset</ZoruSelectItem></ZoruSelectContent></ZoruSelect></div>
                        </ZoruAccordionContent>
                    </ZoruAccordionItem>
                </ZoruAccordion>
            </TabsContent>
                 ...
                 <ZoruAccordion type="multiple" className="w-full" defaultValue={['advanced_spacing']}>
                    <ZoruAccordionItem value="advanced_spacing">
                        ...
                        <ZoruAccordionContent className="space-y-4 pt-2">
                             ...
                             <div className="space-y-2"><ZoruLabel>Padding (Top, Right, Bottom, Left) in px</ZoruLabel><div className="grid grid-cols-4 gap-2"><ZoruInput type="number" placeholder="Top" value={settings.padding?.top ?? ''} onChange={(e) => handleSubFieldUpdate('padding', 'top', e.target.value, true)} /><ZoruInput type="number" placeholder="Right" value={settings.padding?.right ?? ''} onChange={(e) => handleSubFieldUpdate('padding', 'right', e.target.value, true)} /><ZoruInput type="number" placeholder="Bottom" value={settings.padding?.bottom ?? ''} onChange={(e) => handleSubFieldUpdate('padding', 'bottom', e.target.value, true)} /><ZoruInput type="number" placeholder="Left" value={settings.padding?.left ?? ''} onChange={(e) => handleSubFieldUpdate('padding', 'left', e.target.value, true)} /></div></div>
                        </ZoruAccordionContent>
                    </ZoruAccordionItem>
                    <ZoruAccordionItem value="advanced_effects">
                        <ZoruAccordionTrigger>Motion Effects</ZoruAccordionTrigger>
                        <ZoruAccordionContent className="space-y-4 pt-2">
                            <div className="space-y-2"><ZoruLabel>Hover Animation</ZoruLabel><ZoruSelect value={settings.hover?.animation || 'none'} onValueChange={(val) => handleSubFieldUpdate('hover', 'animation', val)}><ZoruSelectTrigger><ZoruSelectValue/></ZoruSelectTrigger><ZoruSelectContent>{hoverAnimationOptions.map(opt => <ZoruSelectItem key={opt.value} value={opt.value}>{opt.label}</ZoruSelectItem>)}</ZoruSelectContent></ZoruSelect></div>
                            <div className="space-y-2"><ZoruLabel>Entrance Animation</ZoruLabel><ZoruSelect value={settings.animation || 'none'} onValueChange={(val) => handleUpdate('animation', val)}><ZoruSelectTrigger><ZoruSelectValue/></ZoruSelectTrigger><ZoruSelectContent><ZoruSelectItem value="none">None</ZoruSelectItem><ZoruSelectItem value="fade">Fade In</ZoruSelectItem><ZoruSelectItem value="slide-up">Slide In Up</ZoruSelectItem></ZoruSelectContent></ZoruSelect></div>
                            <div className="grid grid-cols-2 gap-4">
                    ...
                    <ZoruAccordionItem value="advanced_responsive">
                        ...
                        <ZoruAccordionContent className="space-y-4 pt-2">
                            ...
                            <ZoruLabel>Alignment</ZoruLabel>
                             <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2"><ZoruLabel className="text-xs">Tablet</ZoruLabel><ZoruSelect value={settings.tabletAlign || '__inherit__'} onValueChange={v => handleUpdate('tabletAlign', v === '__inherit__' ? '' : v)}><ZoruSelectTrigger><ZoruSelectValue placeholder="Inherit"/></ZoruSelectTrigger><ZoruSelectContent><ZoruSelectItem value="__inherit__">Inherit</ZoruSelectItem><ZoruSelectItem value="left">Left</ZoruSelectItem><ZoruSelectItem value="center">Center</ZoruSelectItem><ZoruSelectItem value="right">Right</ZoruSelectItem><ZoruSelectItem value="justify">Justify</ZoruSelectItem></ZoruSelectContent></ZoruSelect></div>
                                <div className="space-y-2"><ZoruLabel className="text-xs">Mobile</ZoruLabel><ZoruSelect value={settings.mobileAlign || '__inherit__'} onValueChange={v => handleUpdate('mobileAlign', v === '__inherit__' ? '' : v)}><ZoruSelectTrigger><ZoruSelectValue placeholder="Inherit"/></ZoruSelectTrigger><ZoruSelectContent><ZoruSelectItem value="__inherit__">Inherit</ZoruSelectItem><ZoruSelectItem value="left">Left</ZoruSelectItem><ZoruSelectItem value="center">Center</ZoruSelectItem><ZoruSelectItem value="right">Right</ZoruSelectItem><ZoruSelectItem value="justify">Justify</ZoruSelectItem></ZoruSelectContent></ZoruSelect></div>
                            </div>
                        </ZoruAccordionContent>
                    </ZoruAccordionItem>
