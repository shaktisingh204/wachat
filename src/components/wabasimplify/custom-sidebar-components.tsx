...
export const SabChatIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 512 512" fill="currentColor" {...props}>
    <path d="M220.33,216.81h23.28c-.37,12.74,6.59,16.38,10.45,18.81,3.86,2.43,16.6,6.48,17.89,7.29,1.29.81,4.89,2.36,5.12,5.41.22,3.05.18,7.91-8.06,8.83-8.24.92-15.13-2.39-19.91-8.39l-10.51,10.51s10.08,11.54,25.19,11.58c13.76.03,17.67-2.65,23.85-7.43,4.19-3.24,5.15-8.82,5.34-12.08v36.96h-55.05c-9.71,0-17.58-7.87-17.58-17.58v-53.9Z" />
    <path d="M311.9,197.01v51.75h-18.94s1.66-9.78-7.03-16.26c-6.18-4.71-17.22-7.66-17.22-7.66,0,0-11.59-3.09-8.87-10.78,3.83-6.26,13.4-3.31,13.4-3.31,0,0,5.67,1.47,9.39,6.4l10.64-10.64s-7.18-9.97-23.08-9.97-26.2,7.53-26.57,20.27v-37.39h50.71c9.71,0,17.58,7.87,17.58,17.58Z" />
    <path d="M292.97,251.33v-2.57s.09,1.02,0,2.57Z" fill="#7058a5" />
  </svg>
);
