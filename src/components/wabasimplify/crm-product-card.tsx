            ...
            <div className="group block flex-grow flex flex-col">
                <CardHeader className="p-0">
                    <div className="relative aspect-[4/5] bg-muted">
                        <Image src={getImage() || 'https://placehold.co/400x500.png'} alt={product.name} layout="fill" objectFit="cover" className="rounded-t-lg" data-ai-hint="product photo" />
                    </div>
                    <div className="p-4">
                ...
                <CardContent className="p-4 pt-0 flex-grow">
                    ...
                    <div className="flex justify-between items-center mt-4">
                        <p className="text-lg font-semibold">{new Intl.NumberFormat('en-US', { style: 'currency', currency }).format(getPrice())}</p>
                        {stockStatus()}
                    </div>
                </CardContent>
            </div>
