...
import type { Project, Template, MetaFlow, Tag } from '@/lib/definitions';
  ...
  return (
    <Card className="card-gradient card-gradient-green">
      <form ref={formRef} action={formAction}>
          ...
          <CardDescription>Select a phone number, a message type, and your audience.</CardDescription>
          </CardHeader>
          <CardContent className="grid md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2 space-y-2">
                <Label htmlFor="templateId">3. Select Message Template or Flow</Label>
                {broadcastType === 'template' ? (
                    ...
                    <Select name="metaFlowId" required value={selectedFlowId} onValueChange={setSelectedFlowId}>
                        <SelectTrigger id="metaFlowId"><SelectValue placeholder="Choose a published flow..." /></SelectTrigger>
                        <SelectContent searchable>
                        {publishedFlows.length > 0 ? (
                            ...
                            <div className="p-4 text-center text-sm text-muted-foreground">No published flows found. <br/> Please create or sync one.</div>
                        )}
                        </SelectContent>
                    </Select>
                )}
