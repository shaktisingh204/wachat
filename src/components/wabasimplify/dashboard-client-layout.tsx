...
import { MetaIcon, WhatsAppIcon, SeoIcon, CustomEcommerceIcon, WaPayIcon, InstagramIcon, IndianRupee, FilePlus } from '@/components/wabasimplify/custom-sidebar-components';
