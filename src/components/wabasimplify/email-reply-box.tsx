            ...
            <div className="border rounded-lg">
                ...
                <div className="p-2 border-t flex justify-between items-center">
                    <div className="flex items-center gap-1">
                        <ZoruButton variant="ghost" size="icon" disabled><Paperclip className="h-4 w-4"/></ZoruButton>
                        <ZoruButton variant="ghost" size="icon" disabled><Code className="h-4 w-4"/></ZoruButton>
                    </div>
                    <SubmitButton />
                </div>
            </div>
