            ...
            <Tabs defaultValue="add" className="w-full">
                ...
                <TabsContent value="add" className="p-4 space-y-4">
                    <div className="space-y-2">
                        <h3 className="text-sm font-medium text-[var(--st-text)]">Layout</h3>
                        <DraggableSidebarItem type="SECTION" label="Section" />
                    </div>
                    <div className="space-y-2">
                        <h3 className="text-sm font-medium text-[var(--st-text)]">Basic Widgets</h3>
                ...
                <TabsContent value="edit" className="p-4 h-[calc(100vh-100px)] overflow-hidden flex flex-col">
                    {selectedElement ? (
                        ...
                        <div className="text-center text-[var(--st-text)] py-10">Select an element to edit</div>
                    )}
                </TabsContent>
