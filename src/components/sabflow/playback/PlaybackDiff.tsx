    ...
    <div className="flex flex-col gap-2 text-[var(--gray-12)]">
      ...
      <div className="flex flex-wrap items-center gap-2 rounded-xl border border-[var(--gray-5)] bg-[var(--gray-1)] px-3.5 py-2.5">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          {stats.removed > 0 && (
            <span className="rounded-md border border-red-200 bg-red-50 px-1.5 py-0.5 text-[11px] font-medium tabular-nums text-red-700 dark:border-red-900/60 dark:bg-red-950/30 dark:text-red-300">
              −{stats.removed}
            </span>
          )}
          {stats.added > 0 && (
            <span className="rounded-md border border-green-200 bg-green-50 px-1.5 py-0.5 text-[11px] font-medium tabular-nums text-green-700 dark:border-green-900/60 dark:bg-green-950/30 dark:text-green-300">
              +{stats.added}
            </span>
          )}
          {!hasChanges && (
      ...
      <div className="grid grid-cols-2 gap-px">
        <div className="flex items-center gap-2 rounded-tl-lg rounded-tr-none border border-[var(--gray-5)] bg-[var(--gray-2)] px-3 py-1.5">
          <span className="flex h-4 w-4 shrink-0 items-center justify-center rounded-sm bg-red-100 text-[9px] font-bold text-red-600 dark:bg-red-950/40 dark:text-red-400">
            A
          </span>
        ...
        <div className="flex items-center gap-2 rounded-tl-none rounded-tr-lg border border-l-0 border-[var(--gray-5)] bg-[var(--gray-2)] px-3 py-1.5">
          <span className="flex h-4 w-4 shrink-0 items-center justify-center rounded-sm bg-green-100 text-[9px] font-bold text-green-600 dark:bg-green-950/40 dark:text-green-400">
            B
          </span>
          <span className="text-[11.5px] font-medium text-[var(--gray-11)] truncate">
            {fieldLabel} · event B
