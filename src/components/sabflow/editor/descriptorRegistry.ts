...
const RUST_CATEGORY_META: Record<string, { label: string; color: string; order: number }> = {
  communication: { label: 'Communication (n8n)',  color: '#0ea5e9', order: 1 },
  productivity:  { label: 'Productivity (n8n)',   color: '#a855f7', order: 2 },
  crm:           { label: 'CRM (n8n)',            color: '#3b82f6', order: 3 },
  sales:         { label: 'Sales (n8n)',          color: '#6366f1', order: 4 },
  marketing:     { label: 'Marketing (n8n)',      color: '#ec4899', order: 5 },
  finance:       { label: 'Finance (n8n)',        color: '#22c55e', order: 6 },
  storage:       { label: 'Storage (n8n)',        color: '#0891b2', order: 7 },
  files:         { label: 'Files (n8n)',          color: '#f59e0b', order: 8 },
  database:      { label: 'Databases (n8n)',      color: '#336791', order: 9 },
  analytics:     { label: 'Analytics (n8n)',      color: '#14b8a6', order: 10 },
  ai:            { label: 'AI (n8n)',             color: '#f76808', order: 11 },
  developer:     { label: 'Developer (n8n)',      color: '#737373', order: 12 },
  hr:            { label: 'HR (n8n)',             color: '#10b981', order: 13 },
  action:        { label: 'Actions (n8n)',        color: '#f97316', order: 14 },
  trigger:       { label: 'Triggers (n8n)',       color: '#8b5cf6', order: 15 },
  logic:         { label: 'Logic (n8n)',          color: '#fb923c', order: 16 },
  transform:     { label: 'Transform (n8n)',      color: '#9333ea', order: 17 },
  misc:          { label: 'Miscellaneous (n8n)',  color: '#94a3b8', order: 18 },
};
