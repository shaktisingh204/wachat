      ...
      <ZoruDialogContent className="max-w-lg">
        <ZoruDialogHeader>
          <ZoruDialogTitle className="flex items-center gap-2">
            <LuArrowUpRight className="h-4 w-4 text-amber-500" />
            Upgrade template
          </ZoruDialogTitle>
          <ZoruDialogDescription>
  ...
  return (
    <div className="space-y-3">
      ...
      <NodeList
        ...
        colorClass="text-rose-600 bg-rose-500/10 border-rose-500/30"
      />
      <NodeList
        label="Changed nodes"
...
function ConnectionDelta({
  ...
  return (
    <div className="flex flex-wrap gap-2">
      {added > 0 && (
        <span className="flex items-center gap-1 rounded border border-emerald-500/30 bg-emerald-500/10 px-2 py-0.5 text-xs text-emerald-600">
          <LuPlus className="h-3 w-3" />
          {added} connection{added !== 1 ? 's' : ''} added
        </span>
      )}
      {removed > 0 && (
        <span className="flex items-center gap-1 rounded border border-rose-500/30 bg-rose-500/10 px-2 py-0.5 text-xs text-rose-600">
