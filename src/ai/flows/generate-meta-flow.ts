...
const FormComponentSchema: z.ZodType<any> = z.lazy(() => z.union([
    ...
    z.object({ 
        ...
        name: z.string(), 
        label: z.string(), 
        "data-source": z.array(z.object({ 
            id: z.string(), 
            title: z.string(),
            description: z.string().optional(),
            metadata: z.string().optional(),
            enabled: z.boolean().optional(),
        })).describe("Array of options for the dropdown."), 
        required: z.boolean().optional(),
    ...
    z.object({ 
        ...
        name: z.string(), 
        label: z.string(), 
        "min-date": z.string().optional().describe('Minimum selectable date, formatted "YYYY-MM-DD"'), 
        "max-date": z.string().optional().describe('Maximum selectable date, formatted "YYYY-MM-DD"'),
        "unavailable-dates": z.array(z.string()).optional().describe('Array of dates (strings, "YYYY-MM-DD") that cannot be selected'),
        visible: z.union([z.boolean(), z.string()]).optional(),
        enabled: z.union([z.boolean(), z.string()]).optional(),
        "helper-text": z.string().optional(),
        required: z.boolean().optional(),
        "init-value": z.string().optional().describe('Pre-selected date, format "YYYY-MM-DD"'),
        "error-message": z.string().optional(),
        "on-select-action": ActionSchema.optional()
    }),
    z.object({ 
