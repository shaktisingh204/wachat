...
// PORT-NOTE: RelationType is inlined here since the interface module has no
// Mongo analogue. FieldMetadataEntity / FlatFieldMetadata merged into a
// single local union type below.
