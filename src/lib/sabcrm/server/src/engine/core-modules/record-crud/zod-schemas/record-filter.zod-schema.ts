...
import {
  RelationType,
  generateFieldFilterZodSchema,
} from '@/lib/sabcrm/server/src/engine/core-modules/record-crud/zod-schemas/field-filters.zod-schema';

// PORT-NOTE: shouldExcludeFieldFromAgentToolSchema inlined — excludes system
// relation-only fields that have no direct user-facing filter surface.
const shouldExcludeFieldFromAgentToolSchema = (field: {
  type: string;
