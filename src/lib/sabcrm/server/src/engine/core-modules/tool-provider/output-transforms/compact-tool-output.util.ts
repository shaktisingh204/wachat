// PORT-NOTE: Pure utility — straight port. Import remapped to ported target.

import { stripEmptyValues } from '@/lib/sabcrm/server/src/engine/core-modules/tool-provider/output-transforms/strip-empty-values.util';
