import type { WorkspaceMigrationBuilderException } from "@/lib/sabcrm/server/src/engine/workspace-manager/workspace-migration/exceptions/workspace-migration-builder-exception";
