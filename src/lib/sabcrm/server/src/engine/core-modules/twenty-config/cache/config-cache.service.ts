...
import {
  ...
  type ConfigKey,
  type ConfigValue,
} from '@/lib/sabcrm/server/src/engine/core-modules/twenty-config/cache/interfaces/config-cache-entry.interface';

// PORT-NOTE: NestJS @Injectable / OnModuleDestroy removed. This is now a plain
// singleton class. Callers construct it with `new ConfigCacheService()` or use
// the module-level singleton exported below.
export class ConfigCacheService {
  ...
  // Called in place of NestJS onModuleDestroy
  destroy(): void {
    this.clearAll();
  }
