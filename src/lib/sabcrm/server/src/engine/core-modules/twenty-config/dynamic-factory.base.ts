// PORT-NOTE: Ported from twenty-server. NestJS DI removed; ConfigGroupHashService and
// TwentyConfigService are used as plain class references rather than injected services.
