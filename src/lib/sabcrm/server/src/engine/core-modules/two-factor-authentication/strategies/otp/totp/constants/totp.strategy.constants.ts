...
import { type OTPStatus } from "@/lib/sabcrm/server/src/engine/core-modules/two-factor-authentication/strategies/otp/otp.constants";
...
export const TOTP_STRATEGY_CONFIG_SCHEMA = z.object({
  algorithm: z
    .nativeEnum(TOTPHashAlgorithms, {
      errorMap: () => ({
        message: "Invalid algorithm specified. Must be SHA1, SHA256, or SHA512.",
      }),
    })
    .optional(),
  digits: z
