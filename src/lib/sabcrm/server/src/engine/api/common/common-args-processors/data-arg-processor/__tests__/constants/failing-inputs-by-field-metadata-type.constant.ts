...
// PORT-NOTE: joinColumnNameForManyToOneMorphRelationField1 was imported from a test integration util
// that does not exist in SabNode — using a string literal placeholder for the morph relation column name.
