...
import { type LinksFieldGraphQLInput } from 'src/lib/sabcrm/server/src/engine/core-modules/record-transformer/utils/transform-links-value.util';
    ...
    switch (subField) {
      ...
      default:
        throw new CommonQueryRunnerException(
          ...
          { userFriendlyMessage: 'Invalid value for links.' },
        );
    }
  }
