...
import { validateTextFieldOrThrow } from 'src/lib/sabcrm/server/src/engine/api/common/common-args-processors/data-arg-processor/validator-utils/validate-text-field-or-throw.util';
import {
  CommonQueryRunnerException,
  CommonQueryRunnerExceptionCode,
} from 'src/lib/sabcrm/server/src/engine/api/common/common-query-runners/errors/common-query-runner.exception';
import { type PhonesFieldGraphQLInput } from 'src/lib/sabcrm/server/src/engine/core-modules/record-transformer/utils/transform-phones-value.util';
    ...
    switch (subField) {
      ...
      default:
        throw new CommonQueryRunnerException(
          ...
          { userFriendlyMessage: 'Invalid value for phones.' },
        );
    }
  }
