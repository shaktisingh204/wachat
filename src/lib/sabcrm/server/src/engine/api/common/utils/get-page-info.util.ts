...
import { type ObjectRecordOrderBy } from '@/lib/sabcrm/server/src/engine/api/graphql/workspace-query-builder/interfaces/object-record.interface';

import { type CommonPageInfo } from '@/lib/sabcrm/server/src/engine/api/common/types/common-page-info.type';
import {
  encodeCursor,
  getPaginationInfo,
} from '@/lib/sabcrm/server/src/engine/api/graphql/graphql-query-runner/utils/cursors.util';
