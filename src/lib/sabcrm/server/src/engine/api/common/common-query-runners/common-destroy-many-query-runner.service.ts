...
import { QUERY_MAX_RECORDS_FROM_RELATION } from "@/lib/sabcrm/shared/constants";
...
import { buildMutationQueryBuilder } from "@/lib/sabcrm/server/src/engine/api/common/common-query-runners/utils/build-mutation-query-builder.util";
...
// PORT-NOTE: NestJS @Injectable() removed. Plain exported class.
