...
import { validateRatingAndSelectFieldOrThrow } from '@/lib/sabcrm/server/src/engine/api/common/common-args-processors/data-arg-processor/validator-utils/validate-rating-and-select-field-or-throw.util';
...
import { validateUUIDFieldOrThrow } from '@/lib/sabcrm/server/src/engine/api/common/common-args-processors/data-arg-processor/validator-utils/validate-uuid-field-or-throw.util';
    ...
    switch (subField) {
      ...
      default:
        throw new CommonQueryRunnerException(
          ...
          { userFriendlyMessage: 'Invalid value for actor.' },
        );
    }
  }
