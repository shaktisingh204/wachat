import {
  ...
  FieldMetadataType,
} from '@/lib/sabcrm/shared/src/types/FieldMetadataType';
import { RelationType } from '@/lib/sabcrm/shared/src/types/RelationType';

// PORT-NOTE: joinColumnNameForManyToOneMorphRelationField1 was sourced from a test integration util
// not present in SabNode — using a string literal placeholder for the morph relation column name.
const joinColumnNameForManyToOneMorphRelationField1 =
  'manyToOneMorphRelationField1Id';
