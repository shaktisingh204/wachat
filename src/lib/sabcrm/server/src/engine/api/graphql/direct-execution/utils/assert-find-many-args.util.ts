...
import { isDefined, isEmptyObject } from '@/lib/sabcrm/shared/src/utils';

import {
  GraphqlDirectExecutionException,
  GraphqlDirectExecutionExceptionCode,
} from '@/lib/sabcrm/server/src/engine/api/graphql/direct-execution/errors/graphql-direct-execution.exception';
...
import { type FindManyResolverArgs } from '@/lib/sabcrm/server/src/engine/api/graphql/workspace-resolver-builder/interfaces/workspace-resolvers-builder.interface';
