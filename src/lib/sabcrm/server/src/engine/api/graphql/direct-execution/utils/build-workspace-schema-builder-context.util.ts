...
import { type ResolverNameMapEntry } from '@/lib/sabcrm/server/src/engine/api/graphql/direct-execution/utils/build-resolver-name-map.util';
import { type WorkspaceSchemaBuilderContext } from '@/lib/sabcrm/server/src/engine/api/graphql/workspace-schema-builder/interfaces/workspace-schema-builder-context.interface';
