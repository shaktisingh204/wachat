// PORT-NOTE: server-logic (mock / test fixture)
// Original: Twenty object-metadata-item mock using TypeORM entities and twenty-shared types.
// Ported faithfully; NestJS-specific imports dropped, SabNode path aliases substituted.
// Import paths for FieldMetadataEntity and ObjectMetadataEntity point to their ported targets.
...
import type { FieldMetadataComplexOption } from "@/lib/sabcrm/server/src/engine/metadata-modules/field-metadata/dtos/options.input";
...
import { getMockFieldMetadataEntity } from "@/lib/sabcrm/server/src/utils/__test__/get-field-metadata-entity.mock";
