// PORT-NOTE: Pure utility — ported as-is. Imports remapped to SabNode target paths.
...
import { type MetadataUniversalFlatEntityPropertiesToCompare } from '@/lib/sabcrm/server/src/engine/workspace-manager/workspace-migration/universal-flat-entity/types/metadata-universal-flat-entity-properties-to-compare.type';
import { type AllFlatWorkspaceMigrationAction } from '@/lib/sabcrm/server/src/engine/workspace-manager/workspace-migration/workspace-migration-builder/types/workspace-migration-action-common';
import { METADATA_EVENTS_TO_EMIT } from '@/lib/sabcrm/server/src/engine/workspace-manager/workspace-migration/workspace-migration-runner/constants/metadata-event-to-emit.constant';
import {
...
} from '@/lib/sabcrm/server/src/engine/workspace-manager/workspace-migration/workspace-migration-runner/types/metadata-event';
...
const deriveAllMetadataEventsFromUpdateAction = ({
  ...
  switch (flatAction.metadataName) {
    ...
    default: {
      const _exhaustive: never = flatAction;
      return [];
    }
  }
};
