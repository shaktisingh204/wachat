...
// This utility resolves universal identifiers to concrete IDs when building a FlatObjectMetadata
// for a create-object action. There is no Postgres DDL here — the logic is pure mapping and
// is ported faithfully. No Mongo index creation is required.
...
import { type ExtractUniversalForeignKeyAggregatorForMetadataName } from "@/lib/sabcrm/server/src/engine/workspace-manager/workspace-migration/universal-flat-entity/constants/all-universal-flat-entity-foreign-key-aggregator-properties.constant";
import { type UniversalFlatObjectMetadata } from "@/lib/sabcrm/server/src/engine/workspace-manager/workspace-migration/universal-flat-entity/types/universal-flat-object-metadata.type";
