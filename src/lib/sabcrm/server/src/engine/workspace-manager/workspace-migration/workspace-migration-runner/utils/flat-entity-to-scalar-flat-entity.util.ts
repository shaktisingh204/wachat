...
import { ALL_ENTITY_PROPERTIES_CONFIGURATION_BY_METADATA_NAME } from '@/lib/sabcrm/server/src/engine/metadata-modules/flat-entity/constant/all-entity-properties-configuration-by-metadata-name.constant';
