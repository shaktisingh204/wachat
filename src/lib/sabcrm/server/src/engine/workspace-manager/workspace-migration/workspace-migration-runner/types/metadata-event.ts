// PORT-NOTE: Pure type module — ported as-is. Imports remapped to SabNode target paths.

import { type AllMetadataName } from '@/lib/sabcrm/shared/src/metadata/types/all-metadata-name';
import { type MetadataEntity } from '@/lib/sabcrm/server/src/engine/metadata-modules/flat-entity/types/metadata-entity.type';
...
import { type ScalarFlatEntity } from '@/lib/sabcrm/server/src/engine/metadata-modules/flat-entity/types/scalar-flat-entity.type';
