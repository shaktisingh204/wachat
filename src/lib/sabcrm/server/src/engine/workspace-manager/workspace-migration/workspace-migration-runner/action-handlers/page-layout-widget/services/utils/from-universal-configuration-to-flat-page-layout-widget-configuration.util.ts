...
// This file contains pure mapping logic (universal identifiers -> concrete IDs) and
// has no Postgres DDL. It is ported faithfully — no Mongo index creation is required.
...
import { type FlatPageLayoutWidget } from "@/lib/sabcrm/server/src/engine/metadata-modules/flat-page-layout-widget/types/flat-page-layout-widget.type";
import { WidgetConfigurationType } from "@/lib/sabcrm/server/src/engine/metadata-modules/page-layout-widget/enums/widget-configuration-type.type";
