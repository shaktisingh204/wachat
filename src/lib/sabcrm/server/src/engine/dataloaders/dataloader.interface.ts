// PORT-NOTE: DataLoader batching pattern is preserved as-is. In Next.js,
// instantiate IDataloaders per request (e.g., in a React cache or middleware).
// The `dataloader` npm package is a direct dependency; install it if not present.
...
import { type ObjectMetadataDTO } from "@/lib/sabcrm/server/src/engine/metadata-modules/object-metadata/dtos/object-metadata.dto";
import { type ViewFieldGroupDTO } from "@/lib/sabcrm/server/src/engine/metadata-modules/view-field-group/dtos/view-field-group.dto";
import { type ViewFieldDTO } from "@/lib/sabcrm/server/src/engine/metadata-modules/view-field/dtos/view-field.dto";
import { type ViewFilterGroupDTO } from "@/lib/sabcrm/server/src/engine/metadata-modules/view-filter-group/dtos/view-filter-group.dto";
import { type ViewFilterDTO } from "@/lib/sabcrm/server/src/engine/metadata-modules/view-filter/dtos/view-filter.dto";
import { type ViewGroupDTO } from "@/lib/sabcrm/server/src/engine/metadata-modules/view-group/dtos/view-group.dto";
import { type ViewSortDTO } from "@/lib/sabcrm/server/src/engine/metadata-modules/view-sort/dtos/view-sort.dto";
