import { isDefined } from '@/lib/sabcrm/shared/src/utils/is-defined.util';

import {
  FlatEntityMapsException,
  FlatEntityMapsExceptionCode,
} from '@/lib/sabcrm/server/src/engine/metadata-modules/flat-entity/exceptions/flat-entity-maps.exception';
import { type FlatConnectionProvider } from '@/lib/sabcrm/server/src/engine/metadata-modules/flat-connection-provider/types/flat-connection-provider.type';
import { type FromEntityToFlatEntityArgs } from '@/lib/sabcrm/server/src/engine/workspace-cache/types/from-entity-to-flat-entity-args.type';
