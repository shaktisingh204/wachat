// PORT-NOTE: No NestJS/TypeORM dependencies. assertUnreachable is inlined
// (twenty-shared/utils not available on the client bundle). Logic ported verbatim.
...
function assertUnreachable(_value: never): never {
  throw new Error(`Unhandled FieldMetadataExceptionCode: ${String(_value)}`);
}
