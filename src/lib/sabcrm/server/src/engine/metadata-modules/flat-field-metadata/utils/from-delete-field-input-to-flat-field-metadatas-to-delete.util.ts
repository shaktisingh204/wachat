...
import { type DeleteOneFieldInput } from "@/lib/sabcrm/server/src/engine/metadata-modules/field-metadata/dtos/delete-field.input";
import {
...
import { findManyFlatEntityByUniversalIdentifierInUniversalFlatEntityMapsOrThrow } from "@/lib/sabcrm/server/src/engine/metadata-modules/flat-entity/utils/find-many-flat-entity-by-universal-identifier-in-universal-flat-entity-maps-or-throw.util";
import { computeFlatFieldMetadataRelatedFlatFieldMetadata } from "@/lib/sabcrm/server/src/engine/metadata-modules/flat-field-metadata/utils/compute-flat-field-metadata-related-flat-field-metadata.util";
import { type FlatIndexMetadata } from "@/lib/sabcrm/server/src/engine/metadata-modules/flat-index-metadata/types/flat-index-metadata.type";
import { generateFlatIndexMetadataWithNameOrThrow } from "@/lib/sabcrm/server/src/engine/metadata-modules/index-metadata/utils/generate-flat-index.util";
