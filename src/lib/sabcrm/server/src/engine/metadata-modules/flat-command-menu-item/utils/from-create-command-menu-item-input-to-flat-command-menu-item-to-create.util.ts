...
import { type FlatApplication } from 'src/lib/sabcrm/server/src/engine/core-modules/application/types/flat-application.type';
import { type CreateCommandMenuItemInput } from 'src/lib/sabcrm/server/src/engine/metadata-modules/command-menu-item/dtos/create-command-menu-item.input';
import { CommandMenuItemAvailabilityType } from 'src/lib/sabcrm/server/src/engine/metadata-modules/command-menu-item/enums/command-menu-item-availability-type.enum';
