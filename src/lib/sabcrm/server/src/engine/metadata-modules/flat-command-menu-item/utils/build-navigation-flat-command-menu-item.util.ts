...
import { TWENTY_STANDARD_APPLICATION } from 'src/lib/sabcrm/server/src/engine/workspace-manager/twenty-standard-application/constants/twenty-standard-applications';
