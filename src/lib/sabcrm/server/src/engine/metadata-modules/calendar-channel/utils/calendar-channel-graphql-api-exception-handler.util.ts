...
} from '@/lib/sabcrm/server/src/engine/metadata-modules/connected-account/connected-account.exception';

export const calendarChannelGraphqlApiExceptionHandler = (error: Error): never => {
