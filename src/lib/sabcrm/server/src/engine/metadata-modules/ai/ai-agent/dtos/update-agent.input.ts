// PORT-NOTE: Ported from twenty-server ai-agent/dtos/update-agent.input.ts (GraphQL InputType).
// NestJS GraphQL @InputType/@Field decorators, class-validator, and
