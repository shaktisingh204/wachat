// PORT-NOTE: Ported from twenty-server database/commands/workspace-export/utils.
// isDefined from twenty-shared is inlined here as a simple null/undefined check.
