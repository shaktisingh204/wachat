// server-logic: filterEventsAndReturnCancelledEvents — pure util.

import { filterOutBlocklistedEvents } from "@/lib/sabcrm/server/src/modules/calendar/calendar-event-import-manager/utils/filter-out-blocklisted-events.util";
