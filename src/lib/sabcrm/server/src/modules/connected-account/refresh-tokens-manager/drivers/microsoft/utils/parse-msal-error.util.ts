...
// PORT-NOTE: @azure/msal-node types are used for error classification.
// If @azure/msal-node is not installed, these imports should be shimmed or
// the package added to dependencies. The logic is otherwise a direct port.
