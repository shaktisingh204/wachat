...
import { bold } from '@/lib/sabcrm/emails/src/utils/email-renderer/marks/bold';
import { italic } from '@/lib/sabcrm/emails/src/utils/email-renderer/marks/italic';
import { link } from '@/lib/sabcrm/emails/src/utils/email-renderer/marks/link';
import { strike } from '@/lib/sabcrm/emails/src/utils/email-renderer/marks/strike';
import { underline } from '@/lib/sabcrm/emails/src/utils/email-renderer/marks/underline';
