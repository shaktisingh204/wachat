...
export const PROJECTS_OBJECT: ObjectMetadata = {
  ...
  fields: [
    ...
    {
      key: PROJECT_FIELDS.accountId,
      label: 'Account',
      type: 'RELATION',
      icon: 'building-2',
      inTable: true,
      description: 'The client / company this project is for.',
      relation: { targetObject: 'companies', kind: 'MANY_TO_ONE', labelField: 'name' },
    },
    {
      key: PROJECT_FIELDS.contactId,
      label: 'Primary contact',
      type: 'RELATION',
      icon: 'user',
      inTable: false,
      description: 'Main point of contact for the project.',
      relation: { targetObject: 'people', kind: 'MANY_TO_ONE', labelField: 'name' },
    },
    {
      key: PROJECT_FIELDS.dealId,
      label: 'Linked deal',
      type: 'RELATION',
      icon: 'target',
      inTable: false,
      description: 'The deal / opportunity this project delivers.',
      relation: { targetObject: 'leads', kind: 'MANY_TO_ONE', labelField: 'name' },
    },
    {
