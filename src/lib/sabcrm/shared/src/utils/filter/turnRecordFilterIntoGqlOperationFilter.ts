...
import { CustomError } from '@/lib/sabcrm/shared/src/utils/errors/CustomError';
import { checkIfShouldComputeEmptinessFilter } from '@/lib/sabcrm/shared/src/utils/filter/checkIfShouldComputeEmptinessFilter';
import { computeGqlOperationFilterForEmails } from '@/lib/sabcrm/shared/src/utils/filter/compute-record-gql-operation-filter/for-composite-field/computeGqlOperationFilterForEmails';
import { computeGqlOperationFilterForLinks } from '@/lib/sabcrm/shared/src/utils/filter/compute-record-gql-operation-filter/for-composite-field/computeGqlOperationFilterForLinks';
import { resolveDateFilter } from '@/lib/sabcrm/shared/src/utils/filter/dates/utils/resolveDateFilter';
import { resolveDateTimeFilter } from '@/lib/sabcrm/shared/src/utils/filter/dates/utils/resolveDateTimeFilter';
import { getNextPeriodStart } from '@/lib/sabcrm/shared/src/utils/filter/dates/utils/getNextPeriodStart';
import { getPeriodStart } from '@/lib/sabcrm/shared/src/utils/filter/dates/utils/getPeriodStart';
import { resolveRelativeDateFilterStringified } from '@/lib/sabcrm/shared/src/utils/filter/dates/utils/resolveRelativeDateFilterStringified';
import { type RecordFilter } from '@/lib/sabcrm/shared/src/utils/filter/turnRecordFilterGroupIntoGqlOperationFilter';
import { generateILikeFiltersForCompositeFields } from '@/lib/sabcrm/shared/src/utils/filter/utils/generateILikeFiltersForCompositeFields';
import { getEmptyRecordGqlOperationFilter } from '@/lib/sabcrm/shared/src/utils/filter/utils/getEmptyRecordGqlOperationFilter';
import { getFilterTypeFromFieldType } from '@/lib/sabcrm/shared/src/utils/filter/utils/getFilterTypeFromFieldType';
import { isExpectedSubFieldName } from '@/lib/sabcrm/shared/src/utils/filter/utils/isExpectedSubFieldName';
import { arrayOfStringsOrVariablesSchema } from '@/lib/sabcrm/shared/src/utils/filter/utils/validation-schemas/arrayOfStringsOrVariablesSchema';
import { arrayOfUuidOrVariableSchema } from '@/lib/sabcrm/shared/src/utils/filter/utils/validation-schemas/arrayOfUuidsOrVariablesSchema';
import { jsonRelationFilterValueSchema } from '@/lib/sabcrm/shared/src/utils/filter/utils/validation-schemas/jsonRelationFilterValueSchema';
    ...
    case 'RATING':
      switch (recordFilter.operand) {
        case RecordFilterOperand.IS:
          return {
            [fieldMetadataItem.name]: {
              eq: `RATING_${parseFloat(recordFilter.value)}`,
            } as RatingFilter,
          };
        ...
        case RecordFilterOperand.GREATER_THAN_OR_EQUAL:
          return {
            [fieldMetadataItem.name]: {
              in: [`RATING_1`, `RATING_2`, `RATING_3`, `RATING_4`, `RATING_5`].filter(
                (v) => +v.split('_')[1] >= parseFloat(recordFilter.value),
              ),
            } as RatingFilter,
          };
