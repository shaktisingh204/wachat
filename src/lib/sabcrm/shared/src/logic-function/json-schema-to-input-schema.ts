import { type InputJsonSchema } from '@/lib/sabcrm/shared/src/logic-function/input-json-schema.type';
import {
  type InputSchema,
  type InputSchemaProperty,
} from '@/lib/sabcrm/shared/src/workflow/types/InputSchema';
...
// Wraps in a single-element array because SabCRM's InputSchema represents
