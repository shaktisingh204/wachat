import { IDENTIFIER_MAX_CHAR_LENGTH } from '@/lib/sabcrm/shared/src/metadata/constants/identifier-max-char-length.constant';
import { computeMetadataNameFromLabel } from '@/lib/sabcrm/shared/src/metadata/utils/compute-metadata-name-from-label.util';
