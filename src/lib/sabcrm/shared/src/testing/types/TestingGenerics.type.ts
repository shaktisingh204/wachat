 ...
 */
export type HasAllProperties<T, U> = [T] extends [new (...args: unknown[]) => unknown]
  ? HasAllProperties<InstanceType<T & (new (...args: unknown[]) => unknown)>, U>
  : [U] extends [new (...args: unknown[]) => unknown]
    ? HasAllProperties<T, InstanceType<U & (new (...args: unknown[]) => unknown)>>
    : {
