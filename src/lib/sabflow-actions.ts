...
export const sabnodeAppActions = [
  ...
  },
  {
    ...
    actions: [
      ...
      { name: 'update_page_details', label: 'Update Page Details', icon: Edit, description: 'Update the about section or contact info of your Page.', inputs: [{ name: 'about', label: 'About Text', type: 'textarea' }, { name: 'phone', label: 'Phone Number', type: 'tel' }] },
      ...
      { name: 'update_post', label: 'Update Post', icon: Edit, description: 'Edit the message of an existing post.', inputs: [{ name: 'postId', label: 'Post ID', type: 'text' }, { name: 'message', label: 'New Message', type: 'textarea' }] },
