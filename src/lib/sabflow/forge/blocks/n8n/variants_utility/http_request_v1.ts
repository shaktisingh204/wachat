/**
 * Forge block: HTTP Request V1 (legacy n8n shape)
 *
 * Source: n8n-master/packages/nodes-base/nodes/HttpRequest/V1/HttpRequestV1.node.ts
 *
 * Compat-shim — preserves the `forge_http_request_v1` id for flow files
 * pinned to the v1 node. Delegates to the modern `forge_http_request` action.
 */
...
const block: ForgeBlock = {
  id: 'forge_http_request_v1',
  name: 'HTTP Request (v1)',
  description: 'Legacy n8n HTTP Request v1 shape. Delegates to forge_http_request.',
  iconName: 'LuGlobe',
