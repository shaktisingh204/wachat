/**
 * Forge block: EmailSend V2 (legacy n8n shape)
 *
...
const block: ForgeBlock = {
  id: 'forge_emailsend_v2',
  name: 'Email Send (v2)',
  description:
    'Legacy n8n EmailSend v2 shape. Delegates to forge_send_email_n8n.',
  iconName: 'LuMail',
  ...
  actions: [
    {
      ...
      run: async (ctx: ForgeActionContext): Promise<ForgeActionResult> => {
        ...
        if (!target) throw new Error('emailsend v2: no action available');
