/**
 * Forge block: If V2 (legacy n8n shape)
 *
 * Compat-shim — delegates to the modern `forge_if` block.
 */
  ...
  actions: [
    {
      id: 'legacy_action',
      label: 'Legacy action',
      description: 'Forwards to modern If block. Action ids preserved.',
      fields: [
        {
          id: 'targetActionId',
          label: 'Action',
          type: 'text',
          helperText: 'Pick action id from forge_if.',
        },
