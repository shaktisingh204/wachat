...
const metaActions = [
    { name: 'createPost', label: 'Create Post', description: 'Create a new post on your Facebook Page.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }, { name: 'message', label: 'Message', type: 'textarea' }, { name: 'imageUrl', label: 'Image URL (Optional)', type: 'text' }] },
    { name: 'updatePost', label: 'Update Post', description: 'Update the message of an existing post.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }, { name: 'postId', label: 'Post ID', type: 'text' }, { name: 'message', label: 'New Message', type: 'textarea' }] },
    { name: 'deletePost', label: 'Delete Post', description: 'Permanently delete a post.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }, { name: 'postId', label: 'Post ID', type: 'text' }] },
    { name: 'getComments', label: 'Get Comments', description: 'Retrieve comments from a post or another comment.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }, { name: 'objectId', label: 'Post/Comment ID', type: 'text' }] },
    { name: 'postComment', label: 'Post Comment', description: 'Post a comment or reply.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }, { name: 'objectId', label: 'Post/Comment ID', type: 'text' }, { name: 'message', label: 'Comment Text', type: 'textarea' }] },
    { name: 'likeObject', label: 'Like Post/Comment', description: 'Like a post or comment.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }, { name: 'objectId', label: 'Post/Comment ID', type: 'text' }] },
    { name: 'deleteComment', label: 'Delete Comment', description: 'Delete a comment.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }, { name: 'commentId', label: 'Comment ID', type: 'text' }] },
    { name: 'getPagePosts', label: 'Get Page Posts', description: 'Retrieve a list of recent posts from your page.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }] },
    { name: 'getPageInsights', label: 'Get Page Insights', description: 'Get performance metrics for your page.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }] },
    { name: 'sendMessengerMessage', label: 'Send Messenger Message', description: 'Send a text message to a user in Messenger.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }, { name: 'recipientId', label: 'Recipient PSID', type: 'text' }, { name: 'messageText', label: 'Message Text', type: 'textarea' }] },
    { name: 'getPageConversations', label: 'Get Messenger Conversations', description: 'Retrieve a list of recent conversations.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }] },
    { name: 'getConversationMessages', label: 'Get Conversation Messages', description: 'Get messages from a specific Messenger conversation.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }, { name: 'conversationId', label: 'Conversation ID', type: 'text' }] },
    { name: 'scheduleLiveVideo', label: 'Schedule Live Video', description: 'Schedule a pre-recorded video to go live.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }, { name: 'title', label: 'Title', type: 'text' }, { name: 'videoUrl', label: 'Video URL', type: 'text' }, { name: 'scheduledDate', label: 'Date', type: 'date' }, { name: 'scheduledTime', label: 'Time', type: 'time' }] },
    { name: 'getScheduledLiveVideos', label: 'Get Scheduled Live Videos', description: 'Retrieve a list of scheduled live streams.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }] },
    { name: 'getAdCampaigns', label: 'Get Ad Campaigns', description: 'Retrieve a list of ad campaigns.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }] },
    { name: 'getCatalogs', label: 'Get Catalogs', description: 'Get a list of product catalogs.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }] },
    { name: 'getProductsForCatalog', label: 'Get Products in Catalog', description: 'Get products for a specific catalog ID.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }, { name: 'catalogId', label: 'Catalog ID', type: 'text' }] },
    { name: 'addProductToCatalog', label: 'Add Product to Catalog', description: 'Add a new product to a catalog.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }, { name: 'catalogId', label: 'Catalog ID', type: 'text' }, { name: 'name', label: 'Name', type: 'text' }, { name: 'price', label: 'Price', type: 'number' }, { name: 'currency', label: 'Currency', type: 'text' }, { name: 'retailer_id', label: 'SKU', type: 'text' }, { name: 'image_url', label: 'Image URL', type: 'text' }, { name: 'description', label: 'Description', type: 'textarea' }] },
    { name: 'deleteProductFromCatalog', label: 'Delete Product from Catalog', description: 'Delete a product from a catalog.', inputs: [{ name: 'projectId', label: 'Project', type: 'project-selector' }, { name: 'productId', label: 'Product ID', type: 'text' }] },
];
