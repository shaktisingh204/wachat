...
import { UnrecognizedCredentialTypeError } from '@n8n-core/errors/unrecognized-credential-type.error';
import { UnrecognizedNodeTypeError } from '@n8n-core/errors/unrecognized-node-type.error';
