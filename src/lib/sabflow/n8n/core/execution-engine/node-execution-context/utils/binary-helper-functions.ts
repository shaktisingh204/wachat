...
import { BinaryDataService } from '@n8n-core/binary-data/binary-data.service';
import type { BinaryData } from '@n8n-core/binary-data/types';
import { binaryToBuffer } from '@n8n-core/binary-data/utils';
