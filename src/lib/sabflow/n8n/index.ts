...
/* ── Sabflow ↔ n8n bridge (Phase 4) ─────────────────────────────────── */
export { adaptSabFlowDoc, buildN8nWorkflow, adaptVariables } from './adapter';
export type { AdaptedWorkflow, N8nVariable } from './adapter';
export { evaluateExpression, resolveValue } from './expression-runner';
export type { ExpressionContext } from './expression-runner';
