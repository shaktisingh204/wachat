...
export type AuditAction =
  ...
  // ── SabWa (personal WhatsApp / Baileys) ────────────────────────────────
  | 'sabwa.session.connected'
  | 'sabwa.session.disconnected'
  | 'sabwa.session.deleted'
  | 'sabwa.broadcast.sent'
  | 'sabwa.broadcast.cancelled'
  | 'sabwa.automation.created'
  | 'sabwa.automation.updated'
  | 'sabwa.automation.deleted'
  | 'sabwa.automation.toggled'
  | 'sabwa.label.created'
  | 'sabwa.label.applied'
  | 'sabwa.label.removed'
  | 'sabwa.contact.blocked'
  | 'sabwa.contact.unblocked'
