...
const BLOCK_REGISTRY: Record<string, BlockMeta> = {
  ...
  forge_n8n_api:             { label: 'n8n API',        icon: LuGitBranch, category: 'forge', color: '#ea4b71' },
  ...
  forge_n8n_trigger:          { label: 'n8n Trigger',       icon: LuActivity, category: 'forge', color: '#ea4b71' },
  ...
  forge_form_n8n:             { label: 'Form (n8n)',        icon: LuSquareCheck, category: 'forge', color: '#475569' },
