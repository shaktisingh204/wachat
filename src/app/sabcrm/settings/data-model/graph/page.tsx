...
/**
 * SabCRM — Data model GRAPH (`/sabcrm/settings/data-model/graph`).
 *
...
function GraphNode({
  ...
  return (
    <Link
      href={`/sabcrm/settings/data-model#${encodeURIComponent(object.slug)}`}
      className={[
        'dmg-node',
...
export default function DataModelGraphPage(): React.JSX.Element {
  ...
  const header = (
    <TwentyPageHeader
      ...
      icon={GitBranch}
      actions={
        <Link href="/sabcrm/settings/data-model" className="st-btn st-btn--secondary">
    ...
    return (
      <div className="st-page">
        ...
        <div className="st-empty">
          ...
          <Link href="/sabcrm/settings/data-model" className="st-btn st-btn--primary">
            Open data model
          </Link>
        </div>
      </div>
