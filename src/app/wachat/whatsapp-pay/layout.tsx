        ...
        {TABS.map((t) => {
          ...
          return (
            <Link
              ...
              className="inline-flex items-center gap-2 px-3.5 py-2 text-[12.5px] font-medium transition-[background,border-color,color]"
              style={{
                borderRadius: 'var(--st-radius-pill)',
                border: '1px solid',
                borderColor: active ? 'var(--st-text)' : 'var(--st-border)',
                background: active ? 'var(--st-text)' : 'var(--st-bg)',
                color: active ? 'var(--st-bg)' : 'var(--st-text-secondary)',
              }}
            >
              {t.icon}
              {t.label}
