    ...
    <div className="flex flex-col gap-10 pb-10">
      ...
      <section>
        <div className="mb-6 border-b pb-2">
          ...
          <p className="text-muted-foreground text-sm">Follow these steps to connect your Meta App directly using Developer credentials.</p>
        </div>
      ...
      <section>
        <div className="mb-6 border-b pb-2">
          ...
          <p className="text-muted-foreground text-sm">Real-time status checks and testing utilities to ensure your connection is healthy.</p>
        </div>
        <WhatsAppTools />
      </section>
      ...
      <section>
        <div className="mb-6 border-b pb-2">
          ...
          <p className="text-muted-foreground text-sm">Searchable articles, troubleshooting steps, and best practices.</p>
        </div>
        <DocumentationList />
      </section>
    </div>
