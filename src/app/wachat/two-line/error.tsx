...
export default function TwoLineError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[Wachat Two-Line Error]', error);
  }, [error]);
  ...
  return (
    <WaPage>
      <div className="mx-auto flex min-h-[60vh] max-w-md flex-col items-center justify-center text-center">
        ...
        <h1 className="mt-6 text-2xl font-semibold tracking-tight text-zinc-950">Routing failed to load</h1>
        <p className="mt-2 text-[14px] leading-relaxed text-zinc-600">
          {error.message || 'Something went wrong loading routing.'}
        </p>
