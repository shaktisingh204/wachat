...
import { Button, Badge, Card, Separator, ZoruKbd, ScrollArea } from '@/components/zoruui';
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-mono selection:bg-white selection:text-black antialiased">
      ...
      {/* Navigation */}
      <nav className="border-b border-zinc-800 sticky top-0 bg-black/80 backdrop-blur-md z-50">
        <div className="container mx-auto px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Terminal className="h-5 w-5 text-white" />
            <span className="font-bold tracking-tight text-white">SABNODE_API_DOCS</span>
            <Badge variant="outline" className="text-zinc-400 border-zinc-700 rounded-none text-xs">v2.0.0-rc.4</Badge>
          </div>
          <div className="flex items-center gap-6 text-sm text-zinc-400 hidden sm:flex">
            ...
            {loading ? null : session?.user ? (
              <Link href="/wachat">
                <Button className="bg-white text-black hover:bg-zinc-200 rounded-none h-8 font-mono text-xs">
                  [ENTER_WORKSPACE]
                </Button>
              </Link>
            ) : (
        ...
        <main className="flex-1 max-w-4xl">
          <header className="mb-16">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <Button className="bg-white text-black hover:bg-zinc-200 rounded-none font-mono flex items-center gap-2">
                <Terminal className="h-4 w-4" />
                curl https://api.sabnode.com/v2/init
              </Button>
              <Button variant="outline" className="border-zinc-700 text-white hover:bg-zinc-900 rounded-none font-mono">
                View Swagger JSON
              </Button>
            </div>
          </header>
          ...
          <section id="authentication" className="mb-16">
            ...
            <Card className="bg-zinc-950 border-zinc-800 rounded-none overflow-hidden mb-8">
              <div className="bg-zinc-900 border-b border-zinc-800 px-4 py-2 flex items-center justify-between">
                <span className="text-xs text-zinc-400">Request Example</span>
                <ZoruKbd className="bg-zinc-800 text-zinc-300 border-none">bash</ZoruKbd>
              </div>
              <div className="p-4 overflow-x-auto text-sm text-zinc-300 whitespace-pre">
                <code>
<span className="text-zinc-500"># Authenticate your request</span>{'\n'}
            ...
            <div className="space-y-8">
              ...
              <div className="border border-zinc-800 p-6 bg-zinc-950/50">
                <div className="flex items-center gap-4 mb-4">
                  <Badge className="bg-white text-black hover:bg-zinc-200 rounded-none font-bold">POST</Badge>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h5 className="text-xs font-bold uppercase tracking-wider mb-3 text-zinc-500">Parameters</h5>
                    <ul className="space-y-3 text-sm">
                      ...
                      <li className="flex justify-between border-b border-zinc-800 pb-2">
                        ...
                        <span className="text-zinc-500">object (required)</span>
                      </li>
                    </ul>
                  </div>
                  <div>
                    <h5 className="text-xs font-bold uppercase tracking-wider mb-3 text-zinc-500">Response <span className="text-zinc-300">200 OK</span></h5>
                    <pre className="text-xs text-zinc-400 bg-black border border-zinc-800 p-3 overflow-x-auto">
{`{
  "id": "msg_01H...",
  "status": "queued",
  "channel": "whatsapp",
  "created_at": "2026-05-23T01:10:18Z"
              ...
              <div className="border border-zinc-800 p-6 bg-zinc-950/50">
                <div className="flex items-center gap-4 mb-4">
                  <Badge variant="outline" className="border-zinc-500 text-zinc-300 rounded-none font-bold">GET</Badge>
          ...
          <section id="architecture">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="border border-zinc-800 p-5 hover:border-zinc-600 transition-colors bg-zinc-950">
      ...
      <footer className="border-t border-zinc-800 py-12 mt-20">
        <div className="container mx-auto px-6 text-center text-sm text-zinc-500 font-mono">
