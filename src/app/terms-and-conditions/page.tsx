      ...
      <div className="max-w-3xl mx-auto">
        ...
        <Card>
          ...
          <CardContent className="prose prose-sm sm:prose-base lg:prose-lg xl:prose-xl dark:prose-invert max-w-none space-y-4 text-foreground/90">
            ...
            <p>By using SabNode (the "Service"), you agree to be bound by these Terms and Conditions. If you do not agree, do not use the Service.</p>

            <h2 className="text-xl font-semibold">2. Description of Service</h2>
            <p>SabNode provides a platform to interact with the WhatsApp Business API, allowing users to manage message templates, send broadcast messages, and engage with contacts.</p>
            ...
            <p>The Service and its original content, features, and functionality are and will remain the exclusive property of SabNode and its licensors.</p>

            <h2 className="text-xl font-semibold">5. Termination</h2>
            <p>We may terminate or suspend your account immediately, without prior notice or liability, for any reason whatsoever, including without limitation if you breach the Terms.</p>
            
            <h2 className="text-xl font-semibold">6. Limitation of Liability</h2>
            <p>In no event shall SabNode, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.</p>
