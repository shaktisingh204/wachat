    ...
    <div className="flex h-full min-h-screen bg-[var(--gray-1)]">
      ...
      <aside className="w-64 shrink-0 border-r border-[var(--gray-5)] bg-[var(--gray-2)] p-4 overflow-y-auto">
        <div className="mb-4 flex items-center gap-2">
          <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#f76808]/10 text-[#f76808]">
        ...
        <div className="sticky top-0 z-10 border-b border-[var(--gray-5)] bg-[var(--gray-1)]/80 px-6 py-4 backdrop-blur">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg border border-[var(--gray-5)] bg-[var(--gray-2)] py-2 pl-10 pr-3 text-[13px] text-[var(--gray-12)] placeholder:text-[var(--gray-8)] outline-none focus:border-[#f76808]"
            />
          </div>
        </div>
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            ...
            <span className="rounded-full bg-[#f76808]/10 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-[#f76808]">
              ...
              <ul className="space-y-1.5">
                {filters.map((f) => (
                  <li key={f.path} className="flex items-start gap-2 text-[12.5px]">
                    <code className="shrink-0 rounded bg-[var(--gray-3)] px-1.5 py-0.5 font-mono text-[11px] text-[#f76808]">
                      {f.path}
                    </code>
            ...
            <Block title="Examples">
              <ul className="space-y-1.5">
                {doc.examples.map((ex) => (
                  ...
                  >
                    <LuCircleCheck className="mt-[3px] h-3.5 w-3.5 shrink-0 text-emerald-500" />
                    <span>{ex}</span>
                  </li>
                ))}
              </ul>
