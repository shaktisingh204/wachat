      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-6 max-w-3xl">
        ...
        <div className="mt-4">
          ...
          <textarea
            ...
            spellCheck={false}
            rows={10}
            className="w-full rounded-lg border border-[var(--gray-5)] bg-[var(--gray-2)] px-3 py-2 font-mono text-[11.5px] text-[var(--gray-12)] placeholder:text-[var(--gray-8)] outline-none focus:border-violet-400 resize-y"
          />
        ...
        {/* Error */}
        {error && (
          <div className="mt-4 flex items-start gap-2 rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-[12px] text-red-700">
        ...
        {/* Success */}
        {success && (
          <div className="mt-4 flex flex-col gap-2 rounded-lg border border-green-200 bg-green-50 px-4 py-3 dark:border-green-900/50 dark:bg-green-950/30">
            ...
            <button
              type="button"
              onClick={openFlow}
              className="mt-1 self-start inline-flex items-center gap-1.5 rounded-md bg-green-600 px-3 py-1.5 text-[12px] font-semibold text-white hover:bg-green-700"
            >
              Open flow
              <LuArrowRight className="h-3.5 w-3.5" />
            </button>
