      ...
      <div className="flex flex-wrap items-center gap-3 border-b border-[var(--gray-4)] px-4 sm:px-6 py-4 shrink-0">
        ...
        <div className="ml-auto flex flex-wrap items-center gap-2">
          ...
          <button
            type="button"
            onClick={openCreate}
            className="flex items-center gap-1.5 rounded-lg bg-[#f76808] px-3 py-1.5 text-[12px] font-semibold text-white hover:bg-[#e25c00]"
          >
        ...
        {loading && keys.length === 0 ? (
          ...
          <div className="flex h-64 flex-col items-center justify-center gap-3 text-center">
            ...
            <button
              type="button"
              onClick={openCreate}
              className="mt-1 flex items-center gap-1.5 rounded-lg bg-[#f76808] px-3 py-1.5 text-[12px] font-semibold text-white hover:bg-[#e25c00]"
            >
              <LuPlus className="h-3.5 w-3.5" strokeWidth={2.5} />
                ...
                >
                  ...
                  <td className="px-3 py-2.5 text-right">
                    <button
                      ...
                      className="inline-flex items-center gap-1 rounded-md border border-transparent px-2 py-1 text-[11.5px] font-medium text-red-600 hover:border-red-200 hover:bg-red-50 disabled:opacity-50 dark:hover:bg-red-950/40"
                    >
                      {revokingId === row._id ? (
          ...
          >
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                maxLength={80}
                disabled={creating}
                className="rounded-lg border border-[var(--gray-5)] bg-[var(--gray-2)] px-2.5 py-2 text-[12.5px] text-[var(--gray-12)] placeholder:text-[var(--gray-8)] outline-none focus:border-[#f76808] disabled:opacity-50"
              />
      ...
      {minted && (
        ...
        >
          <div className="flex flex-col gap-3">
            <div className="flex items-start gap-2 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2.5 text-[11.5px] text-amber-800 dark:border-amber-900/60 dark:bg-amber-950/30 dark:text-amber-300">
              <LuTriangleAlert className="h-4 w-4 shrink-0 mt-0.5" />
            ...
            <div className="flex items-center justify-end pt-1">
              <button
                ...
                className="rounded-lg bg-[#f76808] px-3 py-1.5 text-[12px] font-semibold text-white hover:bg-[#e25c00]"
              >
                I&rsquo;ve saved it
              </button>
            </div>
