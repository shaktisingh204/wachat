...
export default function DeprecatedProfilePage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full text-center">
            <LoaderCircle className="h-8 w-8 animate-spin text-[var(--st-text-secondary)] mb-4" />
            <h1 className="text-xl font-semibold">This page has moved</h1>
            <p className="text-[var(--st-text-secondary)]">Redirecting you to the new settings page...</p>
        </div>
    );
}
