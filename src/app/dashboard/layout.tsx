...
const instagramMenuGroups = [
  ...
  },
  {
    ...
    items: [
        ...
        { href: '/dashboard/instagram/hashtag-search', label: 'Hashtag Search', icon: Hash },
    ]
  }
];
