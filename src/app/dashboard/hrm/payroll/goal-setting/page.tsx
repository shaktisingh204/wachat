...
export default function GoalSettingPage() {
  ...
  return (
    <HrListShell<Row>
      ...
      icon={Target}
      newHref="/dashboard/hrm/payroll/goal-setting/new"
      editHref={(row) => `/dashboard/hrm/payroll/goal-setting/${String(row._id)}/edit`}
      detailHref={(row) => `/dashboard/hrm/payroll/goal-setting/${String(row._id)}`}
      rows={rows}
      loading={isLoading}
      kpis={kpis}
      statusOptions={[
