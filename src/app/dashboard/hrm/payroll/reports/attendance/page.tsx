                    ...
                    <table className="w-full text-left text-[13px]">
                        <thead>
                            <tr className="border-b border-clay-border bg-clay-surface-2">
                                ...
                                <th className="px-4 py-3 text-center font-medium text-clay-amber">Late</th>
                                <th className="px-4 py-3 text-center font-medium text-clay-blue">WFH</th>
                                <th className="px-4 py-3 text-center font-medium text-clay-ink-muted">Half Day</th>
                                <th className="px-4 py-3 text-center font-medium text-clay-ink-muted">Leave</th>
                                <th className="px-4 py-3 text-center font-medium text-clay-ink-muted">Total Days</th>
                                <th className="px-4 py-3 text-center font-medium text-clay-ink-muted">Attendance %</th>
                            </tr>
                        </thead>
                        <tbody>
                            {isLoading ? (
                                ...
                                <>
                                    {reportData.map(row => (
                                        <tr key={row.employeeId} className="border-b border-clay-border last:border-0 hover:bg-clay-surface-2/50">
                                            ...
                                            <td className="px-4 py-3 text-center text-clay-amber">{row.late}</td>
                                            <td className="px-4 py-3 text-center text-clay-blue">{row.wfh}</td>
                                            <td className="px-4 py-3 text-center text-clay-ink">{row.halfDay}</td>
                                            <td className="px-4 py-3 text-center text-clay-ink">{row.leave}</td>
                                            <td className="px-4 py-3 text-center text-clay-ink">{row.totalWorkingDays}</td>
                                    ...
                                    <tr className="border-t-2 border-clay-border bg-clay-surface-2 font-semibold">
                                        ...
                                        <td className="px-4 py-3 text-center text-clay-amber">{reportData.reduce((s, r) => s + r.late, 0)}</td>
                                        <td className="px-4 py-3 text-center text-clay-blue">{reportData.reduce((s, r) => s + r.wfh, 0)}</td>
                                        <td className="px-4 py-3 text-center text-clay-ink">{reportData.reduce((s, r) => s + r.halfDay, 0)}</td>
                                        <td className="px-4 py-3 text-center text-clay-ink">{reportData.reduce((s, r) => s + r.leave, 0)}</td>
                                        <td className="px-4 py-3 text-center text-clay-ink">{reportData.reduce((s, r) => s + r.totalWorkingDays, 0)}</td>
                                        <td className="px-4 py-3 text-center text-clay-ink">
                                ...
                                <tr>
                                    <td colSpan={10} className="h-24 text-center text-clay-ink-muted">
