...
import type { WsLeaveBalanceEmployee, WsLeaveType, WsLeaveDuration, WsHalfDayType } from '@/lib/worksuite/leave-types';
import { saveLeave, saveLeaveFile } from '@/app/actions/worksuite/leave.actions';
...
export default function ApplyLeaveClient({
  initialTypes,
  initialEmployees,
  initialBalances,
}: {
  ...
  // Initialization handled by server props
