                ...
                {csvData.length > 0 && !isUploading && (
                    <div className="space-y-4">
                        ...
                        <div className="border rounded-md overflow-hidden bg-[var(--st-bg-secondary)]">
                            <div className="grid grid-cols-5 bg-[var(--st-bg-muted)]/50 p-3 text-sm font-medium border-b">
                                        ...
                                        {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    className="grid grid-cols-5 p-3 text-sm border-b items-center hover:bg-[var(--st-bg-muted)]/50 transition-colors"
                                                >
