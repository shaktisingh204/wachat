...
export default async function EditTdsPage({
    ...
    return (
        ...
        >
            <Suspense 
                fallback={
                    <div className="p-6 animate-pulse space-y-6 bg-white rounded-xl shadow-sm border border-[var(--st-border)]">
                        <div className="h-8 bg-[var(--st-bg-muted)] rounded w-1/4"></div>
                        <div className="grid gap-4 sm:grid-cols-2">
                            <div className="h-12 bg-[var(--st-bg-muted)] rounded w-full"></div>
                            <div className="h-12 bg-[var(--st-bg-muted)] rounded w-full"></div>
                        </div>
                        ...
                        <div className="h-24 bg-[var(--st-bg-muted)] rounded w-full mt-4"></div>
                        <div className="flex justify-between pt-4">
                            <div className="h-10 bg-[var(--st-bg-muted)] rounded w-24"></div>
                            <div className="h-10 bg-[var(--st-bg-muted)] rounded w-32"></div>
                        </div>
                    </div>
                }
            >
