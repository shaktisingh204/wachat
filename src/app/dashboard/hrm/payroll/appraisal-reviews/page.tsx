...
export default function AppraisalReviewsPage() {
  ...
  return (
    <HrListShell<Row>
      ...
      icon={Star}
      newHref="/dashboard/hrm/payroll/appraisal-reviews/new"
      editHref={(r) => `/dashboard/hrm/payroll/appraisal-reviews/${r._id}/edit`}
      detailHref={(r) => `/dashboard/hrm/payroll/appraisal-reviews/${r._id}`}
      rows={rows}
      loading={isLoading}
      kpis={kpis}
      statusOptions={[
