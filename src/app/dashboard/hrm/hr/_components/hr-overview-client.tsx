...
export function HrOverviewClient({
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto w-full pb-12">
      ...
      <div className="relative overflow-hidden bg-slate-900/40 p-8 rounded-3xl border border-slate-800/80 backdrop-blur-md shadow-2xl">
        {/* Glow Spheres */}
        ...
        <div className="relative z-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/dashboard/hrm/hr/onboarding/new">
              <Button variant="outline" className="h-10 text-[12.5px] font-bold border-slate-700 bg-slate-800/40 hover:bg-slate-800 hover:text-white text-slate-300 rounded-xl flex items-center gap-1.5 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="bg-slate-900/35 border-slate-800 hover:border-indigo-500/40 backdrop-blur-md p-5 rounded-2xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl flex flex-col justify-between min-h-[140px] group relative overflow-hidden">
          ...
          <div className="flex justify-between items-start">
            <div>
              <p className="text-[12px] font-bold uppercase tracking-wider text-slate-400">Total Directory</p>
              <h3 className="text-3xl font-extrabold text-white mt-2 tracking-tight font-mono">{totalEmployeesCount}</h3>
            </div>
          ...
          <div className="mt-4 pt-3 border-t border-slate-850 flex items-center justify-between text-[11.5px]">
        ...
        <Card className="bg-slate-900/35 border-slate-800 hover:border-emerald-500/40 backdrop-blur-md p-5 rounded-2xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl flex flex-col justify-between min-h-[140px] group relative overflow-hidden">
          ...
          <div className="flex justify-between items-start">
            <div>
              <p className="text-[12px] font-bold uppercase tracking-wider text-slate-400">Open Channels</p>
          ...
          <div className="mt-4 pt-3 border-t border-slate-850 flex items-center justify-between text-[11.5px]">
            ...
            <span className="text-slate-300 font-bold font-mono">{jobs.length} Total</span>
          </div>
        </Card>
        ...
        <Card className="bg-slate-900/35 border-slate-800 hover:border-amber-500/40 backdrop-blur-md p-5 rounded-2xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl flex flex-col justify-between min-h-[140px] group relative overflow-hidden">
          ...
          <div className="flex justify-between items-start">
            <div>
              <p className="text-[12px] font-bold uppercase tracking-wider text-slate-400">New Hires Onboarding</p>
              <h3 className="text-3xl font-extrabold text-white mt-2 tracking-tight font-mono">{onboardingKpis.inProgress}</h3>
            </div>
          ...
          <div className="mt-4 pt-3 border-t border-slate-850 flex items-center justify-between text-[11.5px]">
            <span className="text-slate-400 font-medium">Completed This Month</span>
        ...
        <Card className="bg-slate-900/35 border-slate-800 hover:border-rose-500/40 backdrop-blur-md p-5 rounded-2xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl flex flex-col justify-between min-h-[140px] group relative overflow-hidden">
          ...
          <div className="flex justify-between items-start">
            <div>
              <p className="text-[12px] font-bold uppercase tracking-wider text-slate-400">Compliance Rate</p>
              <h3 className="text-3xl font-extrabold text-white mt-2 tracking-tight font-mono">100%</h3>
            </div>
          ...
          <div className="mt-4 pt-3 border-t border-slate-850 flex items-center justify-between text-[11.5px]">
            <span className="text-slate-400 font-medium">Active Policy Manuals</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="bg-slate-900/35 border-slate-800 backdrop-blur-md p-6 rounded-2xl flex flex-col">
            <div className="flex items-center justify-between pb-4 border-b border-slate-850">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-[15.5px] font-extrabold tracking-tight text-white">Active Onboarding Pipeline</h3>
                  <p className="text-[12px] text-slate-400 mt-0.5">Tracking completion progress for newly recruited staff members.</p>
                </div>
              </div>
              <Link href="/dashboard/hrm/hr/onboarding">
                <Button variant="outline" size="sm" className="h-8 text-[11.5px] border-slate-700 bg-slate-800/40 text-slate-300 font-bold rounded-lg hover:bg-slate-800 hover:text-white flex items-center gap-1">
            ...
            <div className="pt-5 space-y-4">
              {activeOnboardings.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 text-slate-500">
                  <div className="w-12 h-12 rounded-full bg-slate-800/35 border border-slate-800/80 flex items-center justify-center mb-3">
                    <Heart className="w-6 h-6 text-indigo-400/50" />
                  </div>
                  <p className="text-[13px] font-medium text-slate-400">No active onboarding campaigns found.</p>
                  <p className="text-[11.5px] text-slate-500 mt-1">Initiate a new onboarding workspace to track candidates.</p>
                </div>
              ) : (
                <div className="space-y-4">
                  {activeOnboardings.slice(0, 4).map((onboarding) => {
                    ...
                    return (
                      <div 
                        key={onboarding._id}
                        className="p-4 rounded-xl border border-slate-800 bg-slate-950/20 hover:border-slate-700/80 hover:bg-slate-900/10 transition-all duration-300"
                      >
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-slate-800 flex items-center justify-center text-indigo-400 text-sm font-extrabold shadow-inner shrink-0">
                              {onboarding.employeeName?.split(' ').map(n => n[0]).join('').slice(0, 2).toUpperCase() || 'NH'}
                            </div>
                            <div>
                              <h4 className="text-[13.5px] font-extrabold text-white">{onboarding.employeeName || 'New Hire'}</h4>
                          ...
                          <div className="flex items-center gap-3 shrink-0 self-end sm:self-center">
                            ...
                            <Link href={`/dashboard/hrm/hr/onboarding`}>
                              <span className="p-2 rounded-lg bg-slate-800/40 text-slate-400 hover:text-white border border-slate-800 hover:border-slate-700 transition-all cursor-pointer">
                        ...
                        <div className="mt-4 pt-3 border-t border-slate-900">
                          <div className="flex justify-between items-center text-[11.5px] mb-1.5">
                            <span className="text-slate-400 font-medium">Onboarding Milestones Completed</span>
                            <span className="text-indigo-400 font-bold font-mono">{progress}%</span>
                          </div>
                          <Progress value={progress} className="h-1.5 bg-slate-950/40" indicatorClassName="bg-indigo-500" />
                        </div>
                      </div>
                    );
                  })}
          ...
          <Card className="bg-slate-900/35 border-slate-800 backdrop-blur-md p-6 rounded-2xl flex flex-col">
            <div className="flex items-center justify-between pb-4 border-b border-slate-850">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-[15.5px] font-extrabold tracking-tight text-white">Active Recruitment Openings</h3>
                  <p className="text-[12px] text-slate-400 mt-0.5">Postings live on career pages and active recruitment channels.</p>
                </div>
              </div>
            ...
            <div className="pt-5">
              {jobs.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 text-slate-500">
                  ...
                  <p className="text-[13px] font-medium text-slate-400">No active job listings found.</p>
                  <p className="text-[11.5px] text-slate-500 mt-1">Create hiring post to start receiving candidate applications.</p>
                </div>
              ) : (
                  ...
                  <table className="w-full text-left text-[13px] border-collapse">
                    <thead>
                      <tr className="bg-slate-950/40 border-b border-slate-800">
                        <th className="px-4 py-3 text-[11.5px] uppercase font-bold tracking-wider text-slate-400">Title</th>
                        <th className="px-4 py-3 text-[11.5px] uppercase font-bold tracking-wider text-slate-400">Department</th>
                        <th className="px-4 py-3 text-[11.5px] uppercase font-bold tracking-wider text-slate-400">Openings</th>
                        <th className="px-4 py-3 text-[11.5px] uppercase font-bold tracking-wider text-slate-400">Type</th>
                        <th className="px-4 py-3 text-center text-[11.5px] uppercase font-bold tracking-wider text-slate-400">Status</th>
                      </tr>
                    </thead>
                    <tbody>
                      {jobs.slice(0, 5).map((job) => (
                        <tr 
                          key={job._id}
                          className="border-b border-slate-850/60 last:border-0 hover:bg-slate-900/10 transition-colors"
                        >
                          <td className="px-4 py-3.5">
                            <span className="font-extrabold text-white">{job.title}</span>
                          </td>
                          ...
                          <td className="px-4 py-3.5 text-slate-400 font-medium capitalize">
          ...
          <Card className="bg-slate-900/35 border-slate-800 backdrop-blur-md p-6 rounded-2xl flex flex-col">
            <div className="flex items-center justify-between pb-4 border-b border-slate-850">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-[15.5px] font-extrabold tracking-tight text-white">Notice Board</h3>
              </div>
              <Link href="/dashboard/hrm/hr/announcements">
                <Button variant="outline" size="sm" className="h-8 text-[11.5px] border-slate-700 bg-slate-800/40 text-slate-300 font-bold rounded-lg hover:bg-slate-800 hover:text-white flex items-center gap-0.5">
            ...
            <div className="pt-5 space-y-4">
              {announcements.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-10 text-slate-500">
                  <div className="w-10 h-10 rounded-full bg-slate-800/35 border border-slate-800/80 flex items-center justify-center mb-3 text-slate-400/40">
                    <Bell className="w-5 h-5" />
                  </div>
                  <p className="text-[12.5px] font-medium text-slate-400">No corporate announcements.</p>
                </div>
              ) : (
                <div className="space-y-4">
                  {announcements.slice(0, 3).map((ann) => (
                    <div 
                      key={ann._id}
                      className="p-4 rounded-xl border border-slate-800 bg-slate-950/20 hover:border-slate-700/80 hover:bg-slate-900/10 transition-all duration-300 flex flex-col justify-between"
                    >
                      ...
                      <h4 className="text-[13.5px] font-extrabold text-white mt-2.5 line-clamp-1">{ann.title}</h4>
                      ...
                      <div className="mt-3 pt-2.5 border-t border-slate-850 flex items-center justify-between text-[11px] text-slate-400">
                        <span className="font-semibold text-slate-300 flex items-center gap-1">
                          <Users className="w-3 h-3 text-slate-500" /> Aud: {ann.audience || 'All'}
                        </span>
                        <span className="font-medium text-slate-500">By: {ann.authorName || 'Operations'}</span>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <Card className="bg-slate-900/35 border-slate-800 backdrop-blur-md p-6 rounded-2xl flex flex-col">
            <div className="flex items-center justify-between pb-4 border-b border-slate-850">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-[15.5px] font-extrabold tracking-tight text-white">HR Policies</h3>
              </div>
            ...
            <div className="pt-5 space-y-3.5">
              {policies.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-6 text-slate-500">
                  <p className="text-[12.5px] font-medium text-slate-400">No active policy documents published.</p>
                </div>
              ) : (
                <div className="space-y-2">
                  {policies.slice(0, 4).map((policy) => (
                    <div 
                      key={policy._id}
                      className="p-3 rounded-lg border border-slate-800 bg-slate-950/10 hover:border-slate-750/80 transition-colors flex items-center justify-between"
                    >
                      <div className="flex items-center gap-2.5 min-w-0">
                        <FileText className="w-4 h-4 text-slate-500 shrink-0" />
                        <div className="min-w-0">
                          <h5 className="text-[12.5px] font-bold text-white truncate">{policy.name}</h5>
                          <span className="text-[10px] text-slate-400 font-medium">Cat: {policy.category || 'HR'} · Ver {policy.version || '1.0'}</span>
                        </div>
                      </div>
                      <Link href={`/dashboard/hrm/hr/policies`}>
                        <span className="p-1 rounded bg-slate-800/40 border border-slate-850 hover:bg-slate-800 hover:text-white text-slate-400 cursor-pointer transition-colors">
