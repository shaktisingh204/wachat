                ...
                <form onSubmit={handleSubmit} className="space-y-4 py-4">
                    <div className="space-y-2">
                        ...
                        <select
                            name="employee_id"
                            required
                            className="flex h-10 w-full items-center justify-between rounded-md border border-zoru-line bg-transparent px-3 py-2 text-[14px] ring-offset-background placeholder:text-zoru-ink-muted focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                        >
