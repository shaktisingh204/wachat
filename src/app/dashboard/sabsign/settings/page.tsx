              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-start gap-3 p-3 rounded-[var(--st-radius)] text-left transition-colors border ${
                      isActive
                        ? 'bg-[var(--st-accent-soft)] border-[var(--st-accent)] text-[var(--st-accent)]'
                        : 'border-transparent text-[var(--st-text-secondary)] hover:bg-[var(--st-bg-secondary)] hover:text-[var(--st-text)]'
                    }`}
                  >
                    <Icon
                      className={`w-5 h-5 shrink-0 mt-0.5 ${isActive ? 'text-[var(--st-accent)]' : 'text-[var(--st-text-tertiary)]'}`}
                      aria-hidden="true"
                    />
                    <div>
                      <div className={`font-medium ${isActive ? 'text-[var(--st-accent)]' : 'text-[var(--st-text)]'}`}>
                        {tab.name}
                      </div>
                      <div className="text-xs text-[var(--st-text-tertiary)] mt-0.5">{tab.description}</div>
                    </div>
                  </button>
                );
              })}
            ...
            <CardBody>
              ...
              {activeTab === 'general' && (
                <div className="space-y-8">
                  ...
                  <section>
                    <h3 className="text-lg font-medium text-[var(--st-text)] mb-4">Localization & Formatting</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {activeTab === 'branding' && (
                <div className="space-y-10">
                  ...
                  {/* Typography & Styling */}
                  <section>
                    <h3 className="text-lg font-medium text-[var(--st-text)] mb-4">Typography & UI Elements</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <Field label="Button & Card Border Radius">
              ...
              {activeTab === 'legal' && (
                <div className="space-y-8">
                  ...
                  {/* ERISA Disclosures */}
                  <section className="space-y-3">
                    <Field label="ERISA & 401(k) Disclosures" help="Specific compliance text required for HR and Benefits envelopes.">
