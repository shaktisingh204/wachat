...
function LineWidget({ widget, data }: WidgetRendererProps) {
...
function BarWidget({ widget, data }: WidgetRendererProps) {
    const cfg = (widget.config ?? {}) as { xKey?: string; yKey?: string };
...
function DonutWidget({ widget, data }: WidgetRendererProps) {
