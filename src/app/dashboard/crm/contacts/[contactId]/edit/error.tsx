...
import { Button, Card, ZoruAlert } from '@/components/sabcrm/20ui/compat';
  ...
  return (
    <div className="flex h-[calc(100vh-10rem)] items-center justify-center p-6">
      <Card className="max-w-md p-6 text-center shadow-lg">
        <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-zoru-danger/10 text-zoru-danger">
