          ...
          render: (row) => (
            ...
            >
              <div className="space-y-3 text-sm">
                <div>
                  <div className="text-[var(--st-text-secondary)] text-xs">Module</div>
                  <div>{String(row.resource_type || '—')}</div>
                </div>
                <div>
                  <div className="text-[var(--st-text-secondary)] text-xs">Resource ID</div>
                  <div className="font-mono">{String(row.resource_id || '—')}</div>
                </div>
                <div>
                  <div className="text-[var(--st-text-secondary)] text-xs">Reason</div>
