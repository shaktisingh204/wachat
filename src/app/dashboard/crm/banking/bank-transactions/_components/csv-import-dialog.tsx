...
import { Button, Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, Label, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, useToast, cn } from '@/components/sabcrm/20ui';
import {
  FileUp,
  LoaderCircle,
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                            ...
                            {pick ? (
                                <span className="max-w-[260px] truncate text-[12.5px] text-[var(--st-text-secondary)]">
                                    {pick.name}
                                </span>
                            ) : (
                    ...
                    {isParsing ? (
                        ...
                        <div className="rounded-lg border border-[var(--st-border)] bg-[var(--st-bg-muted)]/40 p-3">
                            <p className="mb-2 text-[12.5px] font-medium text-[var(--st-text)]">
                            ...
                            <div className="max-h-[200px] overflow-y-auto text-[11.5px]">
                                ...
                                {preview.length > 50 ? (
                                    <p className="mt-2 text-center text-[var(--st-text-secondary)]">
