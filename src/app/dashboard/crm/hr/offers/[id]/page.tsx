...
export default async function OfferDetailPage({ params }: PageProps) {
  ...
  return (
    <RecruitmentDetailShell
      ...
      back={{ href: '/dashboard/crm/hr/offers', label: 'All offers' }}
      actions={[
        {
          key: 'edit',
          label: 'Edit',
          icon: <Pencil className="h-3.5 w-3.5" />,
          href: `/dashboard/crm/hr/offers/${id}/edit`,
          variant: 'outline',
        },
        {
          key: 'print',
          ...
          href: `/dashboard/crm/hr/offers/${id}?print=1`,
        },
        {
          key: 'email',
          label: 'Email',
        ...
        },
        {
          ...
          href: `/dashboard/crm/hr/offers/${id}/activity`,
        },
      ]}
      actionsSlot={
        <HrActionButtons
      ...
      rightRail={
        <>
          ...
          <RailCard title="Chain — next step">
            <RailLink
              href={`/dashboard/crm/hr/onboarding/new?fromKind=offer&fromId=${id}${
        ...
        rows={[
          {
            ...
            value: o.candidateId ? (
              <Link
                href={`/dashboard/crm/hr/candidates/${o.candidateId}`}
