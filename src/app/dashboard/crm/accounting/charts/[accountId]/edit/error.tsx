...
export default function EditChartOfAccountError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Edit Chart of Account Error Boundary caught an error:', error);
  }, [error]);
    ...
    <div className="flex h-[50vh] flex-col items-center justify-center gap-4 text-center">
      ...
      <div className="space-y-1">
        <h2 className="text-lg font-medium text-zoru-ink">
          Something went wrong loading the account editor
        </h2>
