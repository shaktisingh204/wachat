...
import { Alert, AlertDescription, AlertTitle, Button, Card, DatePicker, Input, Label, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Separator, Textarea, useToast } from '@/components/sabcrm/20ui';
/**
        ...
        <section>
            ...
            <div className="space-y-3">
                {items.map((item, index) => (
                    <div key={item.id} className="p-3 border border-[var(--st-border)] rounded-lg bg-[var(--st-bg-muted)] space-y-3">
        ...
        <form action={handleAction}>
            ...
            <div className="w-full flex flex-col gap-6">
                <header className="flex justify-between items-center">
                    <Button variant="ghost" asChild className="-ml-4 text-[var(--st-text-secondary)] hover:text-[var(--st-text)]">
                ...
                <Card className="w-full p-4 sm:p-8 md:p-12">
                    <header className="text-center mb-8">
                        <h1 className="text-[26px] font-semibold text-[var(--st-text)]">New Voucher Entry</h1>
                        <p className="mt-1 text-[13px] text-[var(--st-text-secondary)]">Record a new journal entry.</p>
                    </header>
                    ...
                    <section className="grid md:grid-cols-3 gap-4 text-sm mb-8">
                        ...
                        <div className="space-y-1 md:col-span-3">
                            <div className="flex items-center justify-between">
                                ...
                                <Button type="button" variant="ghost" size="sm" onClick={handleAutoCategorize} className="h-6 text-xs text-[var(--st-text)]">
                        ...
                        <div className="md:col-span-3 space-y-4 border p-4 rounded-lg bg-[var(--st-bg-muted)]/50">
                            <div className="flex items-center gap-2">
                                <input type="checkbox" id="isRecurring" checked={isRecurring} onChange={(e) => setIsRecurring(e.target.checked)} className="h-4 w-4" />
                                <Label htmlFor="isRecurring" className="font-semibold text-[var(--st-text)]">Schedule Recurring Voucher</Label>
                            </div>
                            {isRecurring && (
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div className="space-y-1">
                    ...
                    <div className="flex justify-end font-semibold text-[15px] p-4">
                        <div className="w-full max-w-sm space-y-2">
                            ...
                            {difference !== 0 && (
                                <div className="flex justify-between text-[var(--st-text)] pt-2 border-t border-[var(--st-border)]">
