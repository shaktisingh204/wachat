                        ...
                        <Table>
                            <THead>
                                <Tr className="border-[var(--st-border)] hover:bg-transparent">
                                    ...
                                    <Th className="text-right text-[var(--st-text-secondary)]">Total Debit</Th>
                                    <Th className="text-right text-[var(--st-text-secondary)]">Total Credit</Th>
                                </Tr>
                            </THead>
                            <TBody>
                                {entries.length === 0 ? (
                                    ...
                                    entries.map((entry) => (
                                        <Tr key={entry._id.toString()} className="border-[var(--st-border)]">
