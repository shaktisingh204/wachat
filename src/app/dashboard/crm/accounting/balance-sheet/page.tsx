...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Table, TBody, Td, Th, THead, Tr } from '@/components/sabcrm/20ui';
...
export default function BalanceSheetPage(): React.JSX.Element {
    ...
    const chart = (
        <div>
            <h2 className="text-[15px] font-semibold text-[var(--st-text)]">Composition</h2>
