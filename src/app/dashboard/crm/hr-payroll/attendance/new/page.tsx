...
import { ArrowLeft, CheckSquare, LoaderCircle, Save } from 'lucide-react';
    ...
    const handleSave = () => {
        startSave(async () => {
            ...
            if (failed === 0) {
                ...
                router.push(`/dashboard/crm/hr-payroll/attendance?date=${dateIso}`);
            } else {
                toast({
        ...
        <div className="flex w-full flex-col gap-6">
            ...
            <div className="flex justify-end gap-2">
                <ZoruButton variant="outline" asChild>
                    <Link href="/dashboard/crm/hr-payroll/attendance">Cancel</Link>
                </ZoruButton>
