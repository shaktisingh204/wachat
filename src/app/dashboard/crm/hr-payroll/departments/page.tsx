...
function SaveButton() {
    ...
    return <Button type="submit" disabled={pending}>{pending && <LoaderCircle className="mr-2 h-4 w-4 animate-spin"/>} Add Department</Button>;
}
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
            <Card>
                <form action={formAction} ref={formRef}>
                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-2"><Label htmlFor="name">Department Name</Label><Input id="name" name="name" required /></div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>The list of all departments in your organization.</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="border rounded-md">
                        <Table>
                            ...
                            <TableBody>
                                ...
                                : <TableRow><TableCell colSpan={2} className="text-center h-24">No departments created yet.</TableCell></TableRow>}
                            </TableBody>
                        </Table>
                    </div>
                </CardContent>
