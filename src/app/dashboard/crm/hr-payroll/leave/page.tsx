  ...
  return (
    <div className="flex w-full flex-col gap-6">
      <CrmPageHeader
        ...
        actions={
          <>
            <Link href="/dashboard/crm/hr-payroll/leave/balance">
              <ClayButton variant="pill">Balance</ClayButton>
            </Link>
            <Link href="/dashboard/crm/hr-payroll/leave/calendar">
              <ClayButton
                variant="pill"
            ...
            <Link href="/dashboard/crm/hr-payroll/leave/types">
              <ClayButton
                variant="pill"
            ...
            <Link href="/dashboard/crm/hr-payroll/leave/settings">
              <ClayButton
                variant="pill"
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end gap-1">
                          <Button variant="ghost" size="icon" asChild>
                            <Link href={`/dashboard/crm/hr-payroll/leave/${l._id}`}>
