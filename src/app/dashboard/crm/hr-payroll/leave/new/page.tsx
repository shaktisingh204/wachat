...
export default function ApplyLeavePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    startSave(async () => {
      ...
      router.push('/dashboard/crm/hr-payroll/leave');
    });
  };
      ...
      <ZoruCard className="p-6">
        {isLoading ? (
          ...
          <form onSubmit={handleSubmit} className="grid gap-4 md:grid-cols-2">
            ...
            {/* TODO P0.4-fu: this page duplicates /dashboard/hrm/payroll/leave/new — convert to a redirect once route audit confirms callers. */}
            <div>
            ...
            <div className="flex gap-2 md:col-span-2 md:justify-end">
              <ZoruButton
                type="button"
                variant="outline"
                onClick={() => router.push('/dashboard/crm/hr-payroll/leave')}
              >
                Cancel
              </ZoruButton>
              <ZoruButton
