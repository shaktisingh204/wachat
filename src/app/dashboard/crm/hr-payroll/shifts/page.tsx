  ...
  return (
    <div className="flex w-full flex-col gap-6">
      <CrmPageHeader
        ...
        actions={
          <>
            <Link href="/dashboard/crm/hr-payroll/shifts/schedule">
              <ClayButton
                variant="pill"
            ...
            <Link href="/dashboard/crm/hr-payroll/shifts/new">
              <ClayButton
                variant="obsidian"
                    ...
                    <TableCell className="text-right">
                      <div className="flex items-center justify-end gap-1">
                        <Button variant="ghost" size="icon" asChild>
                          <Link href={`/dashboard/crm/hr-payroll/shifts/${shift._id}/edit`}>
