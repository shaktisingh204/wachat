...
function IssueFormSkeleton() {
    return (
        <div className="flex w-full flex-col gap-5 animate-pulse">
            {/* Overview Card */}
            <Card className="p-0 bg-zoru-bg/50">
                <ZoruCardHeader>
                    <div className="h-6 w-32 bg-zoru-line/50 rounded" />
                </ZoruCardHeader>
                <ZoruCardContent className="flex flex-col gap-4">
                    <div className="space-y-2">
                        <div className="h-4 w-20 bg-zoru-line/50 rounded" />
                        <div className="h-10 w-full bg-zoru-line/50 rounded" />
                    </div>
                    <div className="space-y-2">
                        <div className="h-4 w-24 bg-zoru-line/50 rounded" />
                        <div className="h-28 w-full bg-zoru-line/50 rounded" />
                    </div>
            ...
            <Card className="p-0 bg-zoru-bg/50">
                <ZoruCardHeader>
                    <div className="h-6 w-36 bg-zoru-line/50 rounded" />
                </ZoruCardHeader>
                <ZoruCardContent className="flex flex-col gap-4">
                    <div className="grid gap-4 md:grid-cols-2">
                        {[1, 2, 3, 4, 5, 6].map((i) => (
                        ...
                        <div className="md:col-span-2 space-y-2">
                            <div className="h-4 w-32 bg-zoru-line/50 rounded" />
                            <div className="h-10 w-full max-w-[200px] bg-zoru-line/50 rounded" />
                        </div>
                    </div>
                </ZoruCardContent>
            </Card>
            ...
            <Card className="p-0 bg-zoru-bg/50">
                <ZoruCardHeader className="flex flex-row items-center justify-between gap-2">
                    <div className="h-6 w-24 bg-zoru-line/50 rounded" />
                    <div className="h-8 w-28 bg-zoru-line/50 rounded" />
                </ZoruCardHeader>
                <ZoruCardContent>
                    <div className="h-10 w-full bg-zoru-line/50 rounded" />
                </ZoruCardContent>
            ...
            <Card className="p-0 bg-zoru-bg/50">
                <ZoruCardHeader className="flex flex-row items-center justify-between gap-2">
                    <div className="h-6 w-32 bg-zoru-line/50 rounded" />
                    <div className="h-8 w-24 bg-zoru-line/50 rounded" />
                </ZoruCardHeader>
                <ZoruCardContent>
                    <div className="h-10 w-full bg-zoru-line/50 rounded" />
                </ZoruCardContent>
            ...
            {/* Skeleton Footer */}
            <div className="flex items-center justify-between gap-2 border-t border-zoru-line/50 bg-zoru-bg px-4 py-3 -mx-4 -mb-4 mt-1 md:-mx-6 md:px-6">
                <div className="h-10 w-24 bg-zoru-line/50 rounded" />
                <div className="h-10 w-32 bg-zoru-line/50 rounded" />
            </div>
        </div>
    );
}
