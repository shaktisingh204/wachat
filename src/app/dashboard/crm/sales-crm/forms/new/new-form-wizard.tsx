...
import { Button, Input, Label, Card, CardHeader, CardTitle, CardBody as CardContent } from '@/components/sabcrm/20ui';
import { CrmFormBuilder } from '@/components/20ui-domain/crm-form-builder';
...
export function NewFormWizard() {
    ...
    return (
        <div className="w-full p-6 mt-10">
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-[var(--st-text)]">Create New Form</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {TEMPLATES.map(t => {
                        ...
                        return (
                            ...
                            >
                                <CardHeader>
                                    <Icon className="w-8 h-8 mb-2 text-[var(--st-text)]" />
                                    <CardTitle className="text-lg">{t.name}</CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <p className="text-sm text-[var(--st-text-secondary)]">{t.description}</p>
                                </CardContent>
                            </Card>
                        );
                    })}
