...
export function CopySnippet({ text, label }: CopySnippetProps) {
    ...
    return (
        <div className="flex flex-col gap-1.5">
            {label && <div className="text-[13px] font-medium text-zoru-ink">{label}</div>}
            <div className="flex items-center gap-2">
                <code className="flex-1 overflow-x-auto whitespace-pre rounded-[var(--zoru-radius)] border border-zoru-line bg-zoru-surface-2 px-3 py-2 text-[12px] text-zoru-ink">
                    {text}
                </code>
