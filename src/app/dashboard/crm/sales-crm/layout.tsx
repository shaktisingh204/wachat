...
const salesCrmNavItems = [
    { href: "/dashboard/crm/sales-crm/all-pipelines", label: "All Pipelines", icon: GanttChart },
    { href: "/dashboard/crm/sales-crm/pipelines", label: "Sales Pipeline", icon: GanttChart },
    ...
    { href: "/dashboard/crm/sales-crm/client-performance-report", label: "Client Performance", icon: LineChart },
