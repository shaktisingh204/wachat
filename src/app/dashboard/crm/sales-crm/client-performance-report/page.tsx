    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-wrap items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold font-headline flex items-center gap-3"><LineChart /> Client Performance Report</h1>
                    <p className="text-muted-foreground">Analyze revenue and lead metrics for each client account.</p>
                </div>
            ...
            <Card>
                ...
                <CardContent className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    <div className="space-y-1"><Label>Lead Created At</Label><DatePicker date={startDate} setDate={setStartDate as any} placeholder="Start Date" /></div>
            ...
            <Card>
                <CardHeader>
                    <CardTitle>Report Data</CardTitle>
                     <CardDescription>Showing {reportData.length} of {reportData.length} clients.</CardDescription>
                </CardHeader>
                <CardContent>
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    ...
                                    <TableHead>Last Lead Activity On</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {isLoading ? (
                                    ...
                                    reportData.map(row => (
                                        <TableRow key={row.clientId}>
                                            ...
                                            <TableCell>{row.lastLeadActivityOn ? format(new Date(row.lastLeadActivityOn), 'PPP') : 'N/A'}</TableCell>
                                        </TableRow>
                                    ))
                                ) : (
