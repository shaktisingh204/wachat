        ...
        <div className="flex w-full flex-col gap-6">
            ...
            <ClayCard>
                <div className="mb-4">
                    ...
                    <p className="mt-0.5 text-[12.5px] text-clay-ink-muted">Showing {reportData.length} of {reportData.length} clients.</p>
                </div>
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="border-clay-border hover:bg-transparent">
                                ...
                                <TableHead className="text-clay-ink-muted">Last Lead Activity On</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            {isLoading ? (
                                ...
                                reportData.map(row => (
                                    <TableRow key={row.clientId} className="border-clay-border">
                                        <TableCell className="font-medium text-clay-ink">{row.clientName}</TableCell>
                                        ...
                                        <TableCell className="text-clay-ink">{row.lastLeadActivityOn ? format(new Date(row.lastLeadActivityOn), 'PPP') : 'N/A'}</TableCell>
                                    </TableRow>
                                ))
                            ) : (
