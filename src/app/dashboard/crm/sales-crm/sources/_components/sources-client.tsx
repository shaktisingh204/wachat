  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-1.5">
        <ZoruLabel htmlFor="src-name">Source Name</ZoruLabel>
        <ZoruInput id="src-name" name="type" defaultValue={row.type} required />
      </div>
      <div className="space-y-1.5">
        <ZoruLabel htmlFor="src-color">Color (hex)</ZoruLabel>
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        <ZoruStatCard label="Total Sources" value={kpi.total} icon={<Radio />} />
        <ZoruStatCard label="Sources with Leads" value={kpi.withActiveLeads} />
        <ZoruStatCard label="Top Source" value={kpi.topSource} />
        <ZoruStatCard label="Leads from Top Source" value={kpi.topSourceLeads} />
      </div>
