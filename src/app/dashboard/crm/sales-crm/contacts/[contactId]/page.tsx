...
import { Button, Card, CardBody, CardHeader, CardTitle, Skeleton, useToast } from '@/components/sabcrm/20ui';
import {
  useParams,
...
import { ComposeEmailDialog } from '@/components/20ui-domain/crm-compose-email-dialog';
