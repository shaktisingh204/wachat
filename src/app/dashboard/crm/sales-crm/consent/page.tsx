                    ...
                    <ZoruTable>
                        <ZoruTableHeader>
                            <ZoruTableRow className="border-border hover:bg-transparent">
                                ...
                                <ZoruTableHead className="text-muted-foreground">State</ZoruTableHead>
                                <ZoruTableHead className="text-muted-foreground">When</ZoruTableHead>
                                <ZoruTableHead className="text-muted-foreground">IP</ZoruTableHead>
                            </ZoruTableRow>
                        </ZoruTableHeader>
                        <ZoruTableBody>
                            {filteredEvents.length === 0 ? (
                                <ZoruTableRow className="border-border">
                                    <ZoruTableCell colSpan={5} className="py-6 text-center text-[13px] text-muted-foreground">
                                ...
                                <ZoruTable>
                                    <ZoruTableHeader>
                                        <ZoruTableRow className="border-border hover:bg-transparent">
                                            ...
                                            <ZoruTableHead className="text-muted-foreground">Purpose</ZoruTableHead>
                                            <ZoruTableHead className="text-muted-foreground">State</ZoruTableHead>
                                            <ZoruTableHead className="text-muted-foreground">Last updated</ZoruTableHead>
                                            <ZoruTableHead className="w-[120px] text-right text-muted-foreground">Actions</ZoruTableHead>
                                        </ZoruTableRow>
                                    </ZoruTableHeader>
                                    <ZoruTableBody>
                                        {purposes.map((p) => {
                                ...
                                <ZoruTable>
                                    <ZoruTableHeader>
                                        <ZoruTableRow className="border-border hover:bg-transparent">
                                            <ZoruTableHead className="text-muted-foreground">Purpose</ZoruTableHead>
                                            <ZoruTableHead className="text-muted-foreground">State</ZoruTableHead>
                                            <ZoruTableHead className="text-muted-foreground">Timestamp</ZoruTableHead>
                                            <ZoruTableHead className="text-muted-foreground">IP</ZoruTableHead>
                                        </ZoruTableRow>
                                    </ZoruTableHeader>
                                    <ZoruTableBody>
