    ...
    <div className="mx-auto max-w-3xl bg-white p-10 text-[13px] text-black print:p-6">
      <header className="mb-8 flex items-start justify-between border-b border-black/30 pb-6">
        <div>
          ...
          <p className="mt-1 text-[14px] text-[var(--st-text)]">
            {bill.billNo || '—'}
          </p>
        </div>
        <div className="text-right text-[12px] text-[var(--st-text)]">
          <p>
      ...
      <section className="mb-6 grid grid-cols-2 gap-6">
        <div>
          <h2 className="mb-1 text-[11px] font-semibold uppercase tracking-wide text-[var(--st-text)]">
            Vendor
          </h2>
      ...
      <section className="ml-auto max-w-xs space-y-1 text-[13px]">
        <div className="flex justify-between">
          <span className="text-[var(--st-text)]">Subtotal</span>
        ...
        <div className="flex justify-between">
          <span className="text-[var(--st-text)]">Paid</span>
          <span className="tabular-nums">
            {fmtMoney(bill.amountPaid ?? 0, currency)}
          </span>
        </div>
        <div className="flex justify-between">
          <span className="text-[var(--st-text)]">Balance</span>
          <span className="tabular-nums">
