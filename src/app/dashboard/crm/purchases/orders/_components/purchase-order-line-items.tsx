 ...
 * catalog item record when an item is selected. A per-line warehouse
 * picker captures the receiving location.
 */
...
export interface POLineItemRow extends CrmPurchaseOrderLineItem {
  _key: string;
}
...
interface PurchaseOrderLineItemsProps {
  ...
  onPatchRow: (key: string, patch: Partial<POLineItemRow>) => void;
}
        ...
        <table className="w-full text-[13px]">
          <thead className="bg-[var(--st-bg-muted)]">
            <tr className="border-b border-[var(--st-border)] text-left">
              ...
              <th className="p-2 font-medium text-[var(--st-text)]">HSN/SAC</th>
          ...
          <tbody>
            {rows.map((row) => (
              ...
              >
                ...
                <td className="min-w-[140px] p-2 align-top">
                  <EntityFormField
                    entity="taxRate"
                ...
                <td className="min-w-[140px] p-2 align-top">
                  <EntityFormField
                    ...
                    onChange={(id) =>
                      onPatchRow(row._key, { warehouseId: id ?? undefined })
                    }
                  />
                </td>
