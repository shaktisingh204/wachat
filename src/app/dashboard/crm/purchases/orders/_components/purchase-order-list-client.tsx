...
/**
 * Client side of the Purchase Orders list — owns the search box, the
...
import { deletePurchaseOrderAction } from '@/app/actions/crm/purchase-orders.actions';
...
export function PurchaseOrderListClient({
  ...
  const [pendingDelete, setPendingDelete] =
    React.useState<CrmPurchaseOrderDoc | null>(null);
  ...
  const confirmDelete = () => {
    ...
    const label = pendingDelete.poNo || id;
    startDelete(async () => {
  ...
  return (
    <ZoruCard className="overflow-hidden p-0">
      ...
      <ZoruTable>
        <ZoruTableHeader>
          <ZoruTableRow>
            ...
            <ZoruTableHead>Expected delivery</ZoruTableHead>
            ...
            <ZoruTableRow>
              ...
              >
                {initialQuery
                  ...
                  : 'No purchase orders yet — click "New purchase order" to add one.'}
              </ZoruTableCell>
            </ZoruTableRow>
          ) : (
            orders.map((order) => {
      ...
      >
        <ZoruAlertDialogContent>
          <ZoruAlertDialogHeader>
            <ZoruAlertDialogTitle>Delete purchase order?</ZoruAlertDialogTitle>
            <ZoruAlertDialogDescription>
              This permanently removes{' '}
              <strong>{pendingDelete?.poNo || ''}</strong> from the database.
