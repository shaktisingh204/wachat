...
import { PageHeader, ZoruPageHeading, ZoruPageEyebrow, ZoruPageTitle, ZoruPageDescription } from '@/components/zoruui';
...
export default async function CrmTemplatesPage() {
    ...
    return (
        <div className="flex-1 flex flex-col gap-6 p-6 bg-[#090a0f] min-h-screen text-slate-100">
            ...
            <PageHeader>
                <ZoruPageHeading>
                    ...
                    <div className="flex items-center gap-3">
                        <ZoruPageTitle className="text-3xl font-extrabold tracking-tight bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 bg-clip-text text-transparent">
                            Visual Template Studio
                        </ZoruPageTitle>
                        <Badge className="bg-indigo-950/60 text-indigo-400 border border-indigo-500/20 text-[10px] uppercase font-semibold tracking-wider px-2 py-0.5 animate-pulse">
                            <Sparkles className="h-2.5 w-2.5 mr-1" /> Studio v2.0
                        </Badge>
                    </div>
                    <ZoruPageDescription className="text-slate-400 mt-1 max-w-2xl">
