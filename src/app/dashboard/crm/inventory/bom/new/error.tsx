...
import { Card, CardBody, CardHeader, CardTitle, Button } from '@/components/sabcrm/20ui';
    ...
    <div className="flex h-[50vh] w-full items-center justify-center p-6">
      <Card className="max-w-md w-full border-[var(--st-danger)] shadow-sm">
        <CardHeader className="flex flex-row items-center gap-3 space-y-0">
          ...
          <div>
            <CardTitle className="text-lg text-[var(--st-danger)]">Failed to load BOM form</CardTitle>
          </div>
        </CardHeader>
