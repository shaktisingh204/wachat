...
export default function EditStockTransferError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Edit Stock Transfer Error Boundary caught an error:', error);
  }, [error]);
    ...
    <div className="flex h-[50vh] flex-col items-center justify-center gap-4 text-center">
      ...
      <div className="space-y-1">
        <h2 className="text-lg font-medium text-[var(--st-text)]">
          Something went wrong loading the stock transfer editor
        </h2>
