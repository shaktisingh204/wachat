...
export default function EditInventoryItemError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Edit Inventory Item Error Boundary caught an error:', error);
  }, [error]);
    ...
    <div className="flex h-[50vh] flex-col items-center justify-center gap-4 text-center">
      ...
      <div className="space-y-1">
        <h2 className="text-lg font-medium text-zoru-ink">
          Something went wrong loading the item editor
        </h2>
