...
export default function ErrorBoundary({
    ...
    return (
        <div className="flex h-[400px] w-full flex-col items-center justify-center gap-4 rounded-[var(--st-radius-lg)] border border-[var(--st-border)] border-dashed p-8 text-center bg-[var(--st-bg)]">
