...
export default function ContractDetailError({
  ...
  useEffect(() => {
    ...
    console.error('Contract Detail Error Boundary caught an error:', error);
  }, [error]);
    ...
    <div className="flex h-[50vh] flex-col items-center justify-center gap-4 text-center">
      ...
      <div className="space-y-1">
        ...
        <p className="text-[13px] text-zoru-ink-muted">
          There was an error retrieving this contract. It might have been deleted, or there is a database issue.
        </p>
      </div>
