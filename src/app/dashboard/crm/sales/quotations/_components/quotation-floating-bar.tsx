...
export function QuotationFloatingBar({ quotationId }: { quotationId: string }) {
  ...
  return (
    <div className="fixed bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-3 rounded-full border border-[var(--st-border)] bg-[var(--st-bg-secondary)]/95 px-5 py-3 shadow-[var(--zoru-shadow-lg)] backdrop-blur-sm z-50 animate-in slide-in-from-bottom-8 fade-in duration-300">
