  ...
  return (
    <div className="flex flex-col gap-6">
        ...
        <table className="w-full text-[13px]">
          <thead className="bg-zoru-surface-2">
            <tr className="border-b border-zoru-line">
              <th className="p-3 text-left font-medium text-zoru-ink">Item</th>
              <th className="p-3 text-right font-medium text-zoru-ink">Qty</th>
              <th className="p-3 text-right font-medium text-zoru-ink">Unit Price</th>
              <th className="p-3 text-right font-medium text-zoru-ink">Tax %</th>
              <th className="p-3 text-right font-medium text-zoru-ink">Total</th>
          ...
          <tbody>
            {lines.length === 0 ? (
              ...
              lines.map((l) => {
                ...
                return (
                  <tr key={l.id} className="border-b border-zoru-line">
                    <td className="p-2 align-top min-w-[220px]">
                      ...
                      {l.name ? (
                        <Input
                          ...
                          className="mb-1 h-9 rounded-lg border-zoru-line bg-zoru-surface text-[13px]"
                        />
                      ) : null}
                      <Textarea
                        value={l.description || ''}
                        ...
                        rows={2}
                        className="rounded-lg border-zoru-line bg-zoru-surface text-[12.5px]"
                      />
                    </td>
                    <td className="p-2 align-top">
                      <Input
                        ...
                        className="h-9 w-20 rounded-lg border-zoru-line bg-zoru-surface text-right text-[13px]"
                      />
                    </td>
                    <td className="p-2 align-top">
                      <Input
                        ...
                        className="h-9 w-28 rounded-lg border-zoru-line bg-zoru-surface text-right text-[13px]"
                      />
                    </td>
                    <td className="p-2 align-top">
                      <Input
                    ...
                    <td className="p-2 text-right align-top font-medium text-zoru-ink">
                    ...
                    <td className="p-2 align-top">
                      <button
                        ...
                        className="rounded-lg p-1.5 text-zoru-ink-muted hover:bg-zoru-surface-2 hover:text-zoru-ink"
                      >
      ...
      <div className="flex flex-wrap justify-between gap-4">
        ...
        <div className="min-w-[260px] rounded-lg border border-zoru-line bg-zoru-surface-2 p-4">
          <div className="flex items-center justify-between py-1 text-[13px] text-zoru-ink">
            <span>Subtotal</span>
          ...
          <div className="flex items-center justify-between gap-3 py-1 text-[13px] text-zoru-ink">
            <Label className="text-zoru-ink">Discount</Label>
            <Input
              type="number"
              min={0}
              step="0.01"
              ...
              className="h-8 w-24 rounded-lg border-zoru-line bg-zoru-surface text-right text-[13px]"
            />
          </div>
          <div className="mt-2 flex items-center justify-between border-t border-zoru-line pt-2 text-[14px] font-semibold text-zoru-ink">
            <span>Total</span>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div>
          <Label className="text-zoru-ink">Terms &amp; Conditions</Label>
          <Textarea
            rows={4}
            value={terms}
