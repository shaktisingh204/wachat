  ...
  return (
    <div className="flex flex-col gap-6">
        ...
        <table className="w-full text-[13px]">
          <thead className="bg-[var(--st-bg-muted)]">
            <tr className="border-b border-[var(--st-border)]">
              <th className="p-3 text-left font-medium text-[var(--st-text)]">Item</th>
              <th className="p-3 text-right font-medium text-[var(--st-text)]">Qty</th>
              <th className="p-3 text-right font-medium text-[var(--st-text)]">Unit Price</th>
              <th className="p-3 text-right font-medium text-[var(--st-text)]">Tax %</th>
              <th className="p-3 text-right font-medium text-[var(--st-text)]">Total</th>
          ...
          <tbody>
            {lines.length === 0 ? (
              ...
              lines.map((l) => {
                ...
                return (
                  <tr key={l.id} className="border-b border-[var(--st-border)]">
                    <td className="p-2 align-top min-w-[220px]">
                      ...
                      {l.name ? (
                        <Input
                          ...
                          className="mb-1 h-9 rounded-lg border-[var(--st-border)] bg-[var(--st-bg-secondary)] text-[13px]"
                        />
                      ) : null}
                      <Textarea
                        value={l.description || ''}
                        ...
                        rows={2}
                        className="rounded-lg border-[var(--st-border)] bg-[var(--st-bg-secondary)] text-[12.5px]"
                      />
                    </td>
                    <td className="p-2 align-top">
                      <Input
                        ...
                        className="h-9 w-20 rounded-lg border-[var(--st-border)] bg-[var(--st-bg-secondary)] text-right text-[13px]"
                      />
                    </td>
                    <td className="p-2 align-top">
                      <Input
                        ...
                        className="h-9 w-28 rounded-lg border-[var(--st-border)] bg-[var(--st-bg-secondary)] text-right text-[13px]"
                      />
                    </td>
                    <td className="p-2 align-top">
                      <Input
                    ...
                    <td className="p-2 text-right align-top font-medium text-[var(--st-text)]">
                    ...
                    <td className="p-2 align-top">
                      <button
                        ...
                        className="rounded-lg p-1.5 text-[var(--st-text-secondary)] hover:bg-[var(--st-bg-muted)] hover:text-[var(--st-text)]"
                      >
      ...
      <div className="flex flex-wrap justify-between gap-4">
        ...
        <div className="min-w-[260px] rounded-lg border border-[var(--st-border)] bg-[var(--st-bg-muted)] p-4">
          <div className="flex items-center justify-between py-1 text-[13px] text-[var(--st-text)]">
            <span>Subtotal</span>
          ...
          <div className="flex items-center justify-between gap-3 py-1 text-[13px] text-[var(--st-text)]">
            <Label className="text-[var(--st-text)]">Discount</Label>
            <Input
              type="number"
              min={0}
              step="0.01"
              ...
              className="h-8 w-24 rounded-lg border-[var(--st-border)] bg-[var(--st-bg-secondary)] text-right text-[13px]"
            />
          </div>
          <div className="mt-2 flex items-center justify-between border-t border-[var(--st-border)] pt-2 text-[14px] font-semibold text-[var(--st-text)]">
            <span>Total</span>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div>
          <Label className="text-[var(--st-text)]">Terms &amp; Conditions</Label>
          <Textarea
            rows={4}
            value={terms}
