            ...
            <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-4">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="mt-1 max-w-2xl text-[13.5px] leading-relaxed text-zoru-ink-muted">
                            Manage every bot connected to this workspace. Each bot is identified by its BotFather token and ties to a single webhook.
                        </p>
                    </div>
                </div>
                <div className="flex shrink-0 items-center gap-2">
                    <ZoruButton
                        variant="outline"
                        size="sm"
                        onClick={() => window.open('https://core.telegram.org/bots/features#botfather', '_blank', 'noopener,noreferrer')}
                    >
                        Docs
                    </ZoruButton>
                    <ZoruButton
                        size="sm"
                        onClick={() => {
                            window.location.href = '/dashboard/telegram/connections';
                        }}
                    >
                        Add bot
                    </ZoruButton>
