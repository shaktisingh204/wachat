            ...
            <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-4">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="mt-1 max-w-2xl text-[13.5px] leading-relaxed text-zoru-ink-muted">
                            Everyone who has messaged your bot, imported from inline queries, deep-links, or MTProto sync.
                        </p>
                    </div>
                </div>
                <div className="flex shrink-0 items-center gap-2">
                    <ZoruButton
                        variant="outline"
                        size="sm"
                        onClick={() => window.open('https://core.telegram.org/api/contacts', '_blank', 'noopener,noreferrer')}
                    >
                        Docs
                    </ZoruButton>
                </div>
