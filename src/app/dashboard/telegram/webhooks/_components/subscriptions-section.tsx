      ...
      <ZoruCardContent className="flex flex-col gap-4 p-4 md:flex-row md:items-start md:justify-between">
        <div className="flex-1 space-y-2">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <code className="break-all rounded bg-[var(--st-bg-muted)] px-2 py-0.5 text-xs">
              {s.url}
            </code>
          </div>
          ...
          <div className="flex items-center gap-2 text-xs">
            <Label>Secret:</Label>
            <code className="rounded bg-[var(--st-bg-muted)] px-2 py-0.5">
          ...
          {s.lastTelegramErrorMessage && (
            <div className="flex items-center gap-1 text-xs text-[var(--st-text)]">
