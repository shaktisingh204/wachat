    ...
    return (
        <Card className="flex flex-col h-[600px]">
            ...
            <ZoruCardContent className="flex-1 overflow-hidden p-0 relative">
                {/* Header row */}
                <div className="flex items-center border-b bg-muted/50 p-3 sticky top-0 z-10 text-sm font-medium">
                    ...
                    >
                        {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                            ...
                            return (
                                <div
                                    key={record.id}
                                    className="absolute top-0 left-0 w-full flex items-center border-b p-2 group hover:bg-muted/30 transition-colors"
                                    style={{
                                ...
                                >
                                    ...
                                    {isEditing ? (
                                        ...
                                        <>
                                            ...
                                            <div className="flex-1 px-2 text-muted-foreground truncate" title={record.value}>{record.value}</div>
                                            <div className="w-[150px] px-2 text-xs text-muted-foreground hidden sm:block shrink-0">
