    ...
    if (portals.length === 0) {
        return (
            <div className="space-y-4">
                <div className="rounded border border-dashed bg-card p-6 text-center text-sm text-muted-foreground">
                            ...
                            {articles.length === 0 ? (
                                ...
                                <ul className="divide-y">
                                    {articles.map((a) => (
                                        <li
                                            key={a._id}
                                            className={`cursor-pointer rounded px-2 py-2 text-sm hover:bg-accent ${
                                                a._id === selectedArticleId ? 'bg-accent' : ''
                                            }`}
