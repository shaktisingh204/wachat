import { Badge, Button, Separator } from "@/components/sabcrm/20ui/zoru";
...
export function Contact360({ selected }: { selected: SabChatConversation | undefined }) {
    if (!selected) {
        return (
            <aside className="col-span-3 overflow-y-auto rounded border bg-[var(--st-bg-secondary)] p-3 flex items-center justify-center text-sm text-[var(--st-text-secondary)]">
    ...
    return (
        <aside className="col-span-3 overflow-y-auto rounded border bg-[var(--st-bg-secondary)] p-4 space-y-6">
            <div>
                <h3 className="text-sm font-semibold mb-2">Contact 360</h3>
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-[var(--st-text)]/10 flex items-center justify-center text-[var(--st-text)] font-bold">
            ...
            <div>
                <div className="text-xs font-semibold uppercase text-[var(--st-text-secondary)] mb-2">
                    CRM Records
                </div>
                <div className="text-sm space-y-2">
                    <div className="flex justify-between">
                        <span className="text-[var(--st-text-secondary)]">Company</span>
                        <span className="font-medium">Acme Corp</span>
                    </div>
                    <div className="flex justify-between">
                        <span className="text-[var(--st-text-secondary)]">ARR</span>
            ...
            <div>
                ...
                <div className="text-sm space-y-3">
                    <div className="flex items-start gap-2">
                        <div className="w-2 h-2 rounded-full bg-[var(--st-text)] mt-1.5" />
                        <div>
                            <div className="font-medium">Upsell Q3 (Won)</div>
                            <div className="text-xs text-[var(--st-text-secondary)]">Sep 15, 2023 &bull; $15k</div>
                        </div>
                    </div>
                    <div className="flex items-start gap-2">
                        <div className="w-2 h-2 rounded-full bg-[var(--st-text)] mt-1.5" />
                        <div>
                            ...
                            <div className="text-xs text-[var(--st-text-secondary)]">Expected Dec 1, 2023 &bull; $120k</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div className="text-sm space-y-2">
                    ...
                    <div className="flex justify-between">
                        <span className="text-[var(--st-text-secondary)]">Campaign</span>
            ...
            {selected.customAttrs && Object.keys(selected.customAttrs).length > 0 && (
                <>
                    ...
                    <div>
                        ...
                        <pre className="mt-1 max-h-40 overflow-auto rounded bg-[var(--st-bg-muted)] p-2 text-[10px]">
