    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-4">
            {initialData.length === 0 ? (
                <div className="col-span-full text-center text-[var(--st-text-secondary)] p-8">
                    ...
                    <Card key={app.id} className="flex flex-col">
                        <CardHeader className="flex flex-row items-center gap-4 space-y-0">
                            {app.iconUrl ? (
                                ...
                                <div className="w-10 h-10 rounded-md bg-[var(--st-bg-muted)] flex items-center justify-center font-bold text-lg shrink-0">
                                    {app.name.charAt(0)}
                                </div>
                            )}
