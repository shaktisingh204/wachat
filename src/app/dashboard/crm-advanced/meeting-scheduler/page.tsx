            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead className="bg-[var(--st-bg-muted)]">
                  <tr>
              <th className="px-4 py-2 text-left text-sm font-medium text-[var(--st-text-secondary)] capitalize">meeting Title</th>
              <th className="px-4 py-2 text-left text-sm font-medium text-[var(--st-text-secondary)] capitalize">attendees</th>
              <th className="px-4 py-2 text-left text-sm font-medium text-[var(--st-text-secondary)] capitalize">status</th>
                ...
                <td className="px-4 py-2 border-t border-[var(--st-border)] text-sm text-[var(--st-text)]">{item.meetingTitle}</td>
                <td className="px-4 py-2 border-t border-[var(--st-border)] text-sm text-[var(--st-text)]">{item.attendees}</td>
