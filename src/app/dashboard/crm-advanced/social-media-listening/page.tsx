            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead className="bg-[var(--st-bg-muted)]">
                  <tr>
              <th className="px-4 py-2 text-left text-sm font-medium text-[var(--st-text-secondary)] capitalize">platform</th>
              <th className="px-4 py-2 text-left text-sm font-medium text-[var(--st-text-secondary)] capitalize">keyword</th>
              <th className="px-4 py-2 text-left text-sm font-medium text-[var(--st-text-secondary)] capitalize">sentiment</th>
                ...
                <td className="px-4 py-2 border-t border-[var(--st-border)] text-sm text-[var(--st-text)]">{item.platform}</td>
                <td className="px-4 py-2 border-t border-[var(--st-border)] text-sm text-[var(--st-text)]">{item.keyword}</td>
