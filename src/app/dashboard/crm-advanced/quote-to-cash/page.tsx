            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead className="bg-zoru-surface-2">
                  <tr>
              <th className="px-4 py-2 text-left text-sm font-medium text-zoru-ink-muted capitalize">quote Id</th>
              <th className="px-4 py-2 text-left text-sm font-medium text-zoru-ink-muted capitalize">amount</th>
              <th className="px-4 py-2 text-left text-sm font-medium text-zoru-ink-muted capitalize">status</th>
                ...
                <td className="px-4 py-2 border-t border-zoru-line text-sm text-zoru-ink">{item.quoteId}</td>
                <td className="px-4 py-2 border-t border-zoru-line text-sm text-zoru-ink">{item.amount}</td>
