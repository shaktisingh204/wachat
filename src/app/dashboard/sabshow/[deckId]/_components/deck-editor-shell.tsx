...
export function DeckEditorShell({
    ...
    /* ── render ───────────────────────────────────────────────────── */
    return (
        <div className="zoruui flex h-[calc(100vh-3rem)] w-full flex-col bg-background">
            {/* top bar */}
                ...
                .map((el) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {sel ? (
                                <div
                                    className="absolute -bottom-1.5 -right-1.5 h-3 w-3 cursor-se-resize rounded-sm bg-green-500"
