    ...
    <div className="p-6 space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Link href="/dashboard/finance/vouchers">
            <Button className="bg-zoru-ink text-white hover:bg-zoru-ink/90">
              New Voucher (Alt+V)
            </Button>
          </Link>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            ...
            <Wallet className="w-4 h-4 text-zoru-ink-muted" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">₹45,231.89</div>
            <p className="text-xs text-zoru-ink-muted flex items-center mt-1 text-zoru-ink">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            ...
            <Activity className="w-4 h-4 text-zoru-ink-muted" />
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            ...
            <CreditCard className="w-4 h-4 text-zoru-ink-muted" />
          </CardHeader>
          <CardContent>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          ...
          <CardContent className="h-[300px] flex items-center justify-center text-zoru-ink-muted border-t">
            ...
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-zoru-ink-muted">Tech Solutions Ltd.</p>
                </div>
