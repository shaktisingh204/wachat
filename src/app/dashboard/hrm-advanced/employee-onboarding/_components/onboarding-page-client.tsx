    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-[var(--st-text-secondary)]">Manage and track onboarding tasks.</p>
        </div>
      ...
      <div className="border rounded-md">
        <div className="grid grid-cols-12 gap-4 p-4 border-b font-medium bg-[var(--st-bg-muted)]/50 items-center">
        ...
        >
          ...
          >
            {rowVirtualizer.getVirtualItems().map((virtualRow) => {
              ...
              return (
                <div
                  ...
                  className="grid grid-cols-12 gap-4 p-4 border-b hover:bg-[var(--st-bg-muted)]/30 items-center transition-colors"
                >
                  <div className="col-span-1 flex justify-center">
                    <Checkbox 
                      checked={isSelected}
                  ...
                  <div className="col-span-2 text-sm text-[var(--st-text-secondary)]">{safeDate}</div>
                  <div className="col-span-1 flex justify-center">
                    {task.isCompleted ? (
                      <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-[var(--st-bg-muted)] text-[var(--st-text)] dark:bg-[var(--st-text)] dark:text-white">
                        Done
                      </span>
                    ) : (
                      <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-[var(--st-bg-muted)] text-[var(--st-text)] dark:bg-[var(--st-text)] dark:text-white">
            ...
            {filteredTasks.length === 0 && (
              <div className="flex flex-col items-center justify-center p-8 text-[var(--st-text-secondary)] h-[200px] w-full absolute">
