    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          />
          {errors.employeeId && <p className="text-[var(--st-text)] text-xs mt-1">{errors.employeeId.message}</p>}
        </div>
        <div>
          ...
          />
          {errors.reviewerId && <p className="text-[var(--st-text)] text-xs mt-1">{errors.reviewerId.message}</p>}
        </div>
        <div>
          ...
          />
          {errors.score && <p className="text-[var(--st-text)] text-xs mt-1">{errors.score.message}</p>}
        </div>
        <div>
          ...
          <input
            ...
            className="w-full border rounded p-2"
          />
          {errors.reviewDate && <p className="text-[var(--st-text)] text-xs mt-1">{errors.reviewDate.message}</p>}
        </div>
      </div>
      <div>
        ...
        />
        {errors.comments && <p className="text-[var(--st-text)] text-xs mt-1">{errors.comments.message}</p>}
      </div>
