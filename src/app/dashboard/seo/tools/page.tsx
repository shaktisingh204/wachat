              ...
              >
                <button
                  ...
                  className={`absolute top-3 right-3 p-1.5 rounded-md transition-opacity z-10 ${
                    isFav ? 'opacity-100 text-yellow-500 hover:text-yellow-600' : 'opacity-0 group-hover:opacity-100 text-muted-foreground hover:bg-muted'
                  }`}
                ...
                <ZoruCardContent className="p-4 flex flex-col gap-2 h-full">
                  ...
                  <div className="text-[10px] uppercase tracking-wide text-muted-foreground flex items-center gap-1.5 mt-2">
