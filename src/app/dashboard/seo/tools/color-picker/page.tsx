...
import { Button, Card, ZoruCardContent, cn } from '@/components/zoruui';
...
export default function ColorPickerPage() {
  ...
  return (
    <ToolShell title="Color Picker" description="Pick and convert colors between HEX, RGB, HSL.">
      ...
      <Card><ZoruCardContent className="p-0"><div className="h-32 rounded" style={{ backgroundColor: hex }} /></ZoruCardContent></Card>
    </ToolShell>
  );
}
