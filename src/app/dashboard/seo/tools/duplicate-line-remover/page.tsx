...
export default function DuplicateLineRemoverPage() {
  ...
  return (
    <ToolShell title="Duplicate Line Remover" description="Remove duplicate lines while preserving order.">
      ...
      <div className="flex flex-col md:flex-row gap-2 mb-6">
        <div className="flex-1 relative">
          <Input 
            ...
            className="pl-9"
          />
          <Link className="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-[var(--st-text-secondary)]" />
        </div>
      ...
      {error && (
        <div className="bg-[var(--st-text)]/10 text-[var(--st-text)] text-sm p-3 rounded-md mb-6 flex items-start gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="space-y-2 mt-6">
              <div className="flex items-center justify-between">
                <div className="text-sm font-medium">
                  Results <span className="text-[var(--st-text-secondary)] font-normal ml-2">({result.split(/\r?\n/).length} lines, removed {removed})</span>
                </div>
                <div className="flex gap-2">
        ...
        <div className="space-y-6">
          <Card className="p-4 space-y-4 bg-[var(--st-bg-muted)]/50">
