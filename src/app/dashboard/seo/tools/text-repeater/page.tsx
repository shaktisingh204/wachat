...
export default function TextRepeaterPage() {
  ...
  return (
    <ToolShell title="Text Repeater" description="Repeat text a given number of times with a separator.">
      <ZoruTextarea value={text} onChange={(e) => setText(e.target.value)} placeholder="Text to repeat…" className="min-h-[120px]" />
      ...
      <ZoruTextarea readOnly value={output} className="min-h-[220px] font-mono text-xs" />
    </ToolShell>
  );
}
