    ...
    <ToolShell title="XML Sitemap Generator" description="Generate a sitemap.xml with image and video support.">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4 p-4 bg-[var(--st-bg-muted)] rounded-lg border">
            <div className="space-y-1 flex-1">
              <Label className="text-xs">Fallback Priority</Label>
              <Input value={globalPriority} onChange={(e) => setGlobalPriority(e.target.value)} className="h-8 text-sm bg-[var(--st-bg-secondary)]" placeholder="priority" />
            </div>
            <div className="space-y-1 flex-1">
              <Label className="text-xs">Fallback Changefreq</Label>
              <select className="border rounded h-8 px-2 bg-[var(--st-bg-secondary)] w-full text-sm" value={globalChangefreq} onChange={(e) => setGlobalChangefreq(e.target.value)}>
