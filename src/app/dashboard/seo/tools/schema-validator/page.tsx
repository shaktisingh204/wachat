      ...
      {result?.ok && (
        <Card><ZoruCardContent className="p-4 space-y-4">
          ...
          {result.validation && result.validation.valid === true && (
            <div className="p-3 bg-green-50 text-green-700 rounded-md border border-green-200 flex items-start gap-2 text-sm">
          ...
          {result.validation && result.validation.valid === false && (
            <div className="p-3 bg-red-50 text-red-700 rounded-md border border-red-200 flex items-start gap-2 text-sm">
