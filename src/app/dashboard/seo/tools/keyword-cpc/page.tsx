        ...
        <Card className="mt-4">
          <ZoruCardContent className="p-6 space-y-4">
            ...
            <div className="text-sm">
              <span className="text-[var(--st-text-secondary)]">Intent: </span>
        ...
        <Card className="mt-4">
          <ZoruCardContent className="p-6 space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-sm text-[var(--st-text-secondary)] mb-1">Search Volume</p>
                <span className="text-2xl font-semibold">{apiResult.search_volume?.toLocaleString() ?? 'N/A'}</span>
              </div>
              <div>
                <p className="text-sm text-[var(--st-text-secondary)] mb-1">Competition Level</p>
                <span className="text-lg font-medium capitalize">{apiResult.competition_level?.toLowerCase() ?? 'Unknown'}</span>
              </div>
              <div>
                <p className="text-sm text-[var(--st-text-secondary)] mb-1">Competition Index</p>
