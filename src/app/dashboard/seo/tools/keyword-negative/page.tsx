...
import { Textarea, Card, ZoruCardContent, Checkbox, Label, Button } from '@/components/zoruui';
            ...
            <ZoruCardContent className="p-4">
              ...
              {detectedNegatives.length === 0 ? (
                <span className="text-sm text-muted-foreground">
                  {kw.trim().length > 0 ? (
                    <span className="text-green-600">Looks good! No negative keywords detected in your list.</span>
                  ) : (
                ...
                <div className="flex flex-wrap gap-2">
                  {detectedNegatives.map((n) => (
                    <span key={n} className="px-2 py-1 text-sm rounded-md border bg-red-100 border-red-300 text-red-800">
                      -{n}
                    </span>
                  ))}
                </div>
            ...
            <ZoruCardContent className="p-4">
              ...
              <div className="flex flex-wrap gap-1.5 max-h-[120px] overflow-y-auto pr-2 pb-2">
                {activeNegatives.length === 0 && (
                  <span className="text-sm text-muted-foreground">No negative lists selected.</span>
                )}
