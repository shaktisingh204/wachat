    ...
    <ToolShell title="Open Graph Generator" description="Generate Open Graph and Twitter Card meta tags for social sharing.">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="mt-4 flex justify-center bg-gray-50 p-6 rounded-lg border border-gray-200">
            {previewMode === 'facebook' && (
                <div className="border border-[#dadde1] rounded-lg overflow-hidden bg-white shadow-sm w-full max-w-[500px]">
                    {f.image ? (
                    <div className="w-full aspect-[1.91/1] bg-[#e4e6eb] relative overflow-hidden border-b border-[#dadde1]">
                    ...
                    <div className="w-full aspect-[1.91/1] bg-[#e4e6eb] flex items-center justify-center text-[#606770] border-b border-[#dadde1]">
                        <span className="font-medium">Image Preview</span>
                    </div>
                    )}
                    <div className="p-3 bg-[#f2f3f5] text-left">
                        <div className="text-[12px] text-[#606770] uppercase tracking-wider mb-1 truncate font-sans">
                            {domain}
                        </div>
                        <div className="font-semibold text-[16px] leading-tight text-[#1d2129] line-clamp-1 mb-1 font-sans">
                            {f.title || 'Page Title'}
                        </div>
                        <div className="text-[14px] text-[#606770] line-clamp-2 leading-snug font-sans">
            ...
            {previewMode === 'twitter' && (
                ...
                <div className="border border-[#cfd9de] rounded-2xl overflow-hidden bg-white w-full max-w-[500px] cursor-pointer hover:bg-gray-50 transition-colors">
                    {f.image ? (
                    <div className="w-full aspect-[1.91/1] bg-[#e4e6eb] relative overflow-hidden border-b border-[#cfd9de]">
                        {/* eslint-disable-next-line @next/next/no-img-element */}
                        <img 
                        src={f.image} 
                        alt="Preview" 
                    ...
                    <div className="w-full aspect-[1.91/1] bg-[#e4e6eb] flex items-center justify-center text-[#536471] border-b border-[#cfd9de]">
                        <span className="font-medium">Image Preview</span>
                    </div>
                    )}
                    <div className="p-3 text-left bg-white">
                        <div className="text-[15px] text-[#536471] mb-0.5 font-sans flex items-center gap-1 line-clamp-1">
                            {lowerDomain}
                        </div>
                        <div className="text-[15px] font-medium text-[#0f1419] line-clamp-1 font-sans">
                            {f.title || 'Page Title'}
                        </div>
                        <div className="text-[15px] text-[#536471] line-clamp-2 mt-0.5 font-sans">
                            {f.description || 'Page description goes here. It provides a brief summary of the content to entice users to click the link.'}
                        </div>
                    </div>
                </div>
                ) : (
                <div className="border border-[#cfd9de] rounded-2xl overflow-hidden bg-white w-full max-w-[500px] cursor-pointer hover:bg-gray-50 transition-colors flex h-[130px]">
                    {f.image ? (
                    <div className="w-[130px] h-full bg-[#e4e6eb] relative overflow-hidden border-r border-[#cfd9de] shrink-0">
                        {/* eslint-disable-next-line @next/next/no-img-element */}
                        <img 
                        src={f.image} 
                        alt="Preview" 
                    ...
                    <div className="w-[130px] h-full bg-[#e4e6eb] flex items-center justify-center text-[#536471] border-r border-[#cfd9de] shrink-0">
                    ...
                    <div className="p-3 text-left bg-white flex flex-col justify-center overflow-hidden">
                        ...
                        <div className="text-[15px] text-[#536471] mt-1 font-sans flex items-center gap-1 line-clamp-1">
            ...
            {previewMode === 'linkedin' && (
                <div className="bg-white overflow-hidden w-full max-w-[500px] border border-[#e0dfdc] shadow-[0_0_0_1px_rgba(0,0,0,0.08)]">
                    {f.image ? (
                    <div className="w-full aspect-[1.91/1] bg-[#e4e6eb] relative overflow-hidden">
                        {/* eslint-disable-next-line @next/next/no-img-element */}
                        <img 
                        src={f.image} 
                        alt="Preview" 
                    ...
                    <div className="w-full aspect-[1.91/1] bg-[#e4e6eb] flex items-center justify-center text-[#606770]">
                        <span className="font-medium">Image Preview</span>
                    </div>
                    )}
                    <div className="pt-2 pb-4 px-4 text-left bg-[#f3f2ef]">
                        <div className="font-semibold text-[14px] leading-tight text-[#000000e6] line-clamp-2 mb-1 font-sans">
                            {f.title || 'Page Title'}
                        </div>
                        <div className="text-[12px] text-[#00000099] uppercase tracking-wider mb-1 truncate font-sans">
                            {lowerDomain}
                        </div>
                    </div>
                </div>
