      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea readOnly value={out} className="min-h-[160px] font-mono text-xs bg-[var(--st-bg-muted)]" />
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="mt-4 flex justify-center bg-[var(--st-bg-muted)] p-6 rounded-lg border border-[var(--st-border)]">
            {previewMode === 'facebook' && (
                <div className="border border-[var(--st-border)] rounded-lg overflow-hidden bg-white shadow-sm w-full max-w-[500px]">
                    {f.image ? (
                    <div className="w-full aspect-[1.91/1] bg-[var(--st-bg-muted)] relative overflow-hidden border-b border-[var(--st-border)]">
                    ...
                    <div className="w-full aspect-[1.91/1] bg-[var(--st-bg-muted)] flex items-center justify-center text-[var(--st-text)] border-b border-[var(--st-border)]">
                        <span className="font-medium">Image Preview</span>
                    </div>
                    )}
                    <div className="p-3 bg-[var(--st-bg-secondary)] text-left">
                        <div className="text-[12px] text-[var(--st-text)] uppercase tracking-wider mb-1 truncate font-sans">
                            {domain}
                        </div>
                        <div className="font-semibold text-[16px] leading-tight text-[var(--st-text)] line-clamp-1 mb-1 font-sans">
                            {f.title || 'Page Title'}
                        </div>
                        <div className="text-[14px] text-[var(--st-text)] line-clamp-2 leading-snug font-sans">
            ...
            {previewMode === 'twitter' && (
                ...
                <div className="border border-[var(--st-border)] rounded-2xl overflow-hidden bg-white w-full max-w-[500px] cursor-pointer hover:bg-[var(--st-bg-muted)] transition-colors">
                    {f.image ? (
                    <div className="w-full aspect-[1.91/1] bg-[var(--st-bg-muted)] relative overflow-hidden border-b border-[var(--st-border)]">
                        {/* eslint-disable-next-line @next/next/no-img-element */}
                        <img 
                    ...
                    <div className="p-3 text-left bg-white">
                        <div className="text-[15px] text-[var(--st-text)] mb-0.5 font-sans flex items-center gap-1 line-clamp-1">
                            {lowerDomain}
                        </div>
                        <div className="text-[15px] font-medium text-[var(--st-text)] line-clamp-1 font-sans">
                            {f.title || 'Page Title'}
                        </div>
                        <div className="text-[15px] text-[var(--st-text)] line-clamp-2 mt-0.5 font-sans">
                            {f.description || 'Page description goes here. It provides a brief summary of the content to entice users to click the link.'}
                        </div>
                    </div>
                </div>
                ) : (
                <div className="border border-[var(--st-border)] rounded-2xl overflow-hidden bg-white w-full max-w-[500px] cursor-pointer hover:bg-[var(--st-bg-muted)] transition-colors flex h-[130px]">
                    {f.image ? (
                    <div className="w-[130px] h-full bg-[var(--st-bg-muted)] relative overflow-hidden border-r border-[var(--st-border)] shrink-0">
                        {/* eslint-disable-next-line @next/next/no-img-element */}
                        <img 
                        src={f.image} 
                        alt="Preview" 
                    ...
                    <div className="w-[130px] h-full bg-[var(--st-bg-muted)] flex items-center justify-center text-[var(--st-text)] border-r border-[var(--st-border)] shrink-0">
                    ...
                    <div className="p-3 text-left bg-white flex flex-col justify-center overflow-hidden">
                        ...
                        <div className="text-[15px] text-[var(--st-text)] mt-1 font-sans flex items-center gap-1 line-clamp-1">
            ...
            {previewMode === 'linkedin' && (
                <div className="bg-white overflow-hidden w-full max-w-[500px] border border-[var(--st-border)] shadow-[0_0_0_1px_rgba(0,0,0,0.08)]">
                    {f.image ? (
                    <div className="w-full aspect-[1.91/1] bg-[var(--st-bg-muted)] relative overflow-hidden">
                        {/* eslint-disable-next-line @next/next/no-img-element */}
                        <img 
                        src={f.image} 
                        alt="Preview" 
                    ...
                    <div className="w-full aspect-[1.91/1] bg-[var(--st-bg-muted)] flex items-center justify-center text-[var(--st-text)]">
                        <span className="font-medium">Image Preview</span>
                    </div>
                    )}
                    <div className="pt-2 pb-4 px-4 text-left bg-[var(--st-bg-secondary)]">
                        <div className="font-semibold text-[14px] leading-tight text-[var(--st-text)] line-clamp-2 mb-1 font-sans">
                            {f.title || 'Page Title'}
                        </div>
                        <div className="text-[12px] text-[var(--st-text)] uppercase tracking-wider mb-1 truncate font-sans">
                            {lowerDomain}
          ...
          <p className="text-xs text-[var(--st-text)] max-w-[500px]">
