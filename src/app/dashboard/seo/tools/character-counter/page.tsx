...
import { Card, ZoruCardContent, Textarea, Input, Button } from '@/components/zoruui';
...
function CharacterCounterContent() {
  ...
  return (
    <ToolShell title="Character Counter" description="Character count with and without spaces, plus common SEO limits.">
      ...
      {error && (
        <div className="mb-4 p-3 rounded-[var(--zoru-radius-lg)] bg-red-50 text-red-600 flex items-center text-sm border border-red-200">
