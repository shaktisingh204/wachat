...
import { Badge, Button, Card, Input, Textarea } from '@/components/sabcrm/20ui';
import {
    decideRequest,
    updateRequest,
            ...
            <div className="flex flex-col gap-4 lg:col-span-2">
                ...
                <Card className="p-4">
                    ...
                    {actions.length === 0 ? (
                        ...
                        <ol className="flex flex-col gap-3 border-l border-[var(--st-border)] pl-4">
                            {actions.map((a) => (
                                <li key={a._id} className="relative">
                                    <span className="absolute -left-[1.4rem] mt-1 h-2 w-2 rounded-full bg-[var(--st-text)]" />
            ...
            <div className="flex flex-col gap-4">
                ...
                {canDecide ? (
                    <Card className="flex flex-col gap-3 p-4">
                        ...
                        />
                        {err ? (
                            <div className="text-sm text-[var(--st-text)]">{err}</div>
                        ) : null}
