...
import { Badge, Button, Card, Input, Label, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Switch, Textarea } from '@/components/sabcrm/20ui';
import {
    createBlueprint,
    deleteBlueprint,
    updateBlueprint,
...
export function BlueprintEditor({ mode, initial }: Props) {
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            {err ? <div className="text-sm text-[var(--st-text)]">{err}</div> : null}
        </div>
    );
}
