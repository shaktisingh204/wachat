  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="live-mode" className="text-sm text-[var(--st-text-secondary)] cursor-pointer">Live Updates</Label>
          </div>
        </div>
      </div>
        ...
        {!loading && forms.length > 0 && (
          <Card>
            <CardBody className="p-4 flex items-center gap-4">
              ...
              <div>
                <p className="text-xs text-[var(--st-text-secondary)]">Total leads across all forms</p>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input 
                    ...
                    className="pl-9 bg-[var(--st-bg-secondary)] w-full"
                    {...field}
                  />
                )}
              />
      ...
      {selectedForms.length > 0 && (
        <div className="flex items-center justify-between p-3 bg-[var(--st-bg-muted)]/50 border rounded-lg animate-in fade-in slide-in-from-top-2">
      ...
      <Dialog open={createOpen} onOpenChange={setCreateOpen}>
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <Button asChild className="w-full bg-[var(--st-text)] hover:bg-[var(--st-text)]/90 text-white">
...
function CrmConnectionBanner({
  ...
  if (!status.configured) {
    return (
      <div className="flex items-center justify-between gap-3 rounded-lg border border-[var(--st-border)]/40 bg-[var(--st-text)]/10 px-4 py-2.5 text-[13px] text-[var(--st-text)] dark:text-[var(--st-text-secondary)]">
        <div className="flex items-center gap-2">
