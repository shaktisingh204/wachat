...
const ITEMS = [
    ...
    { href: '/dashboard/ad-manager/pixels', icon: Shield, title: 'Pixels and datasets', desc: 'Tracking and conversion APIs.' },
                    ...
                    return (
                        <Link key={i.href} href={i.href} className="block h-full">
                            <Card variant="interactive" padding="none" className="h-full">
                                <CardBody className="p-4 flex gap-3 h-full items-center">
                                    <span
                                        aria-hidden="true"
                                        className="h-10 w-10 shrink-0 rounded-[var(--st-radius)] bg-[var(--st-accent-soft)] flex items-center justify-center text-[var(--st-accent)]"
                                    >
