...
export default function AppearancePage() {
    ...
    useEffect(() => {
        startLoadingTransition(async () => {
            ...
            if (storedProjectId) {
                const shopData = await getEcommShopById(storedProjectId);
                setShop(shopData);
            }
        });
    }, []);
    ...
    if (!shop) {
        return (
            <Alert variant="destructive">
                ...
                <AlertTitle>No Project or Shop Selected</AlertTitle>
                <AlertDescription>Please select a project and ensure a shop is created to manage its appearance.</AlertDescription>
            </Alert>
        );
    }
