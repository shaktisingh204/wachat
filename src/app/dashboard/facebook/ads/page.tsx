...
import { Badge, Breadcrumb, BreadcrumbItem, BreadcrumbLink, BreadcrumbList, BreadcrumbPage, BreadcrumbSeparator, Button, Card } from '@/components/sabcrm/20ui/compat';
import {
  ArrowRight,
  BarChart3,
  Briefcase,
