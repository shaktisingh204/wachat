...
import { Clock, Mail, Save, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="flex min-h-full flex-col gap-6">
      ...
      <Card>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Field label="Default role for new members">
            ...
            >
              <SelectTrigger aria-label="Default role for new members">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
        ...
        <div className="mt-4 flex items-start justify-between gap-4 rounded-[var(--st-radius)] border border-[var(--st-border)] bg-[var(--st-bg-secondary)] p-3">
          <div>
      ...
      <Card>
        ...
        />
        <div className="mb-4 flex items-start justify-between gap-4 rounded-[var(--st-radius)] border border-[var(--st-border)] bg-[var(--st-bg-secondary)] p-3">
          <div>
