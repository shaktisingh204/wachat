...
import { Button, Card, Breadcrumb, BreadcrumbList, BreadcrumbItem, BreadcrumbLink, BreadcrumbSeparator, BreadcrumbPage } from '@/components/sabcrm/20ui';
  ...
  return (
    <div className="flex min-h-full flex-col gap-6">
      ...
      <Card className="mt-5 p-10 flex flex-col items-center justify-center text-center">
        ...
        <h2 className="text-lg font-semibold text-[var(--st-text)] mb-2">Failed to load API documentation</h2>
        <p className="text-sm text-[var(--st-text-secondary)] max-w-md mb-6">
          We couldn't retrieve the API documentation. Please check your connection or try again.
          {error?.message && (
