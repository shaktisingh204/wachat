...
function CodeBlock({ code }: { code: string }) {
  ...
  return (
    <div className="relative rounded-[var(--st-radius)] border border-[var(--st-border)] bg-[var(--st-bg-secondary)] p-4 font-mono text-sm text-[var(--st-text)]">
      <IconButton
              ...
              <Card key={i}>
                <CardHeader>
                  <div className="flex items-center gap-4">
                    <Badge tone={METHOD_TONE[method] ?? 'neutral'} kind="solid">
                      {method}
                    </Badge>
