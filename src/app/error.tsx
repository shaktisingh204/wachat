...
export default function Error({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] p-8 text-center bg-[var(--st-bg)] rounded-[var(--zoru-radius-lg)] border border-[var(--st-border)] mt-4 shadow-[var(--zoru-shadow-sm)]">
