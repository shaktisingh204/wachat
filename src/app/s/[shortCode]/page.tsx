        ...
        return (
            <main className="flex min-h-screen flex-col items-center justify-center p-4 bg-background">
                ...
                <div className="text-center space-y-4">
                    ...
                    <p className="text-lg font-medium text-foreground">Taking you to your destination...</p>
                    <p className="text-sm text-muted-foreground">
                        If you are not redirected automatically, <a href={finalUrl} className="text-primary hover:underline">click here</a>.
                    </p>
                </div>
            </main>
        );
