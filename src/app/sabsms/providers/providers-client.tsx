...
import { ChevronRight, ServerCog, Activity, ExternalLink, ActivitySquare, CheckCircle2, XCircle, AlertCircle, Zap, Globe, ShieldCheck } from "lucide-react";
...
function MockConnectionStatuses() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      <Card className="p-4 flex items-center justify-between border-emerald-100 bg-emerald-50/30">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-emerald-100 rounded-lg">
            <CheckCircle2 className="h-5 w-5 text-emerald-600" />
          </div>
          <div>
            <div className="text-sm font-medium text-slate-700">Twilio API</div>
            <div className="text-xs text-slate-500">Latency: 45ms</div>
          </div>
        </div>
        <Badge className="bg-emerald-100 text-emerald-800 hover:bg-emerald-100 border-emerald-200">Operational</Badge>
      </Card>
      ...
      <Card className="p-4 flex items-center justify-between border-amber-100 bg-amber-50/30">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-sm font-medium text-slate-700">Nexmo (Vonage)</div>
            <div className="text-xs text-slate-500">Latency: 120ms</div>
          </div>
        </div>
        <Badge className="bg-amber-100 text-amber-800 hover:bg-amber-100 border-amber-200">Degraded</Badge>
      </Card>

      <Card className="p-4 flex items-center justify-between border-rose-100 bg-rose-50/30">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-rose-100 rounded-lg">
            <XCircle className="h-5 w-5 text-rose-600" />
          </div>
          <div>
            <div className="text-sm font-medium text-slate-700">MessageBird</div>
            <div className="text-xs text-slate-500">Connection Failed</div>
          </div>
        </div>
        <Badge className="bg-rose-100 text-rose-800 hover:bg-rose-100 border-rose-200">Outage</Badge>
      </Card>
    </div>
  );
}
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <Badge variant={selectedProvider.status === "active" ? "default" : "destructive"}>
