        ...
        {view === "keywords" && (
          <div className="space-y-6">
            ...
            <Card className="border-border shadow-sm">
              <ZoruCardHeader className="flex flex-row items-start justify-between bg-muted/20 pb-4 border-b">
                <div>
                ...
                <div className="flex items-center gap-2">
                  <Input placeholder="Search keywords..." className="w-64 bg-background" />
                    ...
                    { 
                      ...
                      render: (r) => (
                        <Badge 
                          ...
                          className={r.actionType === "Opt-in" ? "bg-emerald-500/10 text-emerald-600 hover:bg-emerald-500/20 border-emerald-500/20" : ""}
                        >
                          {r.actionType}
                        </Badge>
                      ) 
                    ...
                    { 
                      ...
                      render: (r) => (
                        <div className="flex items-center gap-1.5 text-sm">
                          <Globe2 className="w-3.5 h-3.5 text-muted-foreground" /> {r.locale}
                        </div>
                      )
                    },
                    { 
                      ...
                      render: (r) => (
                        <div className="flex flex-wrap gap-1">
                          {r.networks.length > 0 ? r.networks.map(n => (
                            <Badge key={n} variant="outline" className="text-[10px] uppercase font-semibold bg-muted/30">
                              {n}
                            </Badge>
                    ...
                    { 
                      ...
                      render: (r) => (
                        <div className="flex items-center gap-2 text-sm font-medium">
                          <span className={`w-2 h-2 rounded-full ${r.status === 'Active' ? 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]' : 'bg-muted-foreground'}`} />
                          {r.status}
                        </div>
                      )
                    },
            ...
            <Card>
              ...
              <ZoruCardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">Drag to reorder precedence (mocked UI).</p>
          ...
          <>
            <div className="grid gap-4 md:grid-cols-2">
                ...
                <ZoruCardContent className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-muted-foreground">replies per minute per contact</span>
                    </div>
                  </div>
              ...
              <Card className="border-amber-200 dark:border-amber-900">
                ...
                <ZoruCardContent>
                  <div className="text-sm p-3 bg-amber-50 dark:bg-amber-950/30 rounded-md">
              ...
              <Card>
                ...
                <ZoruCardContent className="space-y-4">
                  ...
                  <div className="p-3 border rounded text-sm text-muted-foreground">
                    Result: Matches <span className="font-bold text-foreground">STOP</span> (Fuzzy match)
                  </div>
                </ZoruCardContent>
              </Card>
