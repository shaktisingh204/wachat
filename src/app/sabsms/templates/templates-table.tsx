      ...
      render: (row) => (
        <div className="flex flex-col gap-0.5">
          ...
          <div className="flex flex-wrap items-center gap-1">
            ...
            {row.tags.length > 4 && (
              <span className="text-[10px] text-[var(--st-text)]">+{row.tags.length - 4}</span>
            )}
          </div>
        </div>
      ),
    ...
    },
    {
      ...
      render: (row) => (
        <Link
          ...
          className="inline-flex items-center gap-1 font-mono text-xs text-[var(--st-text)] hover:text-[var(--st-text)]"
        >
            ...
            {auditEvents.map((e, i) => (
              ...
              >
                ...
                <div className="flex-1">
                  <p className="text-sm text-[var(--st-text)]">{e.detail}</p>
