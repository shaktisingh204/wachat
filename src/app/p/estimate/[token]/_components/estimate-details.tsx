...
export function EstimateDetails({
  ...
  return (
    <div className="flex flex-col gap-6 lg:col-span-3">
      ...
      {/* NOTES */}
      {estimate.notes ? (
        <div className="rounded-xl border border-[var(--st-border)] p-4 bg-[var(--st-bg-muted)]/20">
          <p className="text-[12.5px] text-[var(--st-text-secondary)] font-medium">
            <span className="font-mono text-[11px] text-[var(--st-text)] mr-1.5 uppercase font-bold">// Notes:</span>
