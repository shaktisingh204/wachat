            ...
            <div>
                <div className="flex flex-col mb-6 gap-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    <Link href={`/shop/${params.slug}/account/login`} className="text-primary hover:underline">
                      Log in here
                    </Link>.
                  </p>
                </div>
            ...
            <div>
                <Card>
                    ...
                    <ZoruCardContent className="space-y-4">
                        {cart.length === 0 ? (
                          <div className="text-sm text-muted-foreground text-center py-4">Your cart is empty</div>
                        ) : (
                          cart.map(item => (
