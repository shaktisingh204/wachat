...
/**
 * SabPay public API — resume a paused subscription.
 *
 *   POST /api/sabpay/v1/subscriptions/:id/resume
 *
...
export async function POST(
  ...
  try {
    const subscription = await rustClient.sabpay.resumeSubscriptionAs(
