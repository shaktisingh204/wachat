...
// Delete fixed-assets  (scope: crm:accounting:write, tier: FREE)
...
// Get fixed-assets  (scope: crm:accounting:read, tier: FREE)
...
// Update fixed-assets  (scope: crm:accounting:write, tier: FREE)
