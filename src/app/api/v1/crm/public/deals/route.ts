/**
 * CRM Public API — /v1/crm/deals (Phase 7 foundation, hand-written).
...
const STRING_FIELDS = ["name","stage","pipelineId","accountId","contactId","currency","closeDate","notes"] as const;

const handlers = makeCrmCollectionHandlers<CreateInput, UpdateInput>({
    entity: 'deals',
    collection: 'crm_deals',
    searchableFields: ["name","stage"],
    webhookEvents: { created: 'deal.created' },
    coerceCreate: (body) => {
