/**
 * CRM Public API — /v1/crm/contacts/[id] (Phase 7 foundation).
 */
...
const STRING_FIELDS = ["name","firstName","lastName","email","phone","company","title","address","city","state","country"] as const;

const handlers = makeCrmItemHandlers<CreateInput, UpdateInput>({
    entity: 'contacts',
    collection: 'crm_contacts',
    webhookEvents: { updated: 'contact.updated', deleted: 'contact.deleted' },
