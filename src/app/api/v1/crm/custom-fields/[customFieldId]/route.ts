...
// Delete custom-fields  (scope: crm:settings:write, tier: FREE)
...
// Get custom-fields  (scope: crm:settings:read, tier: FREE)
...
// Update custom-fields  (scope: crm:settings:write, tier: FREE)
