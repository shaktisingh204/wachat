...
pub struct Functions {
    ...
    // Wave 1 additions (SabNode): new functions
    pub char: String,
    pub code: String,
    pub unichar: String,
    pub clean: String,
    ...
    pub percentileinc: String,
    pub percentileexc: String,
    pub quartileinc: String,
    pub quartileexc: String,
    pub countunique: String,
    pub address: String,
    pub hyperlink: String,
    pub fvschedule: String,
    pub tdist_compat: String,
    pub lognormdist_compat: String,
    pub betadist_compat: String,
    pub negbinomdist_compat: String,
    pub hypgeomdist_compat: String,

    // Wave 1 additions (SabNode): legacy-name aliases resolving to existing variants
    pub stdev_compat: String,
    pub stdevp_compat: String,
    pub stdevs_compat: String,
    pub var_compat: String,
    pub varp_compat: String,
    pub vars_compat: String,
    pub covar_compat: String,
    pub covariancep_compat: String,
    pub covariances_compat: String,
    pub confidence_compat: String,
    pub chitest_compat: String,
    pub ftest_compat: String,
    pub ttest_compat: String,
    pub ztest_compat: String,
    pub chidist_compat: String,
    pub chidistrt_compat: String,
    pub chiinv_compat: String,
    pub chiinvrt_compat: String,
    pub fdist_compat: String,
    pub fdistrt_compat: String,
    pub finv_compat: String,
    pub finvrt_compat: String,
    pub tdist2t_compat: String,
    pub tdistrt_compat: String,
    pub tinv_compat: String,
    pub tinv2t_compat: String,
    pub normdist_compat: String,
    ...
    pub expondist_compat: String,
    pub poisson_compat: String,
    pub poissondist_compat: String,
    pub weibull_compat: String,
    pub weibulldist_compat: String,
    pub binomdist_compat: String,
    pub critbinom_compat: String,
    pub skewp_compat: String,
    pub percentile_compat: String,
    pub quartile_compat: String,
}
