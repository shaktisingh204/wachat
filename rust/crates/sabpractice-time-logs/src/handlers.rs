...
pub async fn list_time_logs(
    ...
    let cursor = coll
        ...
        .with_options(opts)
        .await
        .map_err(|e| ApiError::Internal(anyhow::Error::new(e).context("sabpractice_time_logs.find")))?;
    let mut rows: Vec<SabPracticeTimeLog> = cursor
        .try_collect()
        .await
        .map_err(|e| ApiError::Internal(anyhow::Error::new(e).context("sabpractice_time_logs.collect")))?;
...
pub async fn get_time_log(
    ...
    let row = coll
        ...
        .await
        .map_err(|e| ApiError::Internal(anyhow::Error::new(e).context("sabpractice_time_logs.find_one")))?
...
pub async fn create_time_log(
    ...
    let inserted = coll
        .insert_one(&entity)
        .await
        .map_err(|e| ApiError::Internal(anyhow::Error::new(e).context("sabpractice_time_logs.insert")))?;
    let new_id = inserted
        .inserted_id
        .as_object_id()
...
pub async fn update_time_log(
    ...
    let result = coll
        ...
        .await
        .map_err(|e| ApiError::Internal(anyhow::Error::new(e).context("sabpractice_time_logs.update")))?;
    ...
    let after = coll
        .find_one(ownership_filter(user_id, oid))
        .await
        .map_err(|e| ApiError::Internal(anyhow::Error::new(e).context("sabpractice_time_logs.refetch")))?
        .ok_or_else(|| ApiError::NotFound("time_log".to_owned()))?;
    Ok(Json(after))
}
...
pub async fn delete_time_log(
    ...
    let result = coll
        ...
        .await
        .map_err(|e| ApiError::Internal(anyhow::Error::new(e).context("sabpractice_time_logs.delete")))?;
