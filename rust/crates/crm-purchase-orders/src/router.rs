//! Mountable router for the §2.2 Purchase Order endpoints.
//!
//! Mount under `/v1/crm/purchase-orders` from the host `api` crate:
//!
//! ```ignore
//! use crm_purchase_orders;
//! .nest("/v1/crm/purchase-orders", crm_purchase_orders::router::<AppState>())
//! ```
//!
