...
pub struct CreateInvoiceInput {
    ...
    #[serde(default)] pub timesheet_ids: Vec<String>,
    #[serde(default)] pub line_items: Vec<CreateInvoiceLineInput>,
    pub total_minor: i64,
...
pub struct UpdateInvoiceInput {
    #[serde(default)] pub status: Option<String>,
    #[serde(default)] pub sent_at: Option<DateTime<Utc>>,
    #[serde(default)] pub paid_at: Option<DateTime<Utc>>,
}
