...
fn list_filter(user_id: ObjectId, status: Option<&str>, account_type: Option<&str>) -> Document {
...
pub async fn list_accounts(
    ...
    let mut filter = list_filter(user_id, q.status.as_deref(), q.account_type.as_deref());
