//! Mountable routers. Legacy mount under `/v1/crm/gift-cards`; SabCRM
//! Commerce (project-scoped) mount under `/v1/sabcrm/commerce/gift-cards`.
...
/// `/v1/sabcrm/commerce/gift-cards`. Same handlers, same collection;
/// every request must carry `projectId` (query for
