//! HTTP handlers for SabMail messages.
...
const COLL: &str = "sabmail_messages";
const ENTITY_KIND: &str = "sabmail_message";
...
pub async fn update_message(
    ...
    let after = coll
        .find_one(ownership(user_id, oid))
        .await
        .map_err(|e| ApiError::Internal(anyhow::Error::new(e).context("sabmail_messages.refetch")))?
        .ok_or_else(|| ApiError::NotFound("sabmail_message".to_owned()))?;
