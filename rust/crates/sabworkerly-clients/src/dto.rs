...
pub struct CreateClientInput {
    pub name: String,
    #[serde(default)] pub contact_name: Option<String>,
    #[serde(default)] pub contact_email: Option<String>,
    #[serde(default)] pub contact_phone: Option<String>,
    #[serde(default)] pub billing_address_json: Option<JsonValue>,
    #[serde(default)] pub payment_terms_days: Option<u32>,
    #[serde(default)] pub status: Option<String>,
}
