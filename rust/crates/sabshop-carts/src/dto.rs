...
pub struct CreateCartInput {
    ...
    #[serde(default)] pub guest_session_id: Option<String>,
    #[serde(default)] pub line_items: Vec<CartLineItem>,
...
pub struct UpdateCartInput {
    #[serde(default)] pub line_items: Option<Vec<CartLineItem>>,
    #[serde(default)] pub totals: Option<CartTotals>,
    #[serde(default)] pub coupon_code: Option<String>,
    #[serde(default)] pub customer_id: Option<String>,
}
...
#[derive(Debug, Clone, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct DeleteCartResponse { pub deleted: bool }
