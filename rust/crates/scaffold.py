...
targets = [
    {
        "folder": "sabcheckout-upsells",
        "package": "sabcheckout-upsells",
        "lib": "sabcheckout_upsells",
        "collection": "sabcheckout_upsells",
        "type": "SabcheckoutUpsell",
        "single": "upsell",
        "plural": "upsells",
        "Single": "Upsell",
        "Plural": "Upsells"
    ...
    {
        "folder": "sabcheckout-order-bumps",
        "package": "sabcheckout-order-bumps",
        "lib": "sabcheckout_order_bumps",
        "collection": "sabcheckout_order_bumps",
        "type": "SabcheckoutOrderBump",
        "single": "order_bump",
        "plural": "order_bumps",
        "Single": "OrderBump",
        "Plural": "OrderBumps"
    ...
    {
        "folder": "sabcheckout-ab-testing",
        "package": "sabcheckout-ab-testing",
        "lib": "sabcheckout_ab_testing",
        "collection": "sabcheckout_ab_testing",
        "type": "SabcheckoutAbTest",
        "single": "ab_test",
        "plural": "ab_tests",
        "Single": "AbTest",
        "Plural": "AbTests"
    ...
    {
        "folder": "sabcheckout-affiliates",
        "package": "sabcheckout-affiliates",
        "lib": "sabcheckout_affiliates",
        "collection": "sabcheckout_affiliates",
        "type": "SabcheckoutAffiliate",
        "single": "affiliate",
        "plural": "affiliates",
        "Single": "Affiliate",
        "Plural": "Affiliates"
    ...
    {
        "folder": "sabcheckout-gift-cards",
        "package": "sabcheckout-gift-cards",
        "lib": "sabcheckout_gift_cards",
        "collection": "sabcheckout_gift_cards",
        "type": "SabcheckoutGiftCard",
        "single": "gift_card",
        "plural": "gift_cards",
        "Single": "GiftCard",
        "Plural": "GiftCards"
    ...
    {
        "folder": "sabcheckout-store-credit",
        "package": "sabcheckout-store-credit",
        "lib": "sabcheckout_store_credit",
        "collection": "sabcheckout_store_credit",
        "type": "SabcheckoutStoreCredit",
        "single": "store_credit",
        "plural": "store_credits",
        "Single": "StoreCredit",
        "Plural": "StoreCredits"
    }
]
...
version = "0.1.0"
edition = "2024"
description = "SabCheckout \u2014 {single} CRUD."
license = "UNLICENSED"
publish = false
...
lib_rs_tpl = """//! # {package}
//!
//! HTTP surface for SabCheckout {Plural}.
//! Backs the `{collection}` Mongo collection. Mounted under
//! `/v1/sabcheckout/{plural}`. Tenant-scoped by `userId`.
...
router_rs_tpl = """//! Mountable router. Mount under `/v1/sabcheckout/{plural}`.
...
handlers_rs_tpl = """//! HTTP handlers for SabCheckout {Plural}.
