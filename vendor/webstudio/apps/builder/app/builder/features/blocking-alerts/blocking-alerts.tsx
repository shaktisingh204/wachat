  ...
  const check = () => {
    ...
    const message =
      window.innerWidth >= minWidth
        ? undefined
        : `Your browser window is too small. Resize your browser to at least ${minWidth}px wide to continue building with SabSites.`;
    setMessage(message);
  };
...
const useUnsupportedBrowser = () => {
  ...
  useEffect(() => {
    ...
    setMessage(
      <>
        The SabSites Builder UI currently supports any{" "}
        <Link
