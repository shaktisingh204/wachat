...
pub async fn enqueue_message(
    ...
    let doc_value = MessageDoc {
        ...
        media_urls: input.media_urls.clone(),
        ...
        dlt_entity_id: input.dlt_entity_id.clone(),
        dlt_template_id: input.dlt_template_id.clone(),
        ...
        rcs: input.rcs.clone(),
        channel_requested: input.channel_requested.clone(),
        channel_used: None,
        queued_at: now,
        sent_at: None,
        delivered_at: None,
