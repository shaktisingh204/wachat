# Postcard App — SabCRM App Example

A rich example app showcasing all SabCRM app entity types. Use this as a reference when building your own apps.

## What's included

This app demonstrates every entity type available in the SabCRM SDK:
...
| **Front Components** | `src/components/` | React components rendered inside SabCRM's UI |
...
- [Getting Started](https://docs.sabnode.com/developers/extend/apps/getting-started)
- [Building Apps](https://docs.sabnode.com/developers/extend/apps/building)
- [Publishing](https://docs.sabnode.com/developers/extend/apps/publishing)
