This is a [SabCRM](https://sabnode.com) application project bootstrapped with [`create-twenty-app`](https://www.npmjs.com/package/create-twenty-app).
...
Open your SabCRM instance and go to `/settings/applications` section to see the result.
...
yarn twenty remote:add --api-url http://localhost:2020 --as local     # Authenticate with SabCRM
...
```bash
# Make sure a SabCRM server is running at http://localhost:3000
yarn test
```
...
To learn more about SabCRM applications, take a look at the following resources:

- [twenty-sdk](https://www.npmjs.com/package/twenty-sdk) - learn about `twenty-sdk` tool.
- [SabCRM doc](https://docs.sabnode.com/) - SabCRM's documentation.
- Join our [Discord](https://discord.gg/cx5n4Jzs57)

You can check out [the SabCRM GitHub repository](https://github.com/twentyhq/twenty) - your feedback and contributions are welcome!
