...
export default defineApplication({
  ...
  displayName: 'Linear',
  description:
    'Connect Linear to SabCRM. Each workspace member connects their own Linear account; logic functions can then create issues and read team data on their behalf.',
  ...
  websiteUrl: 'https://www.sabnode.com',
  serverVariables: {
    LINEAR_CLIENT_ID: {
      description:
