...
export default defineApplication({
  ...
  displayName: 'SabCRM Fireflies',
  description:
    'Sync Fireflies call transcripts and AI summaries onto matching CalendarEvent records in SabCRM, and trigger sync / list / search of Fireflies calls from workflows and the AI chat.',
