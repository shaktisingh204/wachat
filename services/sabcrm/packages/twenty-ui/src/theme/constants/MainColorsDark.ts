...
import { mapRecordToGrayscale } from '@ui/theme/constants/toGrayscale';

// Black-&-white reskin: every named hue family neutralized to luminance-matched grayscale.
export const MAIN_COLORS_DARK = mapRecordToGrayscale({
  // Reds
