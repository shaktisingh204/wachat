<div align="center">
  <a href="https://sabnode.com">
    <picture>
      <img alt="SabCRM logo" src="https://raw.githubusercontent.com/twentyhq/twenty/main/packages/twenty-website/public/images/core/logo.svg" height="128">
    </picture>
  </a>
  <h1>SabCRM SDK</h1>
...
A CLI and SDK to develop, build, and publish applications that extend [SabCRM](https://sabnode.com).
...
Full documentation is available at **[docs.sabnode.com/developers/extend/apps](https://docs.sabnode.com/developers/extend/apps/getting-started)**:

- [Getting Started](https://docs.sabnode.com/developers/extend/apps/getting-started) — scaffolding, local server, authentication, dev mode
- [Building Apps](https://docs.sabnode.com/developers/extend/apps/building) — entity definitions, API clients, testing, CLI reference
- [Publishing](https://docs.sabnode.com/developers/extend/apps/publishing) — deploy, npm publish, marketplace
