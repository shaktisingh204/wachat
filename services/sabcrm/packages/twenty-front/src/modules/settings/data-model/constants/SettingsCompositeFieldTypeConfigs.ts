...
export const SETTINGS_COMPOSITE_FIELD_TYPE_CONFIGS = {
  ...
  [FieldMetadataType.EMAILS]: {
    ...
    exampleValues: [
      {
        primaryEmail: 'tim@sabnode.com',
        additionalEmails: [
          'tim@sabnode.com',
          'timapple@sabnode.com',
          'johnappletim@sabnode.com',
        ],
      },
      {
        primaryEmail: 'jane@sabnode.com',
        additionalEmails: ['jane@sabnode.com', 'jane.doe@sabnode.com'],
      },
      {
        primaryEmail: 'john@sabnode.com',
        additionalEmails: ['john.doe@sabnode.com'],
      },
    ],
    category: 'Basic',
  ...
  [FieldMetadataType.LINKS]: {
    ...
    exampleValues: [
      {
        primaryLinkUrl: 'sabnode.com',
        primaryLinkLabel: '',
        secondaryLinks: [{ url: 'sabnode.com', label: 'SabCRM' }],
      },
      {
        primaryLinkUrl: 'github.com/twentyhq/twenty',
        primaryLinkLabel: 'SabCRM Repo',
        secondaryLinks: [{ url: 'sabnode.com', label: '' }],
      },
      {
