...
- Implemented here: **391** · Missing: **0** · Blocked on spill: **9** · n/a internal: **17**
...
| CHAR | ✓ implemented |
| CHIDIST | ✓ implemented |
| CHIDISTRT | ✓ implemented |
| CHIINV | ✓ implemented |
| CHIINVRT | ✓ implemented |
...
| COVARIANCEP | ✓ implemented |
| COVARIANCES | ✓ implemented |
...
| INDEX | ✓ implemented |
| INT | ✓ implemented |
| INTERVAL | — n/a (HyperFormula-specific, output format implementation-defined) |
| IPMT | ✓ implemented |
| IRR | ✓ implemented |
| ISBINARY | — n/a (HyperFormula-specific, output format implementation-defined) |
| ISBLANK | ✓ implemented |
| ISERR | ✓ implemented |
| ISERROR | ✓ implemented |
| ISEVEN | ✓ implemented |
