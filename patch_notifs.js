...
code = code.replace("<EntityListShell", modalCode);

const buttonsCode = `<div className="flex gap-2">
                <Button
                    variant="ghost"
...
const renderListOld = `                    <Card className="p-0">
                        <ul className="divide-y divide-zoru-line">
                            {filtered.map((row) => {`;

const renderListNew = `                    <div className="flex flex-col gap-6">
                        {(() => {
